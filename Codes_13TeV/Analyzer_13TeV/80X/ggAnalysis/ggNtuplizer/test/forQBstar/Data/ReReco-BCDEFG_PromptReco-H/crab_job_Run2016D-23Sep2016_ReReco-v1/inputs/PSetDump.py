...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2016B/SinglePhoton/MINIAOD/23Sep2016-v3/110000/06B8D6E3-4298-E611-BC45-0CC47A78A3EC.root')
)
    ...
    userData = cms.PSet(
        ...
        userClasses = cms.PSet(
            src = cms.VInputTag(cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-loose"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-medium"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-tight"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronID-Summer16-80X-V1-veto"), cms.InputTag("egmGsfElectronIDs","cutBasedElectronHLTPreselection-Summer16-V1"), 
                cms.InputTag("egmGsfElectronIDs","heepElectronID-HEEPV60"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp80"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-GeneralPurpose-V1-wp90"), cms.InputTag("egmGsfElectronIDs","mvaEleID-Spring16-HZZ-V1-wpLoose"))
        ),
        userFloats = cms.PSet(
            src = cms.VInputTag("")
        ),
...
process.ggNtuplizer = cms.EDAnalyzer("ggNtuplizer",
    ...
    EleScale_Smearing_file = cms.string('EgammaAnalysis/ElectronTools/data/ScalesSmearings/Winter_2016_reReco_v1_ele'),
    ...
    ak4GenJetSrc = cms.InputTag("slimmedGenJets"),
    ...
    **dict(
    ...
    jecAK8PayloadNames = cms.vstring('Spring16_25nsV10p2_DATA_L2Relative_AK8PFchs.txt', 
    ...
    rhoLabelForJER = cms.InputTag("fixedGridRhoAll"),
...
process.p = cms.Path(process.ggMETFiltersSequence+process.calibratedPatElectrons+process.calibratedPatPhotons+process.egmGsfElectronIDSequence+process.egmPhotonIDSequence+process.ggNtuplizer)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('Data_Run2016D-23Sep2016_ReReco-v1.root')
)
...
process.jec = cms.ESSource("PoolDBESSource",
    ...
    toGet = cms.VPSet(cms.PSet(
        ...
        cms.PSet(
            ...
            record = cms.string('JetCorrectionsRecord'),
            tag = cms.string('JetCorrectorParametersCollection_Spring16_23Sep2016AllV2_DATA_AK8PFchs')
        ))
)
