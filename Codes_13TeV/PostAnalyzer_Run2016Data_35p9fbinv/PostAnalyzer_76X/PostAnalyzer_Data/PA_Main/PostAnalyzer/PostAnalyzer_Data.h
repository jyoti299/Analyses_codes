...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data/Run2015D_PromptReco_v3/ggNtuples_25ns_data_607.root/ggNtuplizer/EventTree");
      chain->Add("/eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data/Run2015D_PromptReco_v3/ggNtuples_25ns_data_608.root/ggNtuplizer/EventTree");
      chain->Add("/eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data/Run2015D_PromptReco_v3/ggNtuples_25ns_data_609.root/ggNtuplizer/EventTree");
      chain->Add("/eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data/Run2015D_PromptReco_v3/ggNtuples_25ns_data_610.root/ggNtuplizer/EventTree");
      chain->Add("/eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data/Run2015D_PromptReco_v3/ggNtuples_25ns_data_611.root/ggNtuplizer/EventTree");
      chain->Add("/eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data/Run2015D_PromptReco_v3/ggNtuples_25ns_data_612.root/ggNtuplizer/EventTree");
...
Bool_t PostAnalyzer_Data::PassHLT_Prescale(ULong64_t trigBit){
...
void PostAnalyzer_Data::BookHistograms(){
  file->cd();
    ...
    for( Int_t hist = 0; hist < 7; ++hist ){
      sprintf(name, "h_goodPV_%s",cut2[hist].c_str());
    ...
    std::string cut3[2] = {"deno", "num"};
    for(Int_t hist2 =0; hist2 < 2; ++hist2){

      sprintf(name, "h_TrigPhotonPt_%s",cut3[hist2].c_str());
      h_TrigPhotonPt[hist2] = new TH1F(name, "pt of trigger photon", nTrigPtBins, TrigPtBins);
      h_TrigPhotonPt[hist2]->GetYaxis()->SetTitle("");      h_TrigPhotonPt[hist2]->GetYaxis()->CenterTitle();                       
      h_TrigPhotonPt[hist2]->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");   h_TrigPhotonPt[hist2]->GetXaxis()->CenterTitle();  
      h_TrigPhotonPt[hist2]->Sumw2();
    }
    ...
    const int nbins = 15;
    TString CutFlowLabels[nbins] = {"Total", "HLT", "PrimaryVtx_&_METFilters", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "DPhi", "DEta", "MassCut", "1BTag_noMassCut", "1BTag_MassCut", "0BTag_noMassCut", "0BTag_MassCut"};
