...
#Signal bstar
MCnTuplesDir=root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/MC

Signal=Signal_Bstar

Bstar=1
#Bstar_1p0
for i in BstarToGJ_M500_f1p0  BstarToGJ_M1000_f1p0  BstarToGJ_M1500_f1p0  BstarToGJ_M2000_f1p0  BstarToGJ_M2500_f1p0  BstarToGJ_M3000_f1p0  BstarToGJ_M3500_f1p0  BstarToGJ_M4000_f1p0  BstarToGJ_M4500_f1p0  BstarToGJ_M5000_f1p0
do
XS=( 6.236  2.148E-1  2.204E-2  3.585E-3  7.488E-4  1.766E-4  4.517E-5  1.202E-5  3.289E-6  9.216e-7 )
totalEvents=( 100000  98848  75000  74730  75000  74619  49490  46516  49435  47912 )


#Bstar_0p5
#for i in BstarToGJ_M500_f0p5  BstarToGJ_M1000_f0p5  BstarToGJ_M1500_f0p5  BstarToGJ_M2000_f0p5  BstarToGJ_M2500_f0p5  BstarToGJ_M3000_f0p5  BstarToGJ_M3500_f0p5  BstarToGJ_M4000_f0p5  BstarToGJ_M4500_f0p5  BstarToGJ_M5000_f0p5
#do
#XS=( 1.574  5.438E-2  5.666E-3  9.162E-4  1.884E-4  4.393E-5  1.112E-5  2.909E-6  7.705E-7  2.027E-7 )
#totalEvents=( 98568  98621  71172  74610  72480  74889  50000  50000  48336  49656  )

#Bstar_0p1
#for i in BstarToGJ_M500_f0p1  BstarToGJ_M1000_f0p1  BstarToGJ_M1500_f0p1  BstarToGJ_M2000_f0p1  BstarToGJ_M2500_f0p1  BstarToGJ_M3000_f0p1  BstarToGJ_M3500_f0p1  BstarToGJ_M4000_f0p1  BstarToGJ_M4500_f0p1  BstarToGJ_M5000_f0p1
#do
#XS=( 6.357E-2  2.175E-3  2.278E-4  3.674E-5  7.595E-6  1.768E-6  4.454E-7  1.155E-7  3.031E-8  7.703E-9 )
#totalEvents=( 95734  95716  74506  74867  73964  74902  50000  49796  50000  50000 )


sourceDir=${MCnTuplesDir}/${Signal}/${i}/
...
//For b-tag SF
#include "/uscms_data/d3/rocky86/13TeV/PostAnalyzer_Bstar13TeV_74X/PostAnalyzer_MC/PA_Main/BtagSF/BTagCalibrationStandalone.h"
...
public :
   ...
   //Histograms
   TH1F *h_PhotonPt[3][2];
   TH1F *h_PhotonEta[3][2];
   TH1F *h_PhotonPhi[3][2];
   TH1F *h_Photon_SigmaIEtaIEta[3][2];
   TH1F *h_Photon_R9[3][2];
   TH1F *h_Photon_HoverE[3][2];
   TH1F *h_Photon_EleVeto[3][2];
   TH1F *h_Photon_CorrPFChIso[3][2];
   TH1F *h_Photon_CorrPFNeuIso[3][2];
   TH1F *h_Photon_CorrPFPhoIso[3][2];

   TH1F *h_bJetPt[3][2];
   TH1F *h_bJetEta[3][2];
   TH1F *h_bJetPhi[3][2];
   TH1F *h_bJet_NHEF[3][2];
   TH1F *h_bJet_NEEF[3][2];
   TH1F *h_bJet_NConst[3][2];
   TH1F *h_bJet_CHEF[3][2];
   TH1F *h_bJet_ChMult[3][2];
   TH1F *h_bJet_CEEF[3][2];

   TH1F *h_GbJetInvtMass_VarBin[3][2];
   TH1F *h_GbJetInvtMass_UnitBin[3][2];
   TH1F *h_GbJet_dEta[3][2];
   TH1F *h_GbJet_dPhi[3][2];
   TH1F *h_GbJet_dR[3][2];
   TH1F *h_cosThetaStar[3][2];

   TH1F *h_PFMet[3][2];
   TH1F *h_SumPFMet[3][2];
   TH1F *h_MetBySumMET[3][2];
   TH2F *h_PFMetVsGJmass[3][2];
   TH2F *h_PFMetOverSumEtVsGJmass[3][2];

   TH2F *h_PhPt_vs_bJetPt[3][2];
   TH2F *h_PhEta_vs_bJetEta[3][2];

   TH1F *h_CSVv2Dist[3][2];
   TH2F *h_CSVv2_vs_bJetPt[3][2];
   TH2F *h_CSVv2_vs_bJetEta[3][2];
   ...
   //Cut Flow
   TH1F *h_CutFlow;
   TH1F *h_CutFlow_TotalWts;
   TH1F *h_CutFlow_PreBTagWts;
   ...
   //For 74X (WP cuts need to change for 76X)
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      /*      
       chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/MC/Signal_Bstar/BstarToGJ_M2500_f1p0/AOD_BstarToGJ_M2500_f1p0_1.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/MC/Signal_Bstar/BstarToGJ_M2500_f1p0/AOD_BstarToGJ_M2500_f1p0_10.root/ggNtuplizer/EventTree");
      */
      //      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/ZGTo2LG/AOD_ZGTo2LG_121.root/ggNtuplizer/EventTree");
      
/*      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/GJets/GJets_HT200To400/AOD_GJets_HT200To400_244.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/GJets/GJets_HT200To400/AOD_GJets_HT200To400_254.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/GJets/GJets_HT200To400/AOD_GJets_HT200To400_284.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/GJets/GJets_HT200To400/AOD_GJets_HT200To400_294.root/ggNtuplizer/EventTree");
  */    
...
Bool_t PostAnalyzer_MC::JetId(Int_t iJet, TString jetWP){
  ...
  if(jetWP == "loose"){ //loose
    ...
    if(fabs((*jetEta)[iJet]) > 3.0){
      ...
      JetID = ((*jetNEF)[iJet] < 0.90)  &&;	      
        Num_of_Neutral_Particles_not_in_Ntuplizer > 10;
    }
    */
  }
  ...
  if(jetWP == "tightLepVeto"){ //tightLepVeto
	...
	((*jetNEF)[iJet] < 0.90)        &&
	((*jetNConstituents)[iJet] > 1) &&
	MUON-FRACTION-NOT-IN-NTUPLIZER < 0.8  &&
	((*jetCHF)[iJet] > 0)           &&
	((*jetNCH)[iJet] > 0)           &&
	((*jetCEF)[iJet] < 0.90);
    }
...
Bool_t PostAnalyzer_MC::CSVv2bTag(Int_t ijet, TString WP){
  ...
  if(WP == "L"){ //loose
    if((*jetpfCombinedInclusiveSecondaryVertexV2BJetTags)[ijet] > 0.605) passTag = true;
  }
  if(WP == "M"){ //medium
    if((*jetpfCombinedInclusiveSecondaryVertexV2BJetTags)[ijet] > 0.89) passTag = true;
  }
  if(WP == "T"){ //tight
    if((*jetpfCombinedInclusiveSecondaryVertexV2BJetTags)[ijet] > 0.97) passTag = true;
  }
...
Double_t PostAnalyzer_MC::CSVv2bTagSF(BTagEntry::OperatingPoint OP, BTagEntry::JetFlavor JF, std::string sys_type, Double_t JetPt, Double_t JetEta){
  ...
  BTagCalibration calib("csvv2", "/uscms_data/d3/rocky86/13TeV/PostAnalyzer_Bstar13TeV_74X/PostAnalyzer_MC/PA_Main/BtagSF/CSVv2.csv");
...
void PostAnalyzer_MC::PileupReWeighting(){
  ...
  Bool_t Pileup_Bstar = ${Bstar};
    ...
    //puMCfile = "Bstar_PileupHist";

    //For Silver Json
  TFile *fData = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_Bstar13TeV_74X/PostAnalyzer_MC/PA_Main/PileupHistograms/Data_Run2015D_PileUpDist_SilverJson/DataPileupHist_2015D.root");
  TH1F *dataPU = (TH1F*)fData->Get("pileup");
   
  TFile *fMC = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_Bstar13TeV_74X/PostAnalyzer_MC/PA_Main/PileupHistograms/MC_Run2015D_PileUpDist/"+puMCfile+".root");
...
void PostAnalyzer_MC::BookHistograms(){
  ...
  //For now using binning of q* 8 TeV.
    ...
    std::string cut0[3] = {"noBTag", "1BTag", "0BTag"};
    std::string cut1[2] = {"noMassCut", "MassCut"};
    for(Int_t hist0 = 0; hist0 < 3; ++hist0){
      for(Int_t hist1 = 0; hist1 < 2; ++hist1){

	sprintf(name, "h_PhotonPt_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_PhotonPt[hist0][hist1] = new TH1F(name,"Pt distribution of photons",150,0.0,6000.0);
	h_PhotonPt[hist0][hist1]->GetYaxis()->SetTitle("Events/40 GeV");  h_PhotonPt[hist0][hist1]->GetYaxis()->CenterTitle();
	h_PhotonPt[hist0][hist1]->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");  h_PhotonPt[hist0][hist1]->GetXaxis()->CenterTitle();
	h_PhotonPt[hist0][hist1]->Sumw2();

	sprintf(name, "h_PhotonEta_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_PhotonEta[hist0][hist1] = new TH1F(name,"Eta distribution of photons",100,-2.5,2.5);
	h_PhotonEta[hist0][hist1]->GetYaxis()->SetTitle("Events");  h_PhotonEta[hist0][hist1]->GetYaxis()->CenterTitle();
	h_PhotonEta[hist0][hist1]->GetXaxis()->SetTitle("#eta^{#gamma}");  h_PhotonEta[hist0][hist1]->GetXaxis()->CenterTitle();
	h_PhotonEta[hist0][hist1]->Sumw2();

	sprintf(name, "h_PhotonPhi_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_PhotonPhi[hist0][hist1] = new TH1F(name,"Phi distribution of photons",100,-3.2,3.2);
	h_PhotonPhi[hist0][hist1]->GetYaxis()->SetTitle("Events");  h_PhotonPhi[hist0][hist1]->GetYaxis()->CenterTitle();
	h_PhotonPhi[hist0][hist1]->GetXaxis()->SetTitle("#phi^{#gamma}");   h_PhotonPhi[hist0][hist1]->GetXaxis()->CenterTitle();
	h_PhotonPhi[hist0][hist1]->Sumw2();

	sprintf(name, "h_Photon_SigmaIEtaIEta_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_Photon_SigmaIEtaIEta[hist0][hist1] = new TH1F(name,"Photon SigmaIetaIeta Distribution",100,0.0,0.05);
	h_Photon_SigmaIEtaIEta[hist0][hist1]->GetYaxis()->SetTitle("Events");  h_Photon_SigmaIEtaIEta[hist0][hist1]->GetYaxis()->CenterTitle();
	h_Photon_SigmaIEtaIEta[hist0][hist1]->GetXaxis()->SetTitle("#sigma_{i#etai#eta}");  h_Photon_SigmaIEtaIEta[hist0][hist1]->GetXaxis()->CenterTitle();
	h_Photon_SigmaIEtaIEta[hist0][hist1]->Sumw2();

	sprintf(name, "h_Photon_R9_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_Photon_R9[hist0][hist1] = new TH1F(name,"Photon R9 Distribution",100,0.0,10.0);
	h_Photon_R9[hist0][hist1]->GetYaxis()->SetTitle("Events");       h_Photon_R9[hist0][hist1]->GetYaxis()->CenterTitle();
	h_Photon_R9[hist0][hist1]->GetXaxis()->SetTitle("Photon_r9");    h_Photon_R9[hist0][hist1]->GetXaxis()->CenterTitle();
	h_Photon_R9[hist0][hist1]->Sumw2();

	sprintf(name, "h_Photon_HoverE_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_Photon_HoverE[hist0][hist1] = new TH1F(name,"Photon HoverE Distribution",50,0.0,0.1);
	h_Photon_HoverE[hist0][hist1]->GetYaxis()->SetTitle("Events");   h_Photon_HoverE[hist0][hist1]->GetYaxis()->CenterTitle();
	h_Photon_HoverE[hist0][hist1]->GetXaxis()->SetTitle("H/E");      h_Photon_HoverE[hist0][hist1]->GetXaxis()->CenterTitle();
	h_Photon_HoverE[hist0][hist1]->Sumw2();

	sprintf(name, "h_Photon_EleVeto_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_Photon_EleVeto[hist0][hist1] = new TH1F(name,"Photon ElectronVeto",3,0,3);
	h_Photon_EleVeto[hist0][hist1]->GetYaxis()->SetTitle("Events");     h_Photon_EleVeto[hist0][hist1]->GetYaxis()->CenterTitle();
	h_Photon_EleVeto[hist0][hist1]->GetXaxis()->SetTitle("EleVeto");    h_Photon_EleVeto[hist0][hist1]->GetXaxis()->CenterTitle();
	h_Photon_EleVeto[hist0][hist1]->Sumw2();

	sprintf(name, "h_Photon_CorrPFChIso_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_Photon_CorrPFChIso[hist0][hist1] = new TH1F(name,"Rho Corrected PF Charged Isolation",625,0,25);
	h_Photon_CorrPFChIso[hist0][hist1]->GetYaxis()->SetTitle("Events");        h_Photon_CorrPFChIso[hist0][hist1]->GetYaxis()->CenterTitle();
	h_Photon_CorrPFChIso[hist0][hist1]->GetXaxis()->SetTitle("CorrPFChIso");   h_Photon_CorrPFChIso[hist0][hist1]->GetXaxis()->CenterTitle();
	h_Photon_CorrPFChIso[hist0][hist1]->Sumw2();

	sprintf(name, "h_Photon_CorrPFNeuIso_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_Photon_CorrPFNeuIso[hist0][hist1] = new TH1F(name,"Rho Corrected PF Neutral Isolation",100,0,300);
	h_Photon_CorrPFNeuIso[hist0][hist1]->GetYaxis()->SetTitle("Events");    h_Photon_CorrPFNeuIso[hist0][hist1]->GetYaxis()->CenterTitle();
	h_Photon_CorrPFNeuIso[hist0][hist1]->GetXaxis()->SetTitle("CorrPFNeuIso");    h_Photon_CorrPFNeuIso[hist0][hist1]->GetXaxis()->CenterTitle();
	h_Photon_CorrPFNeuIso[hist0][hist1]->Sumw2();

	sprintf(name, "h_Photon_CorrPFPhoIso_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_Photon_CorrPFPhoIso[hist0][hist1] = new TH1F(name,"Rho Corrected PF Photon Isolation",125,0,25);
	h_Photon_CorrPFPhoIso[hist0][hist1]->GetYaxis()->SetTitle("Events");    h_Photon_CorrPFPhoIso[hist0][hist1]->GetYaxis()->CenterTitle();
	h_Photon_CorrPFPhoIso[hist0][hist1]->GetXaxis()->SetTitle("CorrPFPhoIso"); h_Photon_CorrPFPhoIso[hist0][hist1]->GetXaxis()->CenterTitle();
	h_Photon_CorrPFPhoIso[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_JetPt_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	else sprintf(name, "h_bJetPt_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_bJetPt[hist0][hist1] = new TH1F(name,"Pt distribution of jets",150,0.0,6000.0);
	h_bJetPt[hist0][hist1]->GetYaxis()->SetTitle("Events/40 GeV");  h_bJetPt[hist0][hist1]->GetYaxis()->CenterTitle();
	h_bJetPt[hist0][hist1]->GetXaxis()->SetTitle("P_{T}^{Jet} (GeV)");  h_bJetPt[hist0][hist1]->GetXaxis()->CenterTitle();
	h_bJetPt[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_JetEta_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
        else sprintf(name, "h_bJetEta_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_bJetEta[hist0][hist1] = new TH1F(name,"Eta distribution of jets",120,-3.0,3.0);
	h_bJetEta[hist0][hist1]->GetYaxis()->SetTitle("Events");      h_bJetEta[hist0][hist1]->GetYaxis()->CenterTitle();
	h_bJetEta[hist0][hist1]->GetXaxis()->SetTitle("#eta^{Jet}");  h_bJetEta[hist0][hist1]->GetXaxis()->CenterTitle();
	h_bJetEta[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_JetPhi_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	else sprintf(name, "h_bJetPhi_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_bJetPhi[hist0][hist1] = new TH1F(name,"Phi distribution of jets",100,-3.2,3.2);
	h_bJetPhi[hist0][hist1]->GetYaxis()->SetTitle("Events");      h_bJetPhi[hist0][hist1]->GetYaxis()->CenterTitle();
	h_bJetPhi[hist0][hist1]->GetXaxis()->SetTitle("#phi^{Jet}");  h_bJetPhi[hist0][hist1]->GetXaxis()->CenterTitle();
	h_bJetPhi[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_Jet_NHEF_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
        else sprintf(name, "h_bJet_NHEF_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_bJet_NHEF[hist0][hist1] = new TH1F(name,"Neutral Hadron Energy Fraction",25,0,1);
	h_bJet_NHEF[hist0][hist1]->GetYaxis()->SetTitle("Events");      h_bJet_NHEF[hist0][hist1]->GetYaxis()->CenterTitle();
	h_bJet_NHEF[hist0][hist1]->GetXaxis()->SetTitle("Jet_NHEF");    h_bJet_NHEF[hist0][hist1]->GetXaxis()->CenterTitle();
	h_bJet_NHEF[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_Jet_NEEF_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
        else sprintf(name, "h_bJet_NEEF_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_bJet_NEEF[hist0][hist1] = new TH1F(name,"Neutral Em Energy Fraction",25,0,1);
	h_bJet_NEEF[hist0][hist1]->GetYaxis()->SetTitle("Events");       h_bJet_NEEF[hist0][hist1]->GetYaxis()->CenterTitle();
	h_bJet_NEEF[hist0][hist1]->GetXaxis()->SetTitle("Jet_NEEF");     h_bJet_NEEF[hist0][hist1]->GetXaxis()->CenterTitle();
	h_bJet_NEEF[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_Jet_NConst_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
        else sprintf(name, "h_bJet_NConst_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_bJet_NConst[hist0][hist1] = new TH1F(name,"No. of Constituents",50,0,50);
	h_bJet_NConst[hist0][hist1]->GetYaxis()->SetTitle("Events");      h_bJet_NConst[hist0][hist1]->GetYaxis()->CenterTitle();
	h_bJet_NConst[hist0][hist1]->GetXaxis()->SetTitle("Jet_NConst");  h_bJet_NConst[hist0][hist1]->GetXaxis()->CenterTitle();
	h_bJet_NConst[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_Jet_CHEF_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
        else sprintf(name, "h_bJet_CHEF_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_bJet_CHEF[hist0][hist1] = new TH1F(name,"Charged Hadron Energy Fraction",25,0,1);
	h_bJet_CHEF[hist0][hist1]->GetYaxis()->SetTitle("Events");      h_bJet_CHEF[hist0][hist1]->GetYaxis()->CenterTitle();
	h_bJet_CHEF[hist0][hist1]->GetXaxis()->SetTitle("Jet_CHEF");    h_bJet_CHEF[hist0][hist1]->GetXaxis()->CenterTitle();
	h_bJet_CHEF[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_Jet_ChMult_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	else sprintf(name, "h_bJet_ChMult_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_bJet_ChMult[hist0][hist1] = new TH1F(name,"Charged Multiplicity",50,0,50);
	h_bJet_ChMult[hist0][hist1]->GetYaxis()->SetTitle("Events");       h_bJet_ChMult[hist0][hist1]->GetYaxis()->CenterTitle();
	h_bJet_ChMult[hist0][hist1]->GetXaxis()->SetTitle("Jet_ChMult");   h_bJet_ChMult[hist0][hist1]->GetXaxis()->CenterTitle();
	h_bJet_ChMult[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_Jet_CEEF_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	else sprintf(name, "h_bJet_CEEF_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_bJet_CEEF[hist0][hist1] = new TH1F(name,"Charged Em Energy Fraction",25,0,1);
	h_bJet_CEEF[hist0][hist1]->GetYaxis()->SetTitle("Events");      h_bJet_CEEF[hist0][hist1]->GetYaxis()->CenterTitle();
	h_bJet_CEEF[hist0][hist1]->GetXaxis()->SetTitle("Jet_CEEF");    h_bJet_CEEF[hist0][hist1]->GetXaxis()->CenterTitle();
	h_bJet_CEEF[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_GJetInvtMass_VarBin_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	else sprintf(name, "h_GbJetInvtMass_VarBin_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_GbJetInvtMass_VarBin[hist0][hist1] = new TH1F(name, "Invt mass distribution", nMassBins, MassBin);
	h_GbJetInvtMass_VarBin[hist0][hist1]->GetYaxis()->SetTitle("Events/VarBin"); h_GbJetInvtMass_VarBin[hist0][hist1]->GetYaxis()->CenterTitle();
	h_GbJetInvtMass_VarBin[hist0][hist1]->GetXaxis()->SetTitle("Invt Mass (GeV)");    h_GbJetInvtMass_VarBin[hist0][hist1]->GetXaxis()->CenterTitle();
	h_GbJetInvtMass_VarBin[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_GJetInvtMass_UnitBin_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	else sprintf(name, "h_GbJetInvtMass_UnitBin_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_GbJetInvtMass_UnitBin[hist0][hist1] = new TH1F(name,"Invt mass distribution", 14000, 0.0, 14000.0);
	h_GbJetInvtMass_UnitBin[hist0][hist1]->GetYaxis()->SetTitle("Events/UnitBin");   h_GbJetInvtMass_UnitBin[hist0][hist1]->GetYaxis()->CenterTitle();
	h_GbJetInvtMass_UnitBin[hist0][hist1]->GetXaxis()->SetTitle("Invt Mass (GeV)"); h_GbJetInvtMass_UnitBin[hist0][hist1]->GetXaxis()->CenterTitle();
	h_GbJetInvtMass_UnitBin[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_GJet_dEta_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
        else sprintf(name, "h_GbJet_dEta_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_GbJet_dEta[hist0][hist1] = new TH1F(name, "delta Eta dist", 120, 0, 6);
	h_GbJet_dEta[hist0][hist1]->GetYaxis()->SetTitle("Events");         h_GbJet_dEta[hist0][hist1]->GetYaxis()->CenterTitle();
	h_GbJet_dEta[hist0][hist1]->GetXaxis()->SetTitle("#Delta #eta");    h_GbJet_dEta[hist0][hist1]->GetXaxis()->CenterTitle();
	h_GbJet_dEta[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_GJet_dPhi_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
        else sprintf(name, "h_GbJet_dPhi_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_GbJet_dPhi[hist0][hist1] = new TH1F(name, "delta Phi dist", 64, 0, 3.2);
	h_GbJet_dPhi[hist0][hist1]->GetYaxis()->SetTitle("Events");       h_GbJet_dPhi[hist0][hist1]->GetYaxis()->CenterTitle();
	h_GbJet_dPhi[hist0][hist1]->GetXaxis()->SetTitle("#Delta #phi");  h_GbJet_dPhi[hist0][hist1]->GetXaxis()->CenterTitle();
	h_GbJet_dPhi[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_GJet_dR_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
        else sprintf(name, "h_GbJet_dR_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_GbJet_dR[hist0][hist1] = new TH1F(name, "delta R dist", 100, 0.0, 10.0);
	h_GbJet_dR[hist0][hist1]->GetYaxis()->SetTitle("Events");          h_GbJet_dR[hist0][hist1]->GetYaxis()->CenterTitle();
	h_GbJet_dR[hist0][hist1]->GetXaxis()->SetTitle("#Delta R");        h_GbJet_dR[hist0][hist1]->GetXaxis()->CenterTitle();
	h_GbJet_dR[hist0][hist1]->Sumw2();

	sprintf(name, "h_cosThetaStar_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_cosThetaStar[hist0][hist1] = new TH1F(name,"Cos theta star of photon+jet",50,0,1);
	h_cosThetaStar[hist0][hist1]->GetYaxis()->SetTitle("Events");        h_cosThetaStar[hist0][hist1]->GetYaxis()->CenterTitle();
	h_cosThetaStar[hist0][hist1]->GetXaxis()->SetTitle("cos#theta*");    h_cosThetaStar[hist0][hist1]->GetXaxis()->CenterTitle();
	h_cosThetaStar[hist0][hist1]->Sumw2();

	sprintf(name, "h_PFMet_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_PFMet[hist0][hist1] = new TH1F(name, "PFMet distribution", 200,0.0,1000.0);
	h_PFMet[hist0][hist1]->GetYaxis()->SetTitle("Events/5 GeV");           h_PFMet[hist0][hist1]->GetYaxis()->CenterTitle();
	h_PFMet[hist0][hist1]->GetXaxis()->SetTitle("#slash{E}_{T} (GeV)");    h_PFMet[hist0][hist1]->GetXaxis()->CenterTitle();
	h_PFMet[hist0][hist1]->Sumw2();

	sprintf(name, "h_SumPFMet_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_SumPFMet[hist0][hist1]  = new TH1F(name,"SumET PF Met distribution",80,0.0,4000.0);
	h_SumPFMet[hist0][hist1]->GetYaxis()->SetTitle("Events/50 GeV");            h_SumPFMet[hist0][hist1]->GetYaxis()->CenterTitle();
	h_SumPFMet[hist0][hist1]->GetXaxis()->SetTitle("#sum#slash{E}_{T} (GeV)");  h_SumPFMet[hist0][hist1]->GetXaxis()->CenterTitle();
	h_SumPFMet[hist0][hist1]->Sumw2();

	sprintf(name, "h_MetBySumMET_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_MetBySumMET[hist0][hist1]  = new TH1F(name,"MET / SumET PF Met",50,0.0,1.0);
	h_MetBySumMET[hist0][hist1]->GetYaxis()->SetTitle("Events");        h_MetBySumMET[hist0][hist1]->GetYaxis()->CenterTitle();
	h_MetBySumMET[hist0][hist1]->GetXaxis()->SetTitle("#slash{E}_{T}/#sum#slash{E}_{T}"); h_MetBySumMET[hist0][hist1]->GetXaxis()->CenterTitle();
	h_MetBySumMET[hist0][hist1]->Sumw2();

	sprintf(name, "h_PFMetVsGJmass_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_PFMetVsGJmass[hist0][hist1] = new TH2F(name, "PFMet Vs InvtMass", 1400, 0.0, 14000.0, 150, 0.0, 6000.0);
	h_PFMetVsGJmass[hist0][hist1]->GetYaxis()->SetTitle("PFMET (GeV)");    h_PFMetVsGJmass[hist0][hist1]->GetYaxis()->CenterTitle();
	h_PFMetVsGJmass[hist0][hist1]->GetXaxis()->SetTitle("Invt Mass (GeV)");  h_PFMetVsGJmass[hist0][hist1]->GetXaxis()->CenterTitle();
	h_PFMetVsGJmass[hist0][hist1]->Sumw2();

	sprintf(name, "h_PFMetOverSumEtVsGJmass_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_PFMetOverSumEtVsGJmass[hist0][hist1] = new TH2F(name, "PFMet/SumEt Vs InvtMass", 1400, 0.0, 14000.0, 1000, 0.0, 10.0);
	h_PFMetOverSumEtVsGJmass[hist0][hist1]->GetYaxis()->SetTitle("PFMET/SumEt (GeV)");  h_PFMetOverSumEtVsGJmass[hist0][hist1]->GetYaxis()->CenterTitle();
	h_PFMetOverSumEtVsGJmass[hist0][hist1]->GetXaxis()->SetTitle("Invt Mass (GeV)");  h_PFMetOverSumEtVsGJmass[hist0][hist1]->GetXaxis()->CenterTitle();
	h_PFMetOverSumEtVsGJmass[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_PhPt_vs_JetPt_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
        else sprintf(name, "h_PhPt_vs_bJetPt_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_PhPt_vs_bJetPt[hist0][hist1] = new TH2F(name,"Pt of Photon vs Jet ",120,0.0,4800.0,120,0.0,4800.0);
	h_PhPt_vs_bJetPt[hist0][hist1]->GetYaxis()->SetTitle("P_{T}^{Jet}");   h_PhPt_vs_bJetPt[hist0][hist1]->GetYaxis()->CenterTitle();
	h_PhPt_vs_bJetPt[hist0][hist1]->GetXaxis()->SetTitle("P_{T}^{#gamma}");  h_PhPt_vs_bJetPt[hist0][hist1]->GetXaxis()->CenterTitle();
	h_PhPt_vs_bJetPt[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_PhEta_vs_JetEta_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	else sprintf(name, "h_PhEta_vs_bJetEta_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_PhEta_vs_bJetEta[hist0][hist1] = new TH2F(name,"eta of Photon vs Jet ",100,-2.5,2.5,100,-2.5,2.5);
	h_PhEta_vs_bJetEta[hist0][hist1]->GetYaxis()->SetTitle("#eta^{Jet}");     h_PhEta_vs_bJetEta[hist0][hist1]->GetYaxis()->CenterTitle();
	h_PhEta_vs_bJetEta[hist0][hist1]->GetXaxis()->SetTitle("#eta^{#gamma}");  h_PhEta_vs_bJetEta[hist0][hist1]->GetXaxis()->CenterTitle();
	h_PhEta_vs_bJetEta[hist0][hist1]->Sumw2();

	sprintf(name, "h_CSVv2Dist_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_CSVv2Dist[hist0][hist1] = new TH1F(name, "CSVv2 bTagger Distribution", 500, 0.0, 5.0);
	h_CSVv2Dist[hist0][hist1]->GetYaxis()->SetTitle("Events");      h_CSVv2Dist[hist0][hist1]->GetYaxis()->CenterTitle();
	h_CSVv2Dist[hist0][hist1]->GetXaxis()->SetTitle("CSVv2");       h_CSVv2Dist[hist0][hist1]->GetXaxis()->CenterTitle();
	h_CSVv2Dist[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_CSVv2_vs_JetPt_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	else sprintf(name, "h_CSVv2_vs_bJetPt_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_CSVv2_vs_bJetPt[hist0][hist1] = new TH2F(name,"CSVv2 vs Jet Pt", 120, 0.0, 4800.0, 500, 0.0, 5.0);
	h_CSVv2_vs_bJetPt[hist0][hist1]->GetYaxis()->SetTitle("CSVv2");         h_CSVv2_vs_bJetPt[hist0][hist1]->GetYaxis()->CenterTitle();
	h_CSVv2_vs_bJetPt[hist0][hist1]->GetXaxis()->SetTitle("P_{T}^{Jet}");   h_CSVv2_vs_bJetPt[hist0][hist1]->GetXaxis()->CenterTitle();
	h_CSVv2_vs_bJetPt[hist0][hist1]->Sumw2();

	if(hist0 == 0) sprintf(name, "h_CSVv2_vs_JetEta_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	else sprintf(name, "h_CSVv2_vs_bJetEta_%s_%s",cut0[hist0].c_str(), cut1[hist1].c_str());
	h_CSVv2_vs_bJetEta[hist0][hist1] = new TH2F(name,"CSVv2 vs Jet Eta", 100, -2.5, 2.5, 500, 0.0, 5.0);
	h_CSVv2_vs_bJetEta[hist0][hist1]->GetYaxis()->SetTitle("CSVv2");         h_CSVv2_vs_bJetEta[hist0][hist1]->GetYaxis()->CenterTitle();
	h_CSVv2_vs_bJetEta[hist0][hist1]->GetXaxis()->SetTitle("#eta^{Jet}");    h_CSVv2_vs_bJetEta[hist0][hist1]->GetXaxis()->CenterTitle();
	h_CSVv2_vs_bJetEta[hist0][hist1]->Sumw2();
    ...
    std::string cut2[7] = {"noCut", "noBTag_noMassCut", "noBTag_MassCut", "1BTag_noMassCut", "1BTag_MassCut", "0BTag_noMassCut", "0BTag_MassCut"};
    for( Int_t hist = 0; hist < 7; ++hist ){
      sprintf(name, "h_goodPV_TotalWt_%s",cut2[hist].c_str());
      ...
      sprintf(name, "h_nIsoPhotons_%s",cut2[hist].c_str());
      h_nIsoPhotons[hist] = new TH1F(name,"No. of Isolated Photons", 400, 0, 200);
      h_nIsoPhotons[hist]->GetYaxis()->SetTitle("Events");         h_nIsoPhotons[hist]->GetYaxis()->CenterTitle();
      h_nIsoPhotons[hist]->GetXaxis()->SetTitle("nIsoPhotons");    h_nIsoPhotons[hist]->GetXaxis()->CenterTitle();
      h_nIsoPhotons[hist]->Sumw2();

      sprintf(name, "h_nGoodPhotons_%s",cut2[hist].c_str());
      h_nGoodPhotons[hist] = new TH1F(name,"No. of Good Isolated Photons", 400, 0, 200);
      h_nGoodPhotons[hist]->GetYaxis()->SetTitle("Events");          h_nGoodPhotons[hist]->GetYaxis()->CenterTitle();
      h_nGoodPhotons[hist]->GetXaxis()->SetTitle("nGoodPhotons");    h_nGoodPhotons[hist]->GetXaxis()->CenterTitle();
      h_nGoodPhotons[hist]->Sumw2();

      sprintf(name, "h_IsoPhotonIdxVsPt_%s",cut2[hist].c_str());
      h_IsoPhotonIdxVsPt[hist] = new TH2F(name,"Isolated Photons Index Vs Pt", 120, 0.0, 4800.0, 10, 0.0, 10.0);
      h_IsoPhotonIdxVsPt[hist]->GetYaxis()->SetTitle("IsoPhotonIdx");      h_IsoPhotonIdxVsPt[hist]->GetYaxis()->CenterTitle();
      h_IsoPhotonIdxVsPt[hist]->GetXaxis()->SetTitle("P^{T}_{#gamma}");    h_IsoPhotonIdxVsPt[hist]->GetXaxis()->CenterTitle();
      h_IsoPhotonIdxVsPt[hist]->Sumw2();
    
      sprintf(name, "h_GoodPhotonIdxVsPt_%s",cut2[hist].c_str());
      h_GoodPhotonIdxVsPt[hist] = new TH2F(name,"Good Isolated Photons Idx Vs Pt", 120, 0.0, 4800.0, 10, 0.0, 10.0);
      h_GoodPhotonIdxVsPt[hist]->GetYaxis()->SetTitle("GoodPhotonIdx");         h_GoodPhotonIdxVsPt[hist]->GetYaxis()->CenterTitle();
      h_GoodPhotonIdxVsPt[hist]->GetXaxis()->SetTitle("P^{T}_{#gamma}");       h_GoodPhotonIdxVsPt[hist]->GetXaxis()->CenterTitle();
      h_GoodPhotonIdxVsPt[hist]->Sumw2();

      sprintf(name, "h_nJets_%s",cut2[hist].c_str());
      ...
      sprintf(name, "h_JetIdxVsPt_%s",cut2[hist].c_str());
      h_JetIdxVsPt[hist] = new TH2F(name,"Jet Idx vs Pt", 120, 0.0, 4800.0, 20, 0.0, 20.0);
      h_JetIdxVsPt[hist]->GetYaxis()->SetTitle("Jet Idx");           h_JetIdxVsPt[hist]->GetYaxis()->CenterTitle();
      h_JetIdxVsPt[hist]->GetXaxis()->SetTitle("P^{T}_{Jet}");       h_JetIdxVsPt[hist]->GetXaxis()->CenterTitle();
      h_JetIdxVsPt[hist]->Sumw2();
    ...
    TString CutFlowLabels[nbins] = {"Total", "HLT", "PrimaryVtx", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "DPhi", "DEta", "MassCut", "1BTag_noMassCut", "1BTag_MassCut", "0BTag_noMassCut", "0BTag_MassCut"};
    TString CutFlowLabels_TotalWts[nbinsWt] = {"Total", "HLT", "PrimaryVtx", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "DPhi", "DEta", "MassCut", "1BTag_noMassCut", "1BTag_MassCut", "0BTag_noMassCut", "0BTag_MassCut"};
    TString CutFlowLabels_PreBTagWts[nbinsWt] = {"Total", "HLT", "PrimaryVtx", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "DPhi", "DEta", "MassCut", "1BTag_noMassCut", "1BTag_MassCut", "0BTag_noMassCut", "0BTag_MassCut"};
    ...
    h_CutFlow_TotalWts = new TH1F("h_CutFlow_TotalWts", "Events Passing Various Cuts With Total Weights", nbinsWt, 0, nbinsWt);
    h_CutFlow_TotalWts->GetYaxis()->SetTitle("Events");         h_CutFlow_TotalWts->GetYaxis()->CenterTitle();
    for(int i = 0; i < nbinsWt; i++){
      h_CutFlow_TotalWts->GetXaxis()->SetBinLabel(i+1, CutFlowLabels_TotalWts[i]);
    }

    h_CutFlow_PreBTagWts = new TH1F("h_CutFlow_PreBTagWts", "Events Passing Various Cuts With PreBTag Weights", nbinsWt, 0, nbinsWt);
    h_CutFlow_PreBTagWts->GetYaxis()->SetTitle("Events");         h_CutFlow_PreBTagWts->GetYaxis()->CenterTitle();
    for(int i = 0; i < nbinsWt; i++){
      h_CutFlow_PreBTagWts->GetXaxis()->SetBinLabel(i+1, CutFlowLabels_PreBTagWts[i]);
    }
...
####Compilation
g++ -Wno-deprecated analysis_${filenameTag}.C /uscms_data/d3/rocky86/13TeV/PostAnalyzer_Bstar13TeV_74X/PostAnalyzer_MC/PA_Main/BtagSF/BTagCalibrationStandalone.o -o ${filenameTag}.exe -I$ROOTSYS/include -L$ROOTSYS/lib `root-config --cflags` `root-config --libs`
