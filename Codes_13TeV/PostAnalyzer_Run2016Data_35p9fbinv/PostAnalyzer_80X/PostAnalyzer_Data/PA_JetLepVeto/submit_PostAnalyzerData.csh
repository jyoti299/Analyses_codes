...
#Run2016BCDEFG_PromptReco
#setenv DatanTuplesDir root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/Ntuples/80X/Data/ReReco-BCDEFG_PromptReco-H
setenv DatanTuplesDir root://cmseos.fnal.gov//eos/uscms/store/user/rocky86/13TeV/Ntuples/80X/Data/ReReco-BCDEFG_PromptReco-H/

foreach i (Run2016B-23Sep2016_ReReco-v3  Run2016C-23Sep2016_ReReco-v1  Run2016D-23Sep2016_ReReco-v1  Run2016E-23Sep2016_ReReco-v1  Run2016F-23Sep2016_ReReco-v1  Run2016G-23Sep2016_ReReco-v1  Run2016H-PromptReco-v2  Run2016H-PromptReco-v3)
...
Bool_t PostAnalyzer_Data::ResSpikes(Int_t i){
  Bool_t spikes = false;
  if( fabs((*phoseedTimeFull5x5)[i]) < 3.0    &&  //time of arrival of ith photon at seed crystal
...
Bool_t PostAnalyzer_Data::CutBasedElectronID(Int_t iele, UShort_t WP){
...
Bool_t PostAnalyzer_Data::OverlapWithElectron(double jeteta, double jetphi){
...
Bool_t PostAnalyzer_Data::OverlapWithMuon(double jeteta, double jetphi){
...
void PostAnalyzer_Data::BookHistograms(){
  ...
  */
  ...
  TString CutFlowLabels_qstar[nbins_qstar] = {"Total", "HLT", "PrimaryVtx_&_METFilters", "PhotonID", "PhotonPtEta", "JetID&LepVeto", "JetPt", "JetEta", "DPhi", "DEta", "MassCut"};
  TString CutFlowLabels_bstar[nbins_bstar] = {"Total", "HLT", "PrimaryVtx_&_METFilters", "PhotonID", "PhotonPtEta", "JetID&LepVeto", "JetPt", "JetEta", "1BTag", "1BTag_DPhi", "1BTag_DEta", "1BTag_MassCut", "0BTag", "0BTag_DPhi", "0BTag_DEta", "0BTag_MassCut"};
