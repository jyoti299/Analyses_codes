...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	if(CutBasedPhotonID(i, "tight") && fabs((*phoSCEta)[i]) < 2.4 && (*phoEt)[i] > 30.0) TrigPhotons.push_back(i);
      }
	...
	for(Int_t ii = 0; ii < TrigPhotons.size(); ii++){
	  if(GetdR((*phoSCEta)[TrigPhotons[ii]], (*muEta)[MuIdx], (*phoSCPhi)[TrigPhotons[ii]], (*muPhi)[MuIdx]) < 0.5){
