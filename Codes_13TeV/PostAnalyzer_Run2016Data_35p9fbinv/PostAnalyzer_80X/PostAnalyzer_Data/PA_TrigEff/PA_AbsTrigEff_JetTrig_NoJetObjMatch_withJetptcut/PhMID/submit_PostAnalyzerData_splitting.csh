...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   HLT_deno.push_back(HLT_PFJet140_v );
   ...
   JetTrigObjs.push_back(hltSinglePFJet140 );
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	if(PassHLTDeno){
	  ...
	  h_TrigInvtmass[0]->Fill(GetInvtMass(TrigPhotons[0], TrigJets[0]));
	  if(PassHLTNum){
	    h_TrigPhotonPt[1]->Fill((*phoEt)[TrigPhotons[0]]);
	    h_TrigInvtmass[1]->Fill(GetInvtMass(TrigPhotons[0], TrigJets[0]));
	  }
	}
      }
