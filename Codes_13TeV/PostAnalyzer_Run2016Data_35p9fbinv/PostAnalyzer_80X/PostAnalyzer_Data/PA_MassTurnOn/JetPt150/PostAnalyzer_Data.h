...
// used to generate this class and read the Tree.
   if (tree == 0) {
     ...
     // chain->Add("/eos/uscms/store/user/lpcqstar/13TeV/Ntuples/80X/Data/reMiniAOD03Feb2017/singlePhotonRun2016Bv2/Data_newSinglePhotonRun2016Bv2_1.root/ggNtuplizer/EventTree");
      //      chain->Add("/eos/uscms/store/user/lpcqstar/13TeV/Ntuples/80X/Data/ReReco-BCDEFG_PromptReco-H/Run2016G-23Sep2016_ReReco-v1/Data_Run2016G-23Sep2016_ReReco-v1_1.root/ggNtuplizer/EventTree");
      ...
      TString main_path = "root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/Ntuples/80X/Data/reMiniAOD03Feb2017//singlePhotonRun2016Hv3/";
...
*/
      ...
      ifstream Dataset;
      Dataset.open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_2015+2016/PostAnalyzer_80X/PostAnalyzer_Data/PA_MassTurnOn/JetPt150//Dataset_singlePhotonRun2016Hv3.txt", ifstream::in);
      char datafilename[500];

      if(Dataset) cout << "Dataset_singlePhotonRun2016Hv3.txt Opened" << endl;

      int a = 0;
      for(Int_t i = 1; i <= 50 && i <= 25; i++){      
	...
	string main_path = "root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/Ntuples/80X/Data/reMiniAOD03Feb2017//singlePhotonRun2016Hv3/";
