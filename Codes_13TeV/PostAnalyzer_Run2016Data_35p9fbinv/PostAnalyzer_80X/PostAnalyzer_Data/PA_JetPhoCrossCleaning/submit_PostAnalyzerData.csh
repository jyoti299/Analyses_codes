  ...
  //List of single photon triggers in data (Listed here just for information, not used anywhere in the study)
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	for(Int_t ip = 0; ip <  GoodIsoPhotons.size(); ip++){
      ...
      GoodIsoJets = GoodJets_CrossCleanedWithAllPhotons(Cut_JetId); // All jets passing dR with all photons > 0.5, tight jet id and pt > 30.0 
...
public :
   ...
   virtual vector<Int_t> GoodJets_CrossCleanedWithAllPhotons(TString jetWP);
...
//Checking if the selected jets are dr > 0.5 away from all the good photons instead of looking with only leading one.
vector<Int_t> PostAnalyzer_Data::GoodJets_CrossCleanedWithAllPhotons(TString jetWP){
