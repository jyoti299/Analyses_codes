  ...
  //For now using binning of q* 8 TeV.
   ...
   //latest binning based on q* and b* mass resolution (Summer16)
    ...
    for(Int_t hist2 = 0; hist2 < 3; ++hist2){
      ...
      //h_bEff_vs_pt[hist2] = new TH1F(name, "bEff_vs_pt", 200, 0, 2000);
      ...
      //h_cEff_vs_pt[hist2] = new TH1F(name, "cEff_vs_pt", 200, 0, 2000);
      ...
      //h_udsgEff_vs_pt[hist2] = new TH1F(name, "udsgEff_vs_pt", 200, 0, 2000);
