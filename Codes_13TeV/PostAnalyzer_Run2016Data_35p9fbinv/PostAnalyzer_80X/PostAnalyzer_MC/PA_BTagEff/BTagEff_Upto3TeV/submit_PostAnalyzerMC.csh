...
void PostAnalyzer_MC::BookHistograms(){
  ...
  //For now using binning of q* 8 TeV.
   ...
   //latest binning based on q* and b* mass resolution (Summer16)
    ...
    const Int_t n_eff_pt = 30;
    const Double_t Eff_bins_pt[n_eff_pt+1] = {20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 250, 300, 350, 400, 450, 500, 550, 600, 700, 800, 900, 1000, 1200, 1400, 1600, 1800, 2000, 2500, 3000, 3500, 4000};
    ...
    for(Int_t hist2 = 0; hist2 < 3; ++hist2){
      ...
      //h_bEff_vs_pt[hist2] = new TH1F(name, "bEff_vs_pt", 400, 0, 4000);
      ...
      //h_cEff_vs_pt[hist2] = new TH1F(name, "cEff_vs_pt", 400, 0, 4000);
      ...
      //h_udsgEff_vs_pt[hist2] = new TH1F(name, "udsgEff_vs_pt", 400, 0, 4000);
