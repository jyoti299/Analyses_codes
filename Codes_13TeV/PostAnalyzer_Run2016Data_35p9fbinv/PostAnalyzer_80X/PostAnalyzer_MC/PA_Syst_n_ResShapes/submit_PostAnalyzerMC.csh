...
set totalEvents = ()
set mass_norm = ( 500.0  1000.0  2000.0  3000.0  4000.0  5000.0  6000.0  7000.0  8000.0  9000.0 )
...
set totalEvents = ()
set mass_norm = ( 500.0  1000.0  1500.0  2000.0  2500.0  3000.0  3500.0  4000.0  4500.0  5000.0 )
...
set totalEvents = ()
set mass_norm = ( 100.0  200.0  400.0  600.0  1000.0 )
...
set totalEvents = ()
set mass_norm = ( 120.0  170.0  300.0  470.0  600.0  800.0  1000.0  1400.0  1800.0  2400.0  3200.0 )
...
set totalEvents = ()
set mass_norm = ( 1000.0  2000.0  3000.0 4000.0 5000.0)
	  ...
	  if(GoodIsoPhotons.size() > 0){
		...
		if(Pass_JetPt){
		  ...
		  if(Pass_JetEta){
			...
			h_mass_X_bin1[0]->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);

			h_mass_X_bin1_JES[0][0]->Fill(Mass_JESup/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
			h_mass_X_bin1_JES[1][0]->Fill(Mass_JESdown/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
			...
			h_mass_X_bin1_JER[0]->Fill(Mass_JER/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
			...
			h_mass_X_bin1_PES[0][0]->Fill(Mass_PESup/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
			h_mass_X_bin1_PES[1][0]->Fill(Mass_PESdown/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
			...
			h_mass_X_bin1_PER[0]->Fill(Mass_PER/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
		...
		if(Pass_JetPt){
		  ...
		  if(Pass_JetEta){
			...
			if(Pass_GJdEta){
			  ...
			  h_mass_X_bin1[1]->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, Total_EvtWt_1tag);

			  h_mass_X_bin1_JES[0][1]->Fill(Mass_JESup/${mass_norm[${sampleIndex}]}, Total_EvtWt_1tag);
			  h_mass_X_bin1_JES[1][1]->Fill(Mass_JESdown/${mass_norm[${sampleIndex}]}, Total_EvtWt_1tag);

			  //0BTag
			  h_mass_JES[0][2]->Fill(Mass_JESup, Total_EvtWt_0tag);
			  h_mass_JES[1][2]->Fill(Mass_JESdown, Total_EvtWt_0tag);

			  h_mass_X_bin1[2]->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, Total_EvtWt_0tag);

			  h_mass_X_bin1_JES[0][2]->Fill(Mass_JESup/${mass_norm[${sampleIndex}]}, Total_EvtWt_0tag);
			  h_mass_X_bin1_JES[1][2]->Fill(Mass_JESdown/${mass_norm[${sampleIndex}]}, Total_EvtWt_0tag);
			  ...
			  h_mass_X_bin1_JER[1]->Fill(Mass_JER/${mass_norm[${sampleIndex}]}, Total_EvtWt_1tag);
			  h_mass_X_bin1_JER[2]->Fill(Mass_JER/${mass_norm[${sampleIndex}]}, Total_EvtWt_0tag);
			  ...
			  h_mass_X_bin1_PES[0][1]->Fill(Mass_PESup/${mass_norm[${sampleIndex}]}, Total_EvtWt_1tag);
			  h_mass_X_bin1_PES[1][1]->Fill(Mass_PESdown/${mass_norm[${sampleIndex}]}, Total_EvtWt_1tag);

			  //0BTag
			  h_mass_PES[0][2]->Fill(Mass_PESup, Total_EvtWt_0tag);
			  h_mass_PES[1][2]->Fill(Mass_PESdown, Total_EvtWt_0tag);

			  h_mass_X_bin1_PES[0][2]->Fill(Mass_PESup/${mass_norm[${sampleIndex}]}, Total_EvtWt_0tag);
			  h_mass_X_bin1_PES[1][2]->Fill(Mass_PESdown/${mass_norm[${sampleIndex}]}, Total_EvtWt_0tag);
			  ...
			  h_mass_X_bin1_PER[1]->Fill(Mass_PER/${mass_norm[${sampleIndex}]}, Total_EvtWt_1tag);
			  h_mass_X_bin1_PER[2]->Fill(Mass_PER/${mass_norm[${sampleIndex}]}, Total_EvtWt_0tag);

			  //BSF
			  h_profile_BSF[0]->Fill(GetInvtMass(PC, JC), (SFup - SF)/SF);
			  h_profile_BSF[1]->Fill(GetInvtMass(PC, JC), (SFdown - SF)/SF);
			 
			  h_mass_X_bin1_BSF[0][0]->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, Total_EvtWt_1tag_up);
			  h_mass_X_bin1_BSF[0][1]->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, Total_EvtWt_1tag_down);
			  h_mass_X_bin1_BSF[1][0]->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, Total_EvtWt_0tag_up);
			  h_mass_X_bin1_BSF[1][1]->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, Total_EvtWt_0tag_down);
			...
			if(Pass_GJdEta){
			  ...
			  h_mass_X_bin1[2]->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);

			  h_mass_X_bin1_JES[0][2]->Fill(Mass_JESup/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
			  h_mass_X_bin1_JES[1][2]->Fill(Mass_JESdown/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
			  ...
			  h_mass_X_bin1_JER[2]->Fill(Mass_JER/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
			  ...
			  h_mass_X_bin1_PES[0][2]->Fill(Mass_PESup/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
			  h_mass_X_bin1_PES[1][2]->Fill(Mass_PESdown/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
			  ...
			  h_mass_X_bin1_PER[2]->Fill(Mass_PER/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);

			  //BSF                                                            
                          h_mass_X_bin1_BSF[1][0]->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
                          h_mass_X_bin1_BSF[1][1]->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);
...
public :
   ...
   Double_t Total_EvtWt_1tag_up, Total_EvtWt_0tag_up, Total_EvtWt_1tag_down, Total_EvtWt_0tag_down;
   Double_t PU_EvtWt_XSm5, Total_EvtWt_XSm5, PU_EvtWt_XSp5, Total_EvtWt_XSp5;
   ...
   //For JER
   TLorentzVector PFJet4Vec_JER, GJ4Vec_JER;
   Double_t Mass_JER;
   //For PES
   ...
   //For PER
   TLorentzVector Photon4Vec_PER, GJ4Vec_PER;
   Double_t Mass_PER;
   ...
   //Histograms
   //For JES                         
   TProfile *h_profile_JES[2][3];
   TH1F *h_mass_JES[2][3];

   //JER
   TProfile *h_profile_JER[3];
   TH1F *h_mass_JER[3];
   
   //PES
   TProfile *h_profile_PES[2][3];
   TH1F *h_mass_PES[2][3];

   //PER
   TProfile *h_profile_PER[3];
   TH1F *h_mass_PER[3];

   //BSF
   TProfile *h_profile_BSF[2];

   TH1F *h_mass_X_bin1[3];
   TH1F *h_mass_X_bin1_JES[2][3];
   TH1F *h_mass_X_bin1_PES[2][3];
   TH1F *h_mass_X_bin1_BSF[2][2];
   TH1F *h_mass_X_bin1_JER[3];
   TH1F *h_mass_X_bin1_PER[3];
   ...
   TH1F *h_CutFlowWt_qstar_XSm5;
   TH1F *h_CutFlowWt_qstar_XSp5;

   //Pileup Reweighting
   TH1F *h_DataPUNormDist;
   TH1F *h_DataPUNormDist_XSm5;
   TH1F *h_DataPUNormDist_XSp5;
   TH1F *h_MCPUNormDist;
   TH1F *h_MCPUNormDist_XSm5;
   TH1F *h_MCPUNormDist_XSp5;
   ...
   virtual Double_t PUWeights_XSm5(Float_t npv);
   virtual void     PileupReWeighting_XSp5();
   virtual Double_t PUWeights_XSp5(Float_t npv);
...
Bool_t PostAnalyzer_MC::IsOverlappedEvent(Int_t pc){
  ...
  Int_t pc_match = -1;
  pc_match = MatchedGenPhotonToReco(pc); //Matched prompt gen photon with dR < 0.1 and dpt/pt < 0.1
...
void PostAnalyzer_MC::PileupReWeighting_XSm5(){
  ...
  //    Bool_t Pileup_Qstar = ${Qstar};
    ...
    //For Run2016BCDEFG_PromptReco
  TFile *fData = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_2015+2016/PostAnalyzer_80X/PostAnalyzer_MC/PA_Main/PileupHistograms/Data_ReReco-BCDEFG_PromptReco-H_PileUpDist_m5/DataPileupHist.root");
  TH1F *dataPU = (TH1F*)fData->Get("pileup");
  ...
  TH1F *h_MCWeights = new TH1F("h_MCWeights", "MC PileUp Weights", 50, 0, 50);
  for(Int_t ibin = 0; ibin < 50; ibin++){
    h_DataPUNormDist_XSm5->SetBinContent(ibin+1, DataPileUp[ibin]); //This to get in output
    h_PUScaleFactor_XSm5->SetBinContent(ibin+1, DataPileUp[ibin]);
    h_MCPUNormDist_XSm5->SetBinContent(ibin+1, mcPileUp[ibin]);
    h_MCWeights->SetBinContent(ibin+1, mcPileUp[ibin]);
  }

  h_DataPUNormDist_XSm5->Scale(1.0/h_DataPUNormDist_XSm5->Integral());
  h_PUScaleFactor_XSm5->Scale(1.0/h_PUScaleFactor_XSm5->Integral());
  h_MCPUNormDist_XSm5->Scale(1.0/h_MCPUNormDist_XSm5->Integral());
  h_MCWeights->Scale(1.0/h_MCWeights->Integral());
...
void PostAnalyzer_MC::PileupReWeighting_XSp5(){
  ...
  //    Bool_t Pileup_Qstar = ${Qstar};
    ...
    //For Run2016BCDEFG_PromptReco
  TFile *fData = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_2015+2016/PostAnalyzer_80X/PostAnalyzer_MC/PA_Main/PileupHistograms/Data_ReReco-BCDEFG_PromptReco-H_PileUpDist_p5/DataPileupHist.root");
  TH1F *dataPU = (TH1F*)fData->Get("pileup");
  ...
  TH1F *h_MCWeights = new TH1F("h_MCWeights", "MC PileUp Weights", 50, 0, 50);
  for(Int_t ibin = 0; ibin < 50; ibin++){
    h_DataPUNormDist_XSp5->SetBinContent(ibin+1, DataPileUp[ibin]); //This to get in output
    h_PUScaleFactor_XSp5->SetBinContent(ibin+1, DataPileUp[ibin]);
    h_MCPUNormDist_XSp5->SetBinContent(ibin+1, mcPileUp[ibin]);
    h_MCWeights->SetBinContent(ibin+1, mcPileUp[ibin]);
  }

  h_DataPUNormDist_XSp5->Scale(1.0/h_DataPUNormDist_XSp5->Integral());
  h_PUScaleFactor_XSp5->Scale(1.0/h_PUScaleFactor_XSp5->Integral());
  h_MCPUNormDist_XSp5->Scale(1.0/h_MCPUNormDist_XSp5->Integral());
  h_MCWeights->Scale(1.0/h_MCWeights->Integral());
...
void PostAnalyzer_MC::BookHistograms(){
  ...
  //For now using binning of q* 8 TeV.
   ...
   //latest binning based on q* and b* mass resolution (Summer16)
    ...
    std::string level[3] = {"", "_1bTag", "_0bTag"};
    std::string btag[2] = {"_1bTag", "_0bTag"};

    for (int ii = 0; ii < 2; ii++){
      for(int jj = 0; jj < 3; jj++){

	sprintf(hname, "h_profile_JES_%s%s", scale[ii].c_str(), level[jj].c_str());
	sprintf(htit, "Profile of JES_%s vs Mass %s", scale[ii].c_str(), level[jj].c_str());
	h_profile_JES[ii][jj] = new TProfile(hname, htit, nMassBins, MassBin);

	sprintf(hname, "h_mass_JES_%s%s", scale[ii].c_str(), level[jj].c_str());
	sprintf(htit, "Mass Distribution for JES_%s %s", scale[ii].c_str(), level[jj].c_str());
	h_mass_JES[ii][jj] = new TH1F(hname, htit, nMassBins, MassBin);
	h_mass_JES[ii][jj]->GetYaxis()->SetTitle("Events"); h_mass_JES[ii][jj]->GetYaxis()->CenterTitle();
	h_mass_JES[ii][jj]->GetXaxis()->SetTitle("Mass M_{#gammaj} (GeV)"); h_mass_JES[ii][jj]->GetXaxis()->CenterTitle();
	h_mass_JES[ii][jj]->Sumw2();

	sprintf(hname, "h_mass_X_bin1_JES_%s%s", scale[ii].c_str(), level[jj].c_str());
	sprintf(htit, "X dist of Invt Mass for JES_%s", scale[ii].c_str());
	h_mass_X_bin1_JES[ii][jj] = new TH1F(hname, htit, 14000,0.0,5.0);
	h_mass_X_bin1_JES[ii][jj]->GetYaxis()->SetTitle("Events");   h_mass_X_bin1_JES[ii][jj]->GetYaxis()->CenterTitle();
	h_mass_X_bin1_JES[ii][jj]->GetXaxis()->SetTitle("X = M_{#gammaj}/M_{Res}");    h_mass_X_bin1_JES[ii][jj]->GetXaxis()->CenterTitle();
	h_mass_X_bin1_JES[ii][jj]->Sumw2();

	sprintf(hname, "h_profile_PES_%s%s", scale[ii].c_str(), level[jj].c_str());
	sprintf(htit, "Profile of PES_%s vs Mass %s", scale[ii].c_str(), level[jj].c_str());
	h_profile_PES[ii][jj] = new TProfile(hname, htit, nMassBins, MassBin);

	sprintf(hname, "h_mass_PES_%s%s", scale[ii].c_str(), level[jj].c_str());
	sprintf(htit, "Mass Distribution for PES_%s %s", scale[ii].c_str(), level[jj].c_str());
	h_mass_PES[ii][jj] = new TH1F(hname, htit, nMassBins, MassBin);
	h_mass_PES[ii][jj]->GetYaxis()->SetTitle("Events"); h_mass_PES[ii][jj]->GetYaxis()->CenterTitle();
	h_mass_PES[ii][jj]->GetXaxis()->SetTitle("Mass M_{#gammaj} (GeV)"); h_mass_PES[ii][jj]->GetXaxis()->CenterTitle();
	h_mass_PES[ii][jj]->Sumw2();

	sprintf(hname, "h_mass_X_bin1_PES_%s%s", scale[ii].c_str(), level[jj].c_str());
	sprintf(htit, "X dist of Invt Mass for PES_%s", scale[ii].c_str());
	h_mass_X_bin1_PES[ii][jj] = new TH1F(hname, htit, 14000,0.0,5.0);
	h_mass_X_bin1_PES[ii][jj]->GetYaxis()->SetTitle("Events");   h_mass_X_bin1_PES[ii][jj]->GetYaxis()->CenterTitle();
	h_mass_X_bin1_PES[ii][jj]->GetXaxis()->SetTitle("X = M_{#gammaj}/M_{Res}");    h_mass_X_bin1_PES[ii][jj]->GetXaxis()->CenterTitle();
	h_mass_X_bin1_PES[ii][jj]->Sumw2();
    ...
    for(int jj = 0; jj < 3; jj++){
      ...
      sprintf(hname, "h_profile_JER%s", level[jj].c_str());
      sprintf(htit, "Profile of JER%s vs Mass ", level[jj].c_str());
      h_profile_JER[jj] = new TProfile(hname, htit, nMassBins, MassBin);

      sprintf(hname, "h_mass_JER%s", level[jj].c_str());
      sprintf(htit, "Mass Distribution for JER%s", level[jj].c_str());
      h_mass_JER[jj] = new TH1F(hname, htit, nMassBins, MassBin);
      h_mass_JER[jj]->GetYaxis()->SetTitle("Events"); h_mass_JER[jj]->GetYaxis()->CenterTitle();
      h_mass_JER[jj]->GetXaxis()->SetTitle("Mass M_{#gammaj} (GeV)"); h_mass_JER[jj]->GetXaxis()->CenterTitle();
      h_mass_JER[jj]->Sumw2();

      sprintf(hname, "h_mass_X_bin1_JER%s", level[jj].c_str());
      sprintf(htit, "X dist of Invt Mass for JER%s", level[jj].c_str());
      h_mass_X_bin1_JER[jj] = new TH1F(hname, htit, 14000,0.0,5.0);
      h_mass_X_bin1_JER[jj]->GetYaxis()->SetTitle("Events");   h_mass_X_bin1_JER[jj]->GetYaxis()->CenterTitle();
      h_mass_X_bin1_JER[jj]->GetXaxis()->SetTitle("X = M_{#gammaj}/M_{Res}");    h_mass_X_bin1_JER[jj]->GetXaxis()->CenterTitle();
      h_mass_X_bin1_JER[jj]->Sumw2();

      sprintf(hname, "h_profile_PER%s", level[jj].c_str());
      sprintf(htit, "Profile of PER%s vs Mass ", level[jj].c_str());
      h_profile_PER[jj] = new TProfile(hname, htit, nMassBins, MassBin);

      sprintf(hname, "h_mass_PER%s", level[jj].c_str());
      sprintf(htit, "Mass Distribution for PER%s", level[jj].c_str());
      h_mass_PER[jj] = new TH1F(hname, htit, nMassBins, MassBin);
      h_mass_PER[jj]->GetYaxis()->SetTitle("Events"); h_mass_PER[jj]->GetYaxis()->CenterTitle();
      h_mass_PER[jj]->GetXaxis()->SetTitle("Mass M_{#gammaj} (GeV)"); h_mass_PER[jj]->GetXaxis()->CenterTitle();
      h_mass_PER[jj]->Sumw2();

      sprintf(hname, "h_mass_X_bin1_PER%s", level[jj].c_str());
      sprintf(htit, "X dist of Invt Mass for PER%s", level[jj].c_str());
      h_mass_X_bin1_PER[jj] = new TH1F(hname, htit, 14000,0.0,5.0);
      h_mass_X_bin1_PER[jj]->GetYaxis()->SetTitle("Events");   h_mass_X_bin1_PER[jj]->GetYaxis()->CenterTitle();
      h_mass_X_bin1_PER[jj]->GetXaxis()->SetTitle("X = M_{#gammaj}/M_{Res}");    h_mass_X_bin1_PER[jj]->GetXaxis()->CenterTitle();
      h_mass_X_bin1_PER[jj]->Sumw2();

    }

    for(int ki = 0; ki < 2; ki++){

      sprintf(hname, "h_profile_BSF_%s", scale[ki].c_str());
      sprintf(htit, "Profile of BSF_%s vs Mass ", scale[ki].c_str());
      h_profile_BSF[ki] = new TProfile(hname, htit, nMassBins, MassBin);
    }
	...
	sprintf(hname, "h_mass_X_bin1_BSF%s_%s", btag[ik].c_str(), scale[kk].c_str());
	sprintf(htit, "X dist of Invt Mass for BSF %s%s", btag[ik].c_str(), scale[kk].c_str());
	h_mass_X_bin1_BSF[ik][kk] = new TH1F(hname, htit, 14000,0.0,5.0);
	h_mass_X_bin1_BSF[ik][kk]->GetYaxis()->SetTitle("Events");   h_mass_X_bin1_BSF[ik][kk]->GetYaxis()->CenterTitle();
	h_mass_X_bin1_BSF[ik][kk]->GetXaxis()->SetTitle("X = M_{#gammaj}/M_{Res}");  h_mass_X_bin1_BSF[ik][kk]->GetXaxis()->CenterTitle();
	h_mass_X_bin1_BSF[ik][kk]->Sumw2();
    ...
    for(Int_t ij = 0; ij < 3; ij++){
      ...
      sprintf(hname, "h_mass_X_bin1%s", level[ij].c_str());
      sprintf(htit, "X dist of Invt Mass %s", level[ij].c_str());
      h_mass_X_bin1[ij] = new TH1F(hname, htit, 14000,0.0,5.0);
      h_mass_X_bin1[ij]->GetYaxis()->SetTitle("Events");     h_mass_X_bin1[ij]->GetYaxis()->CenterTitle();
      h_mass_X_bin1[ij]->GetXaxis()->SetTitle("X = M_{#gammaj}/M_{Res}");   h_mass_X_bin1[ij]->GetXaxis()->CenterTitle();
      h_mass_X_bin1[ij]->Sumw2();

    }

    std::string cut0[6] = {"noMassCut", "MassCut", "1BTag_noMassCut", "1BTag_MassCut", "0BTag_noMassCut", "0BTag_MassCut"};
    for(Int_t hist0 = 0; hist0 < 6; ++hist0){

      if(hist0 == 0 || hist0 == 1) sprintf(name, "h_GJetInvtMass_UnitBin_%s",cut0[hist0].c_str());
    ...
    //XS - 5% of XS
    h_DataPUNormDist_XSm5 = new TH1F("h_DataPUNormDist_XSm5", "Normalized Data PileUp Distribution", 50, 0, 50);
    h_DataPUNormDist_XSm5->GetYaxis()->SetTitle("Events");           h_DataPUNormDist_XSm5->GetYaxis()->CenterTitle();
    h_DataPUNormDist_XSm5->GetXaxis()->SetTitle("nPUV");             h_DataPUNormDist_XSm5->GetXaxis()->CenterTitle();
    h_DataPUNormDist_XSm5->Sumw2();
  
    h_MCPUNormDist_XSm5 = new TH1F("h_MCPUNormDist_XSm5", "Normalized MC PileUp Distribution",50, 0, 50);
    h_MCPUNormDist_XSm5->GetYaxis()->SetTitle("Events");             h_MCPUNormDist_XSm5->GetYaxis()->CenterTitle();
    h_MCPUNormDist_XSm5->GetXaxis()->SetTitle("nPUV");               h_MCPUNormDist_XSm5->GetXaxis()->CenterTitle();
    h_MCPUNormDist_XSm5->Sumw2();
  
    h_PUScaleFactor_XSm5 = new TH1F("h_PUScaleFactor_XSm5", "PileUp Scale Factors Distribution", 50, 0, 50);
    h_PUScaleFactor_XSm5->GetYaxis()->SetTitle("SF");      h_PUScaleFactor_XSm5->GetYaxis()->CenterTitle();
    h_PUScaleFactor_XSm5->GetXaxis()->SetTitle("nPUV");              h_PUScaleFactor_XSm5->GetXaxis()->CenterTitle();
    h_PUScaleFactor_XSm5->Sumw2();

    //XS + 5% of XS
    h_DataPUNormDist_XSp5 = new TH1F("h_DataPUNormDist_XSp5", "Normalized Data PileUp Distribution", 50, 0, 50);
    h_DataPUNormDist_XSp5->GetYaxis()->SetTitle("Events");           h_DataPUNormDist_XSp5->GetYaxis()->CenterTitle();
    h_DataPUNormDist_XSp5->GetXaxis()->SetTitle("nPUV");             h_DataPUNormDist_XSp5->GetXaxis()->CenterTitle();
    h_DataPUNormDist_XSp5->Sumw2();
  
    h_MCPUNormDist_XSp5 = new TH1F("h_MCPUNormDist_XSp5", "Normalized MC PileUp Distribution",50, 0, 50);
    h_MCPUNormDist_XSp5->GetYaxis()->SetTitle("Events");             h_MCPUNormDist_XSp5->GetYaxis()->CenterTitle();
    h_MCPUNormDist_XSp5->GetXaxis()->SetTitle("nPUV");               h_MCPUNormDist_XSp5->GetXaxis()->CenterTitle();
    h_MCPUNormDist_XSp5->Sumw2();
  
    h_PUScaleFactor_XSp5 = new TH1F("h_PUScaleFactor_XSp5", "PileUp Scale Factors Distribution", 50, 0, 50);
    h_PUScaleFactor_XSp5->GetYaxis()->SetTitle("SF");      h_PUScaleFactor_XSp5->GetYaxis()->CenterTitle();
    ...
    TString CutFlowLabels_qstar[nbins_qstar] = {"Total", "HLT", "PrimaryVtx", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "DPhi", "DEta", "DEta_AfterOverlapRemoval", "MassCut"};
  ...
  TString CutFlowLabelsWt_qstar[nbinsWt_qstar] = {"Total", "HLT", "PrimaryVtx", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "DPhi", "DEta", "DEta_AfterOverlapRemoval", "MassCut"};
  ...
  TString CutFlowLabelsTotalWt_bstar[nbinsTotalWt_bstar] = {"Total", "HLT", "PrimaryVtx", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "1BTag", "1BTag_DPhi", "1BTag_DEta", "1BTag_MassCut", "0BTag", "0BTag_DPhi", "0BTag_DEta", "0BTag_MassCut"};
    ...
    h_CutFlowWt_qstar_XSm5 = new TH1F("h_CutFlowWt_qstar_XSm5", "Events Passing Various Cuts With Weights", nbinsWt_qstar, 0, nbinsWt_qstar);
    h_CutFlowWt_qstar_XSm5->GetYaxis()->SetTitle("Events");         h_CutFlowWt_qstar_XSm5->GetYaxis()->CenterTitle();
    for(int i = 0; i < nbinsWt_qstar; i++){
      h_CutFlowWt_qstar_XSm5->GetXaxis()->SetBinLabel(i+1, CutFlowLabelsWt_qstar[i]);
    }

    h_CutFlowWt_qstar_XSp5 = new TH1F("h_CutFlowWt_qstar_XSp5", "Events Passing Various Cuts With Weights", nbinsWt_qstar, 0, nbinsWt_qstar);
    h_CutFlowWt_qstar_XSp5->GetYaxis()->SetTitle("Events");         h_CutFlowWt_qstar_XSp5->GetYaxis()->CenterTitle();
    for(int i = 0; i < nbinsWt_qstar; i++){
      h_CutFlowWt_qstar_XSp5->GetXaxis()->SetBinLabel(i+1, CutFlowLabelsWt_qstar[i]);
    }
