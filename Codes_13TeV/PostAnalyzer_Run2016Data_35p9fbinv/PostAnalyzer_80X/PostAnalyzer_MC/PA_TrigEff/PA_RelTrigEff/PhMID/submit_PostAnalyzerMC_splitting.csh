   ...
   */
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	for(Int_t i = 0; i < TrigPhotons.size(); i++){
	  if(PhoTrigObjMatching(i, PhodenoTrigObjs)){
	    h_TrigPhotonPt[0]->Fill((*phoEt)[TrigPhotons[i]]);
	    if(PassHLTNum){
	      if(PhoTrigObjMatching(i, PhoTrigObjs)){
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      //chain->Add("/eos/uscms/store/user/lpcqstar/13TeV/Ntuples/80X/MC/Summer16TrancheIV/GJ_madgraph/GJets_HT200To400/GJets_HT200To400_233.root/ggNtuplizer/EventTree");
      //chain->Add("/eos/uscms/store/user/lpcqstar/13TeV/Ntuples/80X/MC/Summer16TrancheIV/GJ_madgraph/GJets_HT200To400/GJets_HT200To400_236.root/ggNtuplizer/EventTree");
      //chain->Add("/eos/uscms/store/user/lpcqstar/13TeV/Ntuples/80X/MC/Summer16TrancheIV/GJ_madgraph/GJets_HT200To400/GJets_HT200To400_237.root/ggNtuplizer/EventTree");
