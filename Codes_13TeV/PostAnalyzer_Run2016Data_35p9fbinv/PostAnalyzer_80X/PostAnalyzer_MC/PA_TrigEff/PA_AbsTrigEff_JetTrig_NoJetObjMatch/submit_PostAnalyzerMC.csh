...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   HLT_deno.push_back(HLT_PFJet200_v);
   HLT_deno.push_back(HLT_PFJet260_v);
   HLT_deno.push_back(HLT_PFJet320_v);
   HLT_deno.push_back(HLT_PFJet400_v);
   HLT_deno.push_back(HLT_PFJet450_v);
   HLT_deno.push_back(HLT_PFJet500_v);
   ...
   JetTrigObjs.push_back(hltSinglePFJet200); 
   JetTrigObjs.push_back(hltSinglePFJet260); 
   JetTrigObjs.push_back(hltSinglePFJet320); 
   JetTrigObjs.push_back(hltSinglePFJet400); 
   JetTrigObjs.push_back(hltSinglePFJet450); 
   JetTrigObjs.push_back(hltSinglePFJet500); 
