...
setenv MCnTuplesDir root://cmseos.fnal.gov//eos/uscms/store/user/rocky86/13TeV/Ntuples/80X/MC 
setenv qstar Qstar
setenv bstar Bstar
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   Lumi = 35866.0; //(pb^{-1}) //Rereco-BCDEFG_PromptReco-H  (24487 pb-1)Run2016BCDEFG_PromptReco
   ...
   */
   ...
   //   if(dR_overlap > 0.05 && ${GJ}) Remove_GJ = true;
	...
	if(HasPrimaryVtx){
	  ...
	  if(GoodIsoPhotons.size() > 0){
	    ...
	    if(PC > -1){
	      ...
	      //QCD overlap removal (overlap is removed here only as the events is already lost for overlap, so not available at b* level)
		...
		if(minDR > dR_overlap)  isPrompt = true;
	      }
	      ...
	      if(Remove_QCD && isPrompt) continue;
		...
		if(minGJDR < dR_overlap)  isGJNonPrompt = true;
	      }
	      ...
	      if(Remove_GJ && isGJNonPrompt) continue;
		...
		//Applying JetPhox scale factors
		Double_t InMass = GetInvtMass(PC, JC);
		EvtWt_WithJPSF = PreBTag_EvtWt;
		if(InMass > 695.0 && InMass < 887.0) EvtWt_WithJPSF = PreBTag_EvtWt * 1.08;
		if((InMass > 887.0 || InMass == 887.0) && InMass < 1159.0) EvtWt_WithJPSF = PreBTag_EvtWt * 0.9;
		if((InMass > 1159.0 || InMass == 1159.0) && InMass < 1807.0) EvtWt_WithJPSF = PreBTag_EvtWt * 0.8;
		if(InMass > 1887.0 || InMass == 1887.0) EvtWt_WithJPSF = PreBTag_EvtWt * 0.75;
		...
		if(Pass_JetPt){
		  ...
		  if(Pass_JetEta){
			...
			h_PhotonPt[1]               ->Fill((*phoEt)[PC], EvtWt_WithJPSF);
			h_PhotonCalibPt[1]          ->Fill((*phoCalibEt)[PC], EvtWt_WithJPSF);
			h_PhotonEta[1]              ->Fill((*phoSCEta)[PC], EvtWt_WithJPSF);
			h_PhotonPhi[1]              ->Fill((*phoSCPhi)[PC], EvtWt_WithJPSF);
			h_Photon_SigmaIEtaIEta[1]   ->Fill((*phoSigmaIEtaIEtaFull5x5)[PC], EvtWt_WithJPSF);
			h_Photon_R9[1]              ->Fill((*phoR9)[PC], EvtWt_WithJPSF);
			h_Photon_HoverE[1]          ->Fill((*phoHoverE)[PC], EvtWt_WithJPSF);
			h_Photon_EleVeto[1]         ->Fill((*phoEleVeto)[PC], EvtWt_WithJPSF);
			h_Photon_CorrPFChIso[1]     ->Fill(TMath::Max(((*phoPFChIso)[PC] - rho*EAChargedHadrons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
			h_Photon_CorrPFNeuIso[1]    ->Fill(TMath::Max(((*phoPFNeuIso)[PC] - rho*EANeutralHadrons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
			h_Photon_CorrPFPhoIso[1]    ->Fill(TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
		      
			//Jet distributions noBTag_noMasscut 
			h_bJetPt[1]                 ->Fill((*jetPt)[JC], EvtWt_WithJPSF);
			h_bJetEta[1]                ->Fill((*jetEta)[JC], EvtWt_WithJPSF);
			h_bJetPhi[1]                ->Fill((*jetPhi)[JC], EvtWt_WithJPSF);
			h_bJet_Mt[1]                ->Fill((*jetMt)[JC], EvtWt_WithJPSF);
			h_bJet_area[1]              ->Fill((*jetArea)[JC], EvtWt_WithJPSF);
			h_bJet_Mass[1]              ->Fill((*jetMass)[JC], EvtWt_WithJPSF);
			h_bJet_NHEF[1]              ->Fill((*jetNHF)[JC], EvtWt_WithJPSF);
			h_bJet_NEEF[1]              ->Fill((*jetNEF)[JC], EvtWt_WithJPSF);
			h_bJet_NConst[1]            ->Fill((*jetNConstituents)[JC], EvtWt_WithJPSF);
			h_bJet_CHEF[1]              ->Fill((*jetCHF)[JC], EvtWt_WithJPSF);
			h_bJet_ChMult[1]            ->Fill((*jetNCH)[JC], EvtWt_WithJPSF);
			h_bJet_CEEF[1]              ->Fill((*jetCEF)[JC], EvtWt_WithJPSF);
			h_bJet_MUF[1]               ->Fill((*jetMUF)[JC], EvtWt_WithJPSF);
			h_bJet_NNP[1]               ->Fill((*jetNNP)[JC], EvtWt_WithJPSF);
		      
			//Photon+Jet distributions noBTag_noMasscut 
			h_GbJetInvtMass_VarBin[1]   ->Fill(GetInvtMass(PC, JC), EvtWt_WithJPSF);
			h_GbJetInvtMass_UnitBin[1]  ->Fill(GetInvtMass(PC, JC), EvtWt_WithJPSF);
			h_GbJet_dEta[1]             ->Fill(GetdEta((*phoSCEta)[PC], (*jetEta)[JC]), EvtWt_WithJPSF);
			h_GbJet_dPhi[1]             ->Fill(GetdPhi((*phoSCPhi)[PC], (*jetPhi)[JC]), EvtWt_WithJPSF);
			h_GbJet_dR[1]               ->Fill(GetdR((*phoSCEta)[PC], (*jetEta)[JC], (*phoSCPhi)[PC], (*jetPhi)[JC]), EvtWt_WithJPSF);
			h_cosThetaStar[1]           ->Fill(GetCosThetaStar((*phoSCEta)[PC], (*jetEta)[JC]), EvtWt_WithJPSF);
		      
			//PFMet distributions for noBTag_noMasscut 
			h_PFMet[1]                  ->Fill(pfMET, EvtWt_WithJPSF);
			h_SumPFMet[1]               ->Fill(pfMETsumEt, EvtWt_WithJPSF);
			h_MetBySumMET[1]            ->Fill(pfMET/pfMETsumEt, EvtWt_WithJPSF);
			h_PFMetVsGJmass[1]          ->Fill(GetInvtMass(PC, JC), pfMET, EvtWt_WithJPSF);
			h_PFMetOverSumEtVsGJmass[1] ->Fill(GetInvtMass(PC, JC), pfMET/pfMETsumEt, EvtWt_WithJPSF);
		      
			//Photon vs Jet dist for noBTag_noMasscut 
			h_PhPt_vs_bJetPt[1]         ->Fill((*phoEt)[PC], (*jetPt)[JC], EvtWt_WithJPSF);
			h_PhEta_vs_bJetEta[1]       ->Fill((*phoSCEta)[PC], (*jetEta)[JC], EvtWt_WithJPSF);
		      
			//CSVv2 discriminator distributions for noBTag_noMasscut 
			h_CSVv2Dist[1]              ->Fill((*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);
			h_CSVv2_vs_bJetPt[1]        ->Fill((*jetPt)[JC], (*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);
			h_CSVv2_vs_bJetEta[1]       ->Fill((*jetEta)[JC], (*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);

			//Primary vertex and number of photon and jets for noBTag_noMasscut 
			h_goodPV_TotalWt[1]              ->Fill(GoodVertex, EvtWt_WithJPSF);
			h_nIsoPhotons[1]                 ->Fill(GoodIsoPhotons.size(), EvtWt_WithJPSF);  // Tot # of isolated photons
			h_nGoodPhotons[1]                ->Fill(GoodIsoBarrelPhotons.size(), EvtWt_WithJPSF); // Tot # of isolated photons with pt > cut and eta < cut 
			for(int ip = 0; ip < GoodIsoPhotons.size(); ip++){
			  h_IsoPhotonIdxVsPt[1]          ->Fill((*phoEt)[GoodIsoPhotons[ip]], ip+1, EvtWt_WithJPSF);
			}
			for(int ii = 0; ii < GoodIsoBarrelPhotons.size(); ii++){
			  h_GoodPhotonIdxVsPt[1]         ->Fill((*phoEt)[GoodIsoBarrelPhotons[ii]], ii+1, EvtWt_WithJPSF);
			}				    
			h_nJets[1]                       ->Fill(GoodIsoJets.size(), EvtWt_WithJPSF);
			for(int ij = 0; ij < GoodIsoJets.size(); ij++){
			  h_JetIdxVsPt[1]                ->Fill((*jetPt)[GoodIsoJets[ij]], ij+1, EvtWt_WithJPSF);
			}
			//------------------------------------------------------------
			...
			if(Pass_GJInvtMass){
			  ...
			  h_CutFlowWt_qstar->Fill(11.5, EvtWt_WithJPSF);
			  
			  //----------------------------------------------------------
			  //[2]
			  //Photon distributions noBTag_Masscut
			  h_PhotonPt[2]               ->Fill((*phoEt)[PC], EvtWt_WithJPSF);
			  h_PhotonCalibPt[2]          ->Fill((*phoCalibEt)[PC], EvtWt_WithJPSF);
			  h_PhotonEta[2]              ->Fill((*phoSCEta)[PC], EvtWt_WithJPSF);
			  h_PhotonPhi[2]              ->Fill((*phoSCPhi)[PC], EvtWt_WithJPSF);
			  h_Photon_SigmaIEtaIEta[2]   ->Fill((*phoSigmaIEtaIEtaFull5x5)[PC], EvtWt_WithJPSF);
			  h_Photon_R9[2]              ->Fill((*phoR9)[PC], EvtWt_WithJPSF);
			  h_Photon_HoverE[2]          ->Fill((*phoHoverE)[PC], EvtWt_WithJPSF);
			  h_Photon_EleVeto[2]         ->Fill((*phoEleVeto)[PC], EvtWt_WithJPSF);
			  h_Photon_CorrPFChIso[2]     ->Fill(TMath::Max(((*phoPFChIso)[PC] - rho*EAChargedHadrons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
			  h_Photon_CorrPFNeuIso[2]    ->Fill(TMath::Max(((*phoPFNeuIso)[PC] - rho*EANeutralHadrons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
			  h_Photon_CorrPFPhoIso[2]    ->Fill(TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
		      
			  //Jet distributions noBTag_Masscut  
			  h_bJetPt[2]                 ->Fill((*jetPt)[JC], EvtWt_WithJPSF);
			  h_bJetEta[2]                ->Fill((*jetEta)[JC], EvtWt_WithJPSF);
			  h_bJetPhi[2]                ->Fill((*jetPhi)[JC], EvtWt_WithJPSF);
			  h_bJet_Mt[2]                ->Fill((*jetMt)[JC], EvtWt_WithJPSF);
			  h_bJet_area[2]              ->Fill((*jetArea)[JC], EvtWt_WithJPSF);
			  h_bJet_Mass[2]              ->Fill((*jetMass)[JC], EvtWt_WithJPSF);
			  h_bJet_NHEF[2]              ->Fill((*jetNHF)[JC], EvtWt_WithJPSF);
			  h_bJet_NEEF[2]              ->Fill((*jetNEF)[JC], EvtWt_WithJPSF);
			  h_bJet_NConst[2]            ->Fill((*jetNConstituents)[JC], EvtWt_WithJPSF);
			  h_bJet_CHEF[2]              ->Fill((*jetCHF)[JC], EvtWt_WithJPSF);
			  h_bJet_ChMult[2]            ->Fill((*jetNCH)[JC], EvtWt_WithJPSF);
			  h_bJet_CEEF[2]              ->Fill((*jetCEF)[JC], EvtWt_WithJPSF);
			  h_bJet_MUF[2]               ->Fill((*jetMUF)[JC], EvtWt_WithJPSF);
			  h_bJet_NNP[2]               ->Fill((*jetNNP)[JC], EvtWt_WithJPSF);
		      
			  //Photon+Jet distributions noBTag_Masscut 
			  h_GbJetInvtMass_VarBin[2]   ->Fill(GetInvtMass(PC, JC), EvtWt_WithJPSF);
			  h_GbJetInvtMass_UnitBin[2]  ->Fill(GetInvtMass(PC, JC), EvtWt_WithJPSF);
			  h_GbJet_dEta[2]             ->Fill(GetdEta((*phoSCEta)[PC], (*jetEta)[JC]), EvtWt_WithJPSF);
			  h_GbJet_dPhi[2]             ->Fill(GetdPhi((*phoSCPhi)[PC], (*jetPhi)[JC]), EvtWt_WithJPSF);
			  h_GbJet_dR[2]               ->Fill(GetdR((*phoSCEta)[PC], (*jetEta)[JC], (*phoSCPhi)[PC], (*jetPhi)[JC]), EvtWt_WithJPSF);
			  h_cosThetaStar[2]           ->Fill(GetCosThetaStar((*phoSCEta)[PC], (*jetEta)[JC]), EvtWt_WithJPSF);
		      
			  //PFMet distributions for noBTag_Masscut 
			  h_PFMet[2]                  ->Fill(pfMET, EvtWt_WithJPSF);
			  h_SumPFMet[2]               ->Fill(pfMETsumEt, EvtWt_WithJPSF);
			  h_MetBySumMET[2]            ->Fill(pfMET/pfMETsumEt, EvtWt_WithJPSF);
			  h_PFMetVsGJmass[2]          ->Fill(GetInvtMass(PC, JC), pfMET, EvtWt_WithJPSF);
			  h_PFMetOverSumEtVsGJmass[2] ->Fill(GetInvtMass(PC, JC), pfMET/pfMETsumEt, EvtWt_WithJPSF);
		      
			  //Photon vs Jet dist for noBTag_Masscut 
			  h_PhPt_vs_bJetPt[2]         ->Fill((*phoEt)[PC], (*jetPt)[JC], EvtWt_WithJPSF);
			  h_PhEta_vs_bJetEta[2]       ->Fill((*phoSCEta)[PC], (*jetEta)[JC], EvtWt_WithJPSF);
		      
			  //CSVv2 discriminator distributions for noBTag_Masscut 
			  h_CSVv2Dist[2]              ->Fill((*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);
			  h_CSVv2_vs_bJetPt[2]        ->Fill((*jetPt)[JC], (*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);
			  h_CSVv2_vs_bJetEta[2]       ->Fill((*jetEta)[JC], (*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);

			  //Primary vertex and number of photon and jets for noBTag_Masscut 
			  h_goodPV_TotalWt[2]              ->Fill(GoodVertex, EvtWt_WithJPSF);
			  h_nIsoPhotons[2]                 ->Fill(GoodIsoPhotons.size(), EvtWt_WithJPSF);  // Tot # of isolated photons
			  h_nGoodPhotons[2]                ->Fill(GoodIsoBarrelPhotons.size(), EvtWt_WithJPSF); // Tot # of isolated photons with pt > cut and eta < cut 
			  for(int ip = 0; ip < GoodIsoPhotons.size(); ip++){
			    h_IsoPhotonIdxVsPt[2]          ->Fill((*phoEt)[GoodIsoPhotons[ip]], ip+1, EvtWt_WithJPSF);
			  }
			  for(int ii = 0; ii < GoodIsoBarrelPhotons.size(); ii++){
			    h_GoodPhotonIdxVsPt[2]         ->Fill((*phoEt)[GoodIsoBarrelPhotons[ii]], ii+1, EvtWt_WithJPSF);
			  }				    
			  h_nJets[2]                       ->Fill(GoodIsoJets.size(), EvtWt_WithJPSF);
			  for(int ij = 0; ij < GoodIsoJets.size(); ij++){
			    h_JetIdxVsPt[2]                ->Fill((*jetPt)[GoodIsoJets[ij]], ij+1, EvtWt_WithJPSF);
			  }
			  //------------------------------------------------------------
			}//if(Pass_GJInvtMass)			
		      }//if(Pass_GJdEta)
		...
		if(Pass_JetPt){
		  ...
		  if(Pass_JetEta){
		    ...
		    if(Pass_CSVv2bTag){
		      ...
		      Total_EvtWt_1tag = EvtWt_WithJPSF * Wt_1Tag;
		      Total_EvtWt_0tag = EvtWt_WithJPSF * Wt_0Tag;
			...
			if(Pass_GJdEta){
			  ...
			  //[5]
			  //Photon distributions 0BTag_noMasscut
			  h_PhotonPt[5]               ->Fill((*phoEt)[PC], EvtWt_WithJPSF);
			  h_PhotonCalibPt[5]          ->Fill((*phoCalibEt)[PC], EvtWt_WithJPSF);
			  h_PhotonEta[5]              ->Fill((*phoSCEta)[PC], EvtWt_WithJPSF);
			  h_PhotonPhi[5]              ->Fill((*phoSCPhi)[PC], EvtWt_WithJPSF);
			  h_Photon_SigmaIEtaIEta[5]   ->Fill((*phoSigmaIEtaIEtaFull5x5)[PC], EvtWt_WithJPSF);
			  h_Photon_R9[5]              ->Fill((*phoR9)[PC], EvtWt_WithJPSF);
			  h_Photon_HoverE[5]          ->Fill((*phoHoverE)[PC], EvtWt_WithJPSF);
			  h_Photon_EleVeto[5]         ->Fill((*phoEleVeto)[PC], EvtWt_WithJPSF);
			  h_Photon_CorrPFChIso[5]     ->Fill(TMath::Max(((*phoPFChIso)[PC] - rho*EAChargedHadrons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
			  h_Photon_CorrPFNeuIso[5]    ->Fill(TMath::Max(((*phoPFNeuIso)[PC] - rho*EANeutralHadrons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
			  h_Photon_CorrPFPhoIso[5]    ->Fill(TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
		      
			  //Jet distributions 0BTag_noMasscut  
			  h_bJetPt[5]                 ->Fill((*jetPt)[JC], EvtWt_WithJPSF);
			  h_bJetEta[5]                ->Fill((*jetEta)[JC], EvtWt_WithJPSF);
			  h_bJetPhi[5]                ->Fill((*jetPhi)[JC], EvtWt_WithJPSF);
			  h_bJet_Mt[5]                ->Fill((*jetMt)[JC], EvtWt_WithJPSF);
			  h_bJet_area[5]              ->Fill((*jetArea)[JC], EvtWt_WithJPSF);
			  h_bJet_Mass[5]              ->Fill((*jetMass)[JC], EvtWt_WithJPSF);
			  h_bJet_NHEF[5]              ->Fill((*jetNHF)[JC], EvtWt_WithJPSF);
			  h_bJet_NEEF[5]              ->Fill((*jetNEF)[JC], EvtWt_WithJPSF);
			  h_bJet_NConst[5]            ->Fill((*jetNConstituents)[JC], EvtWt_WithJPSF);
			  h_bJet_CHEF[5]              ->Fill((*jetCHF)[JC], EvtWt_WithJPSF);
			  h_bJet_ChMult[5]            ->Fill((*jetNCH)[JC], EvtWt_WithJPSF);
			  h_bJet_CEEF[5]              ->Fill((*jetCEF)[JC], EvtWt_WithJPSF);
			  h_bJet_MUF[5]               ->Fill((*jetMUF)[JC], EvtWt_WithJPSF);
			  h_bJet_NNP[5]               ->Fill((*jetNNP)[JC], EvtWt_WithJPSF);
		      
			  //Photon+Jet distributions 0BTag_noMasscut 
			  h_GbJetInvtMass_VarBin[5]   ->Fill(GetInvtMass(PC, JC), EvtWt_WithJPSF);
			  h_GbJetInvtMass_UnitBin[5]  ->Fill(GetInvtMass(PC, JC), EvtWt_WithJPSF);
			  h_GbJet_dEta[5]             ->Fill(GetdEta((*phoSCEta)[PC], (*jetEta)[JC]), EvtWt_WithJPSF);
			  h_GbJet_dPhi[5]             ->Fill(GetdPhi((*phoSCPhi)[PC], (*jetPhi)[JC]), EvtWt_WithJPSF);
			  h_GbJet_dR[5]               ->Fill(GetdR((*phoSCEta)[PC], (*jetEta)[JC], (*phoSCPhi)[PC], (*jetPhi)[JC]), EvtWt_WithJPSF);
			  h_cosThetaStar[5]           ->Fill(GetCosThetaStar((*phoSCEta)[PC], (*jetEta)[JC]), EvtWt_WithJPSF);
		      
			  //PFMet distributions for 0BTag_noMasscut 
			  h_PFMet[5]                  ->Fill(pfMET, EvtWt_WithJPSF);
			  h_SumPFMet[5]               ->Fill(pfMETsumEt, EvtWt_WithJPSF);
			  h_MetBySumMET[5]            ->Fill(pfMET/pfMETsumEt, EvtWt_WithJPSF);
			  h_PFMetVsGJmass[5]          ->Fill(GetInvtMass(PC, JC), pfMET, EvtWt_WithJPSF);
			  h_PFMetOverSumEtVsGJmass[5] ->Fill(GetInvtMass(PC, JC), pfMET/pfMETsumEt, EvtWt_WithJPSF);
		      
			  //Photon vs Jet dist for 0BTag_noMasscut 
			  h_PhPt_vs_bJetPt[5]         ->Fill((*phoEt)[PC], (*jetPt)[JC], EvtWt_WithJPSF);
			  h_PhEta_vs_bJetEta[5]       ->Fill((*phoSCEta)[PC], (*jetEta)[JC], EvtWt_WithJPSF);
		      
			  //CSVv2 discriminator distributions for 0BTag_noMasscut 
			  h_CSVv2Dist[5]              ->Fill((*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);
			  h_CSVv2_vs_bJetPt[5]        ->Fill((*jetPt)[JC], (*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);
			  h_CSVv2_vs_bJetEta[5]       ->Fill((*jetEta)[JC], (*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);

			  //Primary vertex and number of photon and jets for 0BTag_noMasscut 
			  h_goodPV_TotalWt[5]              ->Fill(GoodVertex, EvtWt_WithJPSF);
			  h_nIsoPhotons[5]                 ->Fill(GoodIsoPhotons.size(), EvtWt_WithJPSF);  // Tot # of isolated photons
			  h_nGoodPhotons[5]                ->Fill(GoodIsoBarrelPhotons.size(), EvtWt_WithJPSF); // Tot # of isolated photons with pt > cut and eta < cut 
			  for(int ip = 0; ip < GoodIsoPhotons.size(); ip++){
			    h_IsoPhotonIdxVsPt[5]          ->Fill((*phoEt)[GoodIsoPhotons[ip]], ip+1, EvtWt_WithJPSF);
			  }
			  for(int ii = 0; ii < GoodIsoBarrelPhotons.size(); ii++){
			    h_GoodPhotonIdxVsPt[5]         ->Fill((*phoEt)[GoodIsoBarrelPhotons[ii]], ii+1, EvtWt_WithJPSF);
			  }				    
			  h_nJets[5]                       ->Fill(GoodIsoJets.size(), EvtWt_WithJPSF);
			  for(int ij = 0; ij < GoodIsoJets.size(); ij++){
			    h_JetIdxVsPt[5]                ->Fill((*jetPt)[GoodIsoJets[ij]], ij+1, EvtWt_WithJPSF);
			  }
			  //------------------------------------------------------------
			  ...
			  if(Pass_GJInvtMass){
			    ...
			    //[6]
			    //Photon distributions 0BTag_Masscut
			    h_PhotonPt[6]               ->Fill((*phoEt)[PC], EvtWt_WithJPSF);
			    h_PhotonCalibPt[6]          ->Fill((*phoCalibEt)[PC], EvtWt_WithJPSF);
			    h_PhotonEta[6]              ->Fill((*phoSCEta)[PC], EvtWt_WithJPSF);
			    h_PhotonPhi[6]              ->Fill((*phoSCPhi)[PC], EvtWt_WithJPSF);
			    h_Photon_SigmaIEtaIEta[6]   ->Fill((*phoSigmaIEtaIEtaFull5x5)[PC], EvtWt_WithJPSF);
			    h_Photon_R9[6]              ->Fill((*phoR9)[PC], EvtWt_WithJPSF);
			    h_Photon_HoverE[6]          ->Fill((*phoHoverE)[PC], EvtWt_WithJPSF);
			    h_Photon_EleVeto[6]         ->Fill((*phoEleVeto)[PC], EvtWt_WithJPSF);
			    h_Photon_CorrPFChIso[6]     ->Fill(TMath::Max(((*phoPFChIso)[PC] - rho*EAChargedHadrons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
			    h_Photon_CorrPFNeuIso[6]    ->Fill(TMath::Max(((*phoPFNeuIso)[PC] - rho*EANeutralHadrons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
			    h_Photon_CorrPFPhoIso[6]    ->Fill(TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), EvtWt_WithJPSF);
		      
			    //Jet distributions 0BTag_Masscut  
			    h_bJetPt[6]                 ->Fill((*jetPt)[JC], EvtWt_WithJPSF);
			    h_bJetEta[6]                ->Fill((*jetEta)[JC], EvtWt_WithJPSF);
			    h_bJetPhi[6]                ->Fill((*jetPhi)[JC], EvtWt_WithJPSF);
			    h_bJet_Mt[6]                ->Fill((*jetMt)[JC], EvtWt_WithJPSF);
			    h_bJet_area[6]              ->Fill((*jetArea)[JC], EvtWt_WithJPSF);
			    h_bJet_Mass[6]              ->Fill((*jetMass)[JC], EvtWt_WithJPSF);
			    h_bJet_NHEF[6]              ->Fill((*jetNHF)[JC], EvtWt_WithJPSF);
			    h_bJet_NEEF[6]              ->Fill((*jetNEF)[JC], EvtWt_WithJPSF);
			    h_bJet_NConst[6]            ->Fill((*jetNConstituents)[JC], EvtWt_WithJPSF);
			    h_bJet_CHEF[6]              ->Fill((*jetCHF)[JC], EvtWt_WithJPSF);
			    h_bJet_ChMult[6]            ->Fill((*jetNCH)[JC], EvtWt_WithJPSF);
			    h_bJet_CEEF[6]              ->Fill((*jetCEF)[JC], EvtWt_WithJPSF);
			    h_bJet_MUF[6]               ->Fill((*jetMUF)[JC], EvtWt_WithJPSF);
			    h_bJet_NNP[6]               ->Fill((*jetNNP)[JC], EvtWt_WithJPSF);
		      
			    //Photon+Jet distributions 0BTag_Masscut 
			    h_GbJetInvtMass_VarBin[6]   ->Fill(GetInvtMass(PC, JC), EvtWt_WithJPSF);
			    h_GbJetInvtMass_UnitBin[6]  ->Fill(GetInvtMass(PC, JC), EvtWt_WithJPSF);
			    h_GbJet_dEta[6]             ->Fill(GetdEta((*phoSCEta)[PC], (*jetEta)[JC]), EvtWt_WithJPSF);
			    h_GbJet_dPhi[6]             ->Fill(GetdPhi((*phoSCPhi)[PC], (*jetPhi)[JC]), EvtWt_WithJPSF);
			    h_GbJet_dR[6]               ->Fill(GetdR((*phoSCEta)[PC], (*jetEta)[JC], (*phoSCPhi)[PC], (*jetPhi)[JC]), EvtWt_WithJPSF);
			    h_cosThetaStar[6]           ->Fill(GetCosThetaStar((*phoSCEta)[PC], (*jetEta)[JC]), EvtWt_WithJPSF);
		      
			    //PFMet distributions for 0BTag_Masscut 
			    h_PFMet[6]                  ->Fill(pfMET, EvtWt_WithJPSF);
			    h_SumPFMet[6]               ->Fill(pfMETsumEt, EvtWt_WithJPSF);
			    h_MetBySumMET[6]            ->Fill(pfMET/pfMETsumEt, EvtWt_WithJPSF);
			    h_PFMetVsGJmass[6]          ->Fill(GetInvtMass(PC, JC), pfMET, EvtWt_WithJPSF);
			    h_PFMetOverSumEtVsGJmass[6] ->Fill(GetInvtMass(PC, JC), pfMET/pfMETsumEt, EvtWt_WithJPSF);
		      
			    //Photon vs Jet dist for 0BTag_Masscut 
			    h_PhPt_vs_bJetPt[6]         ->Fill((*phoEt)[PC], (*jetPt)[JC], EvtWt_WithJPSF);
			    h_PhEta_vs_bJetEta[6]       ->Fill((*phoSCEta)[PC], (*jetEta)[JC], EvtWt_WithJPSF);
		      
			    //CSVv2 discriminator distributions for 0BTag_Masscut 
			    h_CSVv2Dist[6]              ->Fill((*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);
			    h_CSVv2_vs_bJetPt[6]        ->Fill((*jetPt)[JC], (*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);
			    h_CSVv2_vs_bJetEta[6]       ->Fill((*jetEta)[JC], (*jetCSV2BJetTags)[JC], EvtWt_WithJPSF);

			    //Primary vertex and number of photon and jets for 0BTag_Masscut 
			    h_goodPV_TotalWt[6]              ->Fill(GoodVertex, EvtWt_WithJPSF);
			    h_nIsoPhotons[6]                 ->Fill(GoodIsoPhotons.size(), EvtWt_WithJPSF);  // Tot # of isolated photons
			    h_nGoodPhotons[6]                ->Fill(GoodIsoBarrelPhotons.size(), EvtWt_WithJPSF); // Tot # of isolated photons with pt > cut and eta < cut 
			    for(int ip = 0; ip < GoodIsoPhotons.size(); ip++){
			      h_IsoPhotonIdxVsPt[6]          ->Fill((*phoEt)[GoodIsoPhotons[ip]], ip+1, EvtWt_WithJPSF);
			    }
			    for(int ii = 0; ii < GoodIsoBarrelPhotons.size(); ii++){
			      h_GoodPhotonIdxVsPt[6]         ->Fill((*phoEt)[GoodIsoBarrelPhotons[ii]], ii+1, EvtWt_WithJPSF);
			    }				    
			    h_nJets[6]                       ->Fill(GoodIsoJets.size(), EvtWt_WithJPSF);
			    for(int ij = 0; ij < GoodIsoJets.size(); ij++){
			      h_JetIdxVsPt[6]                ->Fill((*jetPt)[GoodIsoJets[ij]], ij+1, EvtWt_WithJPSF);
			    }
			    //-----------------------------------------------------------
