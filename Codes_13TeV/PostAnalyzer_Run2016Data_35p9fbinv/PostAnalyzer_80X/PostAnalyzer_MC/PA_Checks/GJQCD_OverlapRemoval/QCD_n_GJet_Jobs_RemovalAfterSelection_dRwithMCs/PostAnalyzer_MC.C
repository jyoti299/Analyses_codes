...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   //Define Output file here
   //   TString OutputPath = "root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/Ntuples/80X/MC/Dijet/QCD_Pt3200toInf//";
   TString OutputFile = "QCD_Pt3200toInf";
   ...
   */
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	//Uncomment it in script
        /////////if(0 && !(isPrompt)) continue; //reject event if no prompt photon in GJet sample
        //if(1 && isPrompt) continue; //reject event if prompt photon in QCD sample
      }
      */
      /*
	...
	//Uncomment it in script
        //if(0 && isPrompt_insideOfDR0p4) continue; //reject event if prompt photon is within dR 0.4 with jet in GJet sample

      }
      */

      //Uncomment this in script  
      Lumi_EvtWt = (Lumi*(0.000165445))/nentries;
