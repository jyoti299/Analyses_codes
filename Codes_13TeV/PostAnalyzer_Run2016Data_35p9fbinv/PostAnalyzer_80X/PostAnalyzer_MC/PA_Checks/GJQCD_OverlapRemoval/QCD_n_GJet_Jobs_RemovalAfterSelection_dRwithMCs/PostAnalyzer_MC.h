...
/*
  ...
  */    
      ...
      TString main_path = "root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/Ntuples/80X/MC/Dijet/QCD_Pt3200toInf/";
...
void PostAnalyzer_MC::PileupReWeighting(){
  ...
  Bool_t Pileup_QCD   = 1;
  Bool_t Pileup_EWK   = 0;
  Bool_t Pileup_Bstar = 0;
  Bool_t Pileup_Qstar = 0;
