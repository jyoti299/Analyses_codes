   ...
   */
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     //cout << "<Analyzing entry: " << jentry << endl;
      ...
      bool removeGJ_QCD_Overlapping = false;
      bool removeGJ_PromPh_insideDR0p4 = true;
	...
	isPrompt = IsPromptFoundOutOf_dR(0.4);//look for prompt photon with given dR requirement between prompt photon and jets.
