...
void pu_GJets(){
  ...
  TFile *fin = new TFile("Gjet.root", "READ");
...
void pu_DiJet(){
  ...
  TFile *fin = new TFile("qcd.root", "READ");
...
void pu_Qstar(){
  ...
  TFile *fin = new TFile("qstar.root", "READ");
...
void pu_bstar(){
  ...
  //Here this input file is hadd of all the files present in QstarToGJ_M1000_f1p0 folder, i did the hadd and saved this file in check dir and then delete it after getting the pileup histogram to save extra space taken unnecessarily by the hadded file. considered the pu dist for one sample only as it will be same for all the samples.
  TFile *fin = new TFile("bstar.root", "READ");
  TFile *fout = new TFile("Bstar_PileupHist.root", "RECREATE");
...
void pu_EWK(){
  ...
  //Here this input file is hadd of all the files present in QstarToGJ_M1000_f1p0 folder, i did the hadd and saved this file in check dir and then delete it after getting the pileup histogram to save extra space taken unnecessarily by the hadded file. considered the pu dist for one sample only as it will be same for all the samples.
  TFile *fin = new TFile("ewk.root", "READ");
  TFile *fout = new TFile("EWK_PileupHist.root", "RECREATE");
