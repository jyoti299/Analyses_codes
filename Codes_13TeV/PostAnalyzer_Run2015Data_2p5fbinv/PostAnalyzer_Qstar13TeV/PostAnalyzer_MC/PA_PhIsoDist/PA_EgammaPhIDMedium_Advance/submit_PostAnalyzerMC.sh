...
MCnTuplesDir=/eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC
GJets=GJets
DiJet=DiJet
Signal_Qstar=Signal_Qstar


myDir=${lpcqstarDir}/13TeV
PostAna_Dir=${myDir}/PostAnalyzer_Results
PostAna_Dir_final=${PostAna_Dir}/Qstar13TeV_EgammaPhIDMedium_Advance
PostAnaMC_Dir=${PostAna_Dir_final}/MC


#GammaJet (for GJets_HT400To600, actual total events for full dataset is 2476770 but some files causing problem so the events in 616 files present in source dir is 2402946, so using this for now, change it if more files run)
GJ=1
#for i in GJets_HT40To100  GJets_HT100To200  GJets_HT200To400  GJets_HT400To600  GJets_HT600ToInf
#do 
#XS=(  23080  9110  2281  273  94.5  )
#totalEvents=(  4816232  5027618  10424189  2476770   2550765   )

#use this one to submit jobs for less totalEvents for 400To600
#for i in GJets_HT40To100  GJets_HT100To200  GJets_HT200To400  GJets_HT400To600  GJets_HT600ToInf
#do 
#XS=(  23080  9110  2281  273  94.5  )
#totalEvents=(  4816232  5027618  10424189  2402946   2550765   )

for i in GJets_HT100To200  GJets_HT200To400
do
XS=( 9110  2281 )
totalEvents=( 5027618  10424189 )
...
#do
#XS=( 471100  117276  7823  648.2  186.9  32.293  9.4183  0.84265  0.114943  0.00682981  0.000165445  )
#totalEvents=( 3458385  3364368  2935633  1937537  1964128  1937216  1487136  197959  193608  194456  192944  )

#for i in QCD_Pt_170to300
#do
#XS=( 117276 ) 
#totalEvents=( 3364368)
...
#for Bstar samples, all records (totalEvents) for all couplings except M1500_f1P0 AND M5000_f1P0 are checked with CMSDAS and corrected in twiki.
#########################################################################################################
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	if(HasPrimaryVtx){
	  if(PC_id > -1){
	    ...
	    h_PFChIsoVsPt[0]                 ->Fill((*phoEt)[PC_id], (*phoPFChIso)[PC_id], PreBTag_EvtWt);
	    h_PFChIsoVsRho[0]                ->Fill(rho, (*phoPFChIso)[PC_id], PreBTag_EvtWt);
	    h_prof_PFChIsoVsPt[0]            ->Fill((*phoEt)[PC_id], (*phoPFChIso)[PC_id], PreBTag_EvtWt);
	    h_prof_PFChIsoVsRho[0]           ->Fill(rho, (*phoPFChIso)[PC_id], PreBTag_EvtWt);
	    
	    h_PFNeuIsoVsPt[0][0]             ->Fill((*phoEt)[PC_id], (*phoPFNeuIso)[PC_id], PreBTag_EvtWt);
	    h_PFNeuIsoVsRho[0][0]            ->Fill(rho, (*phoPFNeuIso)[PC_id], PreBTag_EvtWt);
	    h_prof_PFNeuIsoVsPt[0][0]        ->Fill((*phoEt)[PC_id], (*phoPFNeuIso)[PC_id], PreBTag_EvtWt);
	    h_prof_PFNeuIsoVsRho[0][0]       ->Fill(rho, (*phoPFNeuIso)[PC_id], PreBTag_EvtWt);

	    h_PFPhIsoVsPt[0][0]              ->Fill((*phoEt)[PC_id], (*phoPFPhoIso)[PC_id], PreBTag_EvtWt);
	    h_PFPhIsoVsRho[0][0]             ->Fill(rho, (*phoPFPhoIso)[PC_id], PreBTag_EvtWt);
	    h_prof_PFPhIsoVsPt[0][0]         ->Fill((*phoEt)[PC_id], (*phoPFPhoIso)[PC_id], PreBTag_EvtWt);
	    h_prof_PFPhIsoVsRho[0][0]        ->Fill(rho, (*phoPFPhoIso)[PC_id], PreBTag_EvtWt);
				
	    h_PFNeuIsoVsPt[0][1]      ->Fill((*phoEt)[PC_id], TMath::Max(((*phoPFPhoIso)[PC_id] - rho*EAPhotons((*phoSCEta)[PC_id])), 0.0), PreBTag_EvtWt);
	    h_PFNeuIsoVsRho[0][1]     ->Fill(rho, TMath::Max(((*phoPFPhoIso)[PC_id] - rho*EAPhotons((*phoSCEta)[PC_id])), 0.0), PreBTag_EvtWt);
	    h_prof_PFNeuIsoVsPt[0][1] ->Fill((*phoEt)[PC_id], TMath::Max(((*phoPFPhoIso)[PC_id] - rho*EAPhotons((*phoSCEta)[PC_id])), 0.0), PreBTag_EvtWt);
	    h_prof_PFNeuIsoVsRho[0][1]->Fill(rho, TMath::Max(((*phoPFPhoIso)[PC_id] - rho*EAPhotons((*phoSCEta)[PC_id])), 0.0), PreBTag_EvtWt);

	    h_PFPhIsoVsPt[0][1]       ->Fill((*phoEt)[PC_id], TMath::Max(((*phoPFPhoIso)[PC_id] - rho*EAPhotons((*phoSCEta)[PC_id])), 0.0), PreBTag_EvtWt);
	    h_PFPhIsoVsRho[0][1]      ->Fill(rho, TMath::Max(((*phoPFPhoIso)[PC_id] - rho*EAPhotons((*phoSCEta)[PC_id])), 0.0), PreBTag_EvtWt);
	    h_prof_PFPhIsoVsPt[0][1]  ->Fill((*phoEt)[PC_id], TMath::Max(((*phoPFPhoIso)[PC_id] - rho*EAPhotons((*phoSCEta)[PC_id])), 0.0), PreBTag_EvtWt);
	    h_prof_PFPhIsoVsRho[0][1] ->Fill(rho, TMath::Max(((*phoPFPhoIso)[PC_id] - rho*EAPhotons((*phoSCEta)[PC_id])), 0.0), PreBTag_EvtWt);
	...
	if(HasPrimaryVtx){
	  if(PC > -1){
	    ...
	    h_PFChIsoVsPt[1]                 ->Fill((*phoEt)[PC], (*phoPFChIso)[PC], PreBTag_EvtWt);
      	    h_PFChIsoVsRho[1]                ->Fill(rho, (*phoPFChIso)[PC], PreBTag_EvtWt);
      	    h_prof_PFChIsoVsPt[1]            ->Fill((*phoEt)[PC], (*phoPFChIso)[PC], PreBTag_EvtWt);
	    h_prof_PFChIsoVsRho[1]           ->Fill(rho, (*phoPFChIso)[PC], PreBTag_EvtWt);
	    
	    h_PFNeuIsoVsPt[1][0]             ->Fill((*phoEt)[PC], (*phoPFNeuIso)[PC], PreBTag_EvtWt);
	    h_PFNeuIsoVsRho[1][0]            ->Fill(rho, (*phoPFNeuIso)[PC], PreBTag_EvtWt);
	    h_prof_PFNeuIsoVsPt[1][0]        ->Fill((*phoEt)[PC], (*phoPFNeuIso)[PC], PreBTag_EvtWt);
	    h_prof_PFNeuIsoVsRho[1][0]       ->Fill(rho, (*phoPFNeuIso)[PC], PreBTag_EvtWt);

	    h_PFPhIsoVsPt[1][0]              ->Fill((*phoEt)[PC], (*phoPFPhoIso)[PC], PreBTag_EvtWt);
	    h_PFPhIsoVsRho[1][0]             ->Fill(rho, (*phoPFPhoIso)[PC], PreBTag_EvtWt);
	    h_prof_PFPhIsoVsPt[1][0]         ->Fill((*phoEt)[PC], (*phoPFPhoIso)[PC], PreBTag_EvtWt);
      	    h_prof_PFPhIsoVsRho[1][0]        ->Fill(rho, (*phoPFPhoIso)[PC], PreBTag_EvtWt);
				
	    h_PFNeuIsoVsPt[1][1]      ->Fill((*phoEt)[PC], TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), PreBTag_EvtWt);
	    h_PFNeuIsoVsRho[1][1]     ->Fill(rho, TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), PreBTag_EvtWt);
	    h_prof_PFNeuIsoVsPt[1][1] ->Fill((*phoEt)[PC], TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), PreBTag_EvtWt);
	    h_prof_PFNeuIsoVsRho[1][1]->Fill(rho, TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), PreBTag_EvtWt);

	    h_PFPhIsoVsPt[1][1]       ->Fill((*phoEt)[PC], TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), PreBTag_EvtWt);
	    h_PFPhIsoVsRho[1][1]      ->Fill(rho, TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), PreBTag_EvtWt);
            h_prof_PFPhIsoVsPt[1][1]  ->Fill((*phoEt)[PC], TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), PreBTag_EvtWt);
     	    h_prof_PFPhIsoVsRho[1][1] ->Fill(rho, TMath::Max(((*phoPFPhoIso)[PC] - rho*EAPhotons((*phoSCEta)[PC])), 0.0), PreBTag_EvtWt);
...
public :
   ...
   //Histograms
   TH2F *h_PFChIsoVsPt[2];
   TH2F *h_PFChIsoVsRho[2];
   TProfile *h_prof_PFChIsoVsPt[2];
   TProfile *h_prof_PFChIsoVsRho[2];

   TH2F *h_PFNeuIsoVsPt[2][2];
   TH2F *h_PFNeuIsoVsRho[2][2];
   TProfile *h_prof_PFNeuIsoVsPt[2][2];
   TProfile *h_prof_PFNeuIsoVsRho[2][2];

   TH2F *h_PFPhIsoVsPt[2][2];
   TH2F *h_PFPhIsoVsRho[2][2];
   TProfile *h_prof_PFPhIsoVsPt[2][2];
   TProfile *h_prof_PFPhIsoVsRho[2][2];
   ...
   virtual Int_t    GoodPhoton(TString phoWP);
   virtual Bool_t   TightJetId(Int_t iJet);
   virtual Int_t    GoodJet(Int_t pc);
   ...
   virtual Int_t    MatchedPhoton(Int_t pc);
   virtual Int_t    MatchedJet(Int_t jc);
   ...
   //Extra functions defined for advance level
   virtual Bool_t   PhotonIDNoIso(Int_t ipho, TString phoWP);
   virtual Int_t    PassPhotonIDNoIso(TString phoWP); 
...
Int_t PostAnalyzer_MC::GoodPhoton(TString phoWP){
...
Bool_t PostAnalyzer_MC::PhotonIDNoIso(Int_t ipho, TString phoWP){
...
Int_t PostAnalyzer_MC::PassPhotonIDNoIso(TString phoWP){

  Int_t pc = -1;
  Bool_t ID = false;
  for(Int_t i = 0; i < nPho; i++){
    ID = PhotonIDNoIso(i, phoWP);
    if(ID){
      pc = i;
      break;
    }
...
Int_t PostAnalyzer_MC::GoodJet(Int_t pc){
...
Int_t PostAnalyzer_MC::MatchedPhoton(Int_t pc){
...
Int_t PostAnalyzer_MC::MatchedJet(Int_t jc){
...
void PostAnalyzer_MC::BookHistograms(){
  file->cd();
    ...
    //Photon Isolations variation wrt Pileup and Pt
    std::string cut0[2] = {"NoIsoCut", "IsoCut"};
    std::string cut[2] = {"NoRhoCorr", "RhoCorr"};
    for( Int_t hist0 = 0; hist0 < 2; ++hist0 ){
      sprintf(name, "h_PFChIsoVsPt_%s",cut0[hist0].c_str()); 
      h_PFChIsoVsPt[hist0] = new TH2F(name, "PFChIsoVsPt", 150, 0.0, 6000.0, 1000, 0, 100);
      h_PFChIsoVsPt[hist0]->GetYaxis()->SetTitle("PFChIso");       h_PFChIsoVsPt[hist0]->GetYaxis()->CenterTitle();
      h_PFChIsoVsPt[hist0]->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");   h_PFChIsoVsPt[hist0]->GetXaxis()->CenterTitle();
      h_PFChIsoVsPt[hist0]->Sumw2();

      sprintf(name, "h_PFChIsoVsRho_%s",cut0[hist0].c_str());
      h_PFChIsoVsRho[hist0] = new TH2F(name, "PFChIsoVsRho", 500, 0.0, 50.0, 1000, 0, 100);
      h_PFChIsoVsRho[hist0]->GetYaxis()->SetTitle("PFChIso");       h_PFChIsoVsRho[hist0]->GetYaxis()->CenterTitle();
      h_PFChIsoVsRho[hist0]->GetXaxis()->SetTitle("Rho");           h_PFChIsoVsRho[hist0]->GetXaxis()->CenterTitle();
      h_PFChIsoVsRho[hist0]->Sumw2();

      sprintf(name, "h_prof_PFChIsoVsPt_%s",cut0[hist0].c_str());
      h_prof_PFChIsoVsPt[hist0] = new TProfile(name, "PFChIsoVsPt", 150, 0.0, 6000.0, 0, 100);
      h_prof_PFChIsoVsPt[hist0]->GetYaxis()->SetTitle("PFChIso");     h_prof_PFChIsoVsPt[hist0]->GetYaxis()->CenterTitle();
      h_prof_PFChIsoVsPt[hist0]->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");   h_prof_PFChIsoVsPt[hist0]->GetXaxis()->CenterTitle();
      h_prof_PFChIsoVsPt[hist0]->Sumw2();

      sprintf(name, "h_prof_PFChIsoVsRho_%s",cut0[hist0].c_str());
      h_prof_PFChIsoVsRho[hist0] = new TProfile(name, "PFChIsoVsRho", 500, 0.0, 50.0, 0, 100);
      h_prof_PFChIsoVsRho[hist0]->GetYaxis()->SetTitle("PFChIso");      h_prof_PFChIsoVsRho[hist0]->GetYaxis()->CenterTitle();
      h_prof_PFChIsoVsRho[hist0]->GetXaxis()->SetTitle("Rho");          h_prof_PFChIsoVsRho[hist0]->GetXaxis()->CenterTitle();
      h_prof_PFChIsoVsRho[hist0]->Sumw2();
 
      for( Int_t hist = 0; hist < 2; ++hist ){
	sprintf(name, "h_PFNeuIsoVsPt_%s_%s",cut0[hist0].c_str(),cut[hist].c_str());
	h_PFNeuIsoVsPt[hist0][hist] = new TH2F(name, "PFNeuIsoVsPt", 150, 0.0, 6000.0, 100, 0, 300);
	h_PFNeuIsoVsPt[hist0][hist]->GetYaxis()->SetTitle("PFNeuIso");     h_PFNeuIsoVsPt[hist0][hist]->GetYaxis()->CenterTitle();
	h_PFNeuIsoVsPt[hist0][hist]->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");    h_PFNeuIsoVsPt[hist0][hist]->GetXaxis()->CenterTitle();
	h_PFNeuIsoVsPt[hist0][hist]->Sumw2();

	sprintf(name, "h_PFNeuIsoVsRho_%s_%s",cut0[hist0].c_str(),cut[hist].c_str());
	h_PFNeuIsoVsRho[hist0][hist] = new TH2F(name, "PFNeuIsoVsRho", 500, 0.0, 50.0, 100, 0, 300);
	h_PFNeuIsoVsRho[hist0][hist]->GetYaxis()->SetTitle("PFNeuIso");     h_PFNeuIsoVsRho[hist0][hist]->GetYaxis()->CenterTitle();
	h_PFNeuIsoVsRho[hist0][hist]->GetXaxis()->SetTitle("Rho");    h_PFNeuIsoVsRho[hist0][hist]->GetXaxis()->CenterTitle();
	h_PFNeuIsoVsRho[hist0][hist]->Sumw2();

	sprintf(name, "h_prof_PFNeuIsoVsPt_%s_%s",cut0[hist0].c_str(),cut[hist].c_str());
	h_prof_PFNeuIsoVsPt[hist0][hist] = new TProfile(name, "PFNeuIsoVsPt", 150, 0.0, 6000.0, 0, 300);
	h_prof_PFNeuIsoVsPt[hist0][hist]->GetYaxis()->SetTitle("PFNeuIso");     h_prof_PFNeuIsoVsPt[hist0][hist]->GetYaxis()->CenterTitle();
	h_prof_PFNeuIsoVsPt[hist0][hist]->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");   h_prof_PFNeuIsoVsPt[hist0][hist]->GetXaxis()->CenterTitle();
	h_prof_PFNeuIsoVsPt[hist0][hist]->Sumw2();

	sprintf(name, "h_prof_PFNeuIsoVsRho_%s_%s",cut0[hist0].c_str(),cut[hist].c_str());
	h_prof_PFNeuIsoVsRho[hist0][hist] = new TProfile(name, "PFNeuIsoVsRho", 500, 0.0, 50.0, 0, 300);
	h_prof_PFNeuIsoVsRho[hist0][hist]->GetYaxis()->SetTitle("PFNeuIso");     h_prof_PFNeuIsoVsRho[hist0][hist]->GetYaxis()->CenterTitle();
	h_prof_PFNeuIsoVsRho[hist0][hist]->GetXaxis()->SetTitle("Rho");   h_prof_PFNeuIsoVsRho[hist0][hist]->GetXaxis()->CenterTitle();
	h_prof_PFNeuIsoVsRho[hist0][hist]->Sumw2();

	sprintf(name, "h_PFPhIsoVsPt_%s_%s",cut0[hist0].c_str(),cut[hist].c_str());
	h_PFPhIsoVsPt[hist0][hist] = new TH2F(name, "PFPhIsoVsPt", 150, 0.0, 6000.0, 1000, 0, 100);
	h_PFPhIsoVsPt[hist0][hist]->GetYaxis()->SetTitle("PFPhIso");     h_PFPhIsoVsPt[hist0][hist]->GetYaxis()->CenterTitle();
	h_PFPhIsoVsPt[hist0][hist]->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");    h_PFPhIsoVsPt[hist0][hist]->GetXaxis()->CenterTitle();
	h_PFPhIsoVsPt[hist0][hist]->Sumw2();

	sprintf(name, "h_PFPhIsoVsRho_%s_%s",cut0[hist0].c_str(),cut[hist].c_str());
	h_PFPhIsoVsRho[hist0][hist] = new TH2F(name, "PFPhIsoVsRho", 500, 0.0, 50.0, 1000, 0, 100);
	h_PFPhIsoVsRho[hist0][hist]->GetYaxis()->SetTitle("PFPhIso");     h_PFPhIsoVsRho[hist0][hist]->GetYaxis()->CenterTitle();
	h_PFPhIsoVsRho[hist0][hist]->GetXaxis()->SetTitle("Rho");    h_PFPhIsoVsRho[hist0][hist]->GetXaxis()->CenterTitle();
	h_PFPhIsoVsRho[hist0][hist]->Sumw2();

	sprintf(name, "h_prof_PFPhIsoVsPt_%s_%s",cut0[hist0].c_str(),cut[hist].c_str());
	h_prof_PFPhIsoVsPt[hist0][hist] = new TProfile(name, "PFPhIsoVsPt", 150, 0.0, 6000.0, 0, 100);
	h_prof_PFPhIsoVsPt[hist0][hist]->GetYaxis()->SetTitle("PFPhIso");     h_prof_PFPhIsoVsPt[hist0][hist]->GetYaxis()->CenterTitle();
	h_prof_PFPhIsoVsPt[hist0][hist]->GetXaxis()->SetTitle("P_{T}^{#gamma} (GeV)");   h_prof_PFPhIsoVsPt[hist0][hist]->GetXaxis()->CenterTitle();
	h_prof_PFPhIsoVsPt[hist0][hist]->Sumw2();

	sprintf(name, "h_prof_PFPhIsoVsRho_%s_%s",cut0[hist0].c_str(),cut[hist].c_str());
	h_prof_PFPhIsoVsRho[hist0][hist] = new TProfile(name, "PFPhIsoVsRho", 500, 0.0, 50.0, 0, 100);
	h_prof_PFPhIsoVsRho[hist0][hist]->GetYaxis()->SetTitle("PFPhIso");     h_prof_PFPhIsoVsRho[hist0][hist]->GetYaxis()->CenterTitle();
	h_prof_PFPhIsoVsRho[hist0][hist]->GetXaxis()->SetTitle("Rho");   h_prof_PFPhIsoVsRho[hist0][hist]->GetXaxis()->CenterTitle();
   	h_prof_PFPhIsoVsRho[hist0][hist]->Sumw2();
