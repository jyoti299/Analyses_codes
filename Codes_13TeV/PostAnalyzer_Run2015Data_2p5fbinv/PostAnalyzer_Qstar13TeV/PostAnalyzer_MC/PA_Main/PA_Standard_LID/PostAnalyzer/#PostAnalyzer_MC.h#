...
public :
   ...
   TH1F *h_nIsoPhotons[3];
   TH1F *h_nGoodPhotons[3];
   TH2F *h_IsoPhotonIdxVsPt[3];
   TH2F *h_GoodPhotonIdxVsPt[3];
   TH1F *h_nJets[3];
   TH2F *h_JetIdxVsPt[3];
   ...
   virtual Bool_t   AK8JetId(Int_t iJet, TString jetWP);
...
Bool_t PostAnalyzer_MC::AK8JetId(Int_t iJet, TString jetWP){
  ...
  if(jetWP == "loose"){ //loose
    ...
    /*
    if(fabs((*AK8JetEta)[iJet]) > 3.0){
    
      JetID = ((*AK8JetNEF)[iJet] < 0.90)  &&;	      
        Num_of_Neutral_Particles_not_in_Ntuplizer > 10;
    }
    */
  }
...
void PostAnalyzer_MC::BookHistograms(){
  file->cd();
    ...
    for( Int_t hist = 0; hist < 2; ++hist ){ 
      ...
      h_PFMet[hist] = new TH1F(name, "PFMet distribution", 200,0.0,1000.0);
      ...
      sprintf(name, "h_SumPFMet_%s",cut[hist].c_str());
      h_SumPFMet[hist]  = new TH1F(name,"SumET PF Met distribution",80,0.0,4000.0);
      h_SumPFMet[hist]->GetYaxis()->SetTitle("Events/50 GeV");              h_SumPFMet[hist]->GetYaxis()->CenterTitle();
      h_SumPFMet[hist]->GetXaxis()->SetTitle("#sum#slash{E}_{T} (GeV)");    h_SumPFMet[hist]->GetXaxis()->CenterTitle();
      h_SumPFMet[hist]->Sumw2();

      sprintf(name, "h_MetBySumMET_%s",cut[hist].c_str());
      ...
      sprintf(name, "h_PtPhotJet_%s",cut[hist].c_str());
      ...
      sprintf(name, "h_etaPhotJet_%s",cut[hist].c_str());
      ...
      sprintf(name, "h_cosThetaStar_%s",cut[hist].c_str());
    ...
    for( Int_t hist = 0; hist < 3; ++hist ){
      ...
      sprintf(name, "h_nIsoPhotons_%s",cut1[hist].c_str());
      ...
      sprintf(name, "h_nGoodPhotons_%s",cut1[hist].c_str());
      ...
      sprintf(name, "h_IsoPhotonIdxVsPt_%s",cut1[hist].c_str());
      ...
      sprintf(name, "h_GoodPhotonIdxVsPt_%s",cut1[hist].c_str());
      ...
      sprintf(name, "h_JetIdxVsPt_%s",cut1[hist].c_str());
