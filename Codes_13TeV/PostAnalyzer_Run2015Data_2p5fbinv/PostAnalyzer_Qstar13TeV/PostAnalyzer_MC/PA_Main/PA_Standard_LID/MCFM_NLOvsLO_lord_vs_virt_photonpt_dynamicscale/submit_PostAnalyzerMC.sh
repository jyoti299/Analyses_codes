...
Double_t PostAnalyzer_MC::MCFM_kFact(Double_t phpt){
  ...
  TFile *f = TFile::Open("/uscms_data/d3/rocky86/slc6_amd64_gcc491/Analyzer_13TeV/PostAnalyzer_MC/MCFM_kFactor/MCFM_kFact_lordvsVirt_photonpt_dynamicscale.root");
