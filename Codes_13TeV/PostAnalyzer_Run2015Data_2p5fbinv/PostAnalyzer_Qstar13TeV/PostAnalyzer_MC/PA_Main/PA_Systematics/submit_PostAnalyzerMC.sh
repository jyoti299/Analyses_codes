...
MCnTuplesDir=root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/MC_76X/
Signal_Qstar=Signal 
...
##XS=( 3.033E2  1.632E1  5.213E-1  4.272E-2  4.8E-3  5.835E-4  7.076E-5  8.66E-6  1.283E-6  2.985E-7  )
#totalEvents=( 298953  299072  100000  74879  74271  74802  74822  49544  49628  50000  )
#mass_norm=( 500.0  1000.0  2000.0  3000.0  4000.0  5000.0  6000.0  7000.0  8000.0  9000.0 )

for i in QstarToGJ_M1000_f1p0  QstarToGJ_M2000_f1p0
do
XS=( 1.632E1  5.213E-1)
totalEvents=(299072  100000)
mass_norm=( 1000.0  2000.0)
...
public :
   ...
   TH1F *h_mass_X_bin1_JES[2];
   TH1F *h_mass_X_bin1_PES[2];
   TH1F *h_mass_X_bin1;

   //Cut Flow
   TH1F *h_CutFlow;
   TH1F *h_CutFlowWithWts;
   TH1F *h_CutFlowWithWts_XSm5;
   TH1F *h_CutFlowWithWts_XSp5;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      //      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/WGToLNuG/AOD_WGToLNuG_10.root/ggNtuplizer/EventTree");
      //      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/ZJets/AOD_WGToLNuG_124.root/ggNtuplizer/EventTree");
      /*      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/ZJets/AOD_WGToLNuG_10.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/ZJets/AOD_WGToLNuG_135.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/ZJets/AOD_WGToLNuG_14.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/ZJets/AOD_WGToLNuG_124.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC/ZJets/AOD_WGToLNuG_181.root/ggNtuplizer/EventTree");
...
Double_t PostAnalyzer_MC::MCFM_kFact(Double_t phpt){
  ...
  //  TFile *f = TFile::Open("/uscms_data/d3/rocky86/slc6_amd64_gcc491/Analyzer_13TeV/PostAnalyzer_MC/MCFM_kFactor/MCFM_kFact_lordvsVirt.root");
  //  TH1F *h = (TH1F*)f->Get("h_MCFMnlo_over_MCFMlo_DiffXS_vs_PhotPt");
  //  Int_t bin = h->GetXaxis()->FindBin(phpt);
  //  return h->GetBinContent( bin );

  Double_t kfac;
  if(phpt > 100 && phpt <= 400) kfac = 1.8;
  if(phpt > 400 && phpt <= 600) kfac = 1.4;
  if(phpt > 600) kfac = 1.0;
...
void PostAnalyzer_MC::PileupReWeighting(){
  ...
  //    Bool_t Pileup_Qstar = ${Qstar};
    ...
    //For Golden Json
    //  TFile *fData = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_2015/PostAnalyzer_Qstar13TeV/PostAnalyzer_MC/PileupHistograms/Data_Run2015D_PileUpDist_GoldenJson/DataPileupHist_2015D.root");
    //For Silver Json
  TFile *fData = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_2015/PostAnalyzer_Qstar13TeV/PostAnalyzer_MC/PileupHistograms/Data_Run2015D_PileUpDist_SilverJson/DataPileupHist_2015D.root");
  TH1F *dataPU = (TH1F*)fData->Get("pileup");
   
  TFile *fMC = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_2015/PostAnalyzer_Qstar13TeV/PostAnalyzer_MC/PileupHistograms/MC_Run2015D_PileUpDist/"+puMCfile+".root");
...
void PostAnalyzer_MC::PileupReWeighting_XSm5(){
  ...
  //    Bool_t Pileup_Qstar = ${Qstar};
    ...
    //  TFile *fData = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_2015/PostAnalyzer_Qstar13TeV/PostAnalyzer_MC/PileupHistograms/Data_Run2015D_PileUpDist_GoldenJson/DataPileupHist_2015D.root");
    //For Silver Json
  TFile *fData = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_2015/PostAnalyzer_Qstar13TeV/PostAnalyzer_MC/PileupHistograms/Data_Run2015D_PileUpDist_SilverJson_XSm5/DataPileupHist_2015D_XSm5.root");
  TH1F *dataPU = (TH1F*)fData->Get("pileup");
...
void PostAnalyzer_MC::PileupReWeighting_XSp5(){
  ...
  //    Bool_t Pileup_Qstar = ${Qstar};
    ...
    //  TFile *fData = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_2015/PostAnalyzer_Qstar13TeV/PostAnalyzer_MC/PileupHistograms/Data_Run2015D_PileUpDist_GoldenJson/DataPileupHist_2015D.root");
    //For Silver Json
  TFile *fData = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_2015/PostAnalyzer_Qstar13TeV/PostAnalyzer_MC/PileupHistograms/Data_Run2015D_PileUpDist_SilverJson_XSp5/DataPileupHist_2015D_XSp5.root");
  TH1F *dataPU = (TH1F*)fData->Get("pileup");
...
void PostAnalyzer_MC::BookHistograms(){
  ...
  const Double_t MassBin[nMassBins+1] = {1, 3, 6, 10, 16, 23, 31, 40, 50, 61, 73, 86, 100, 115, 132, 150, 169, 189, 210, 232, 252, 273, 295, 318, 341, 365, 390, 416, 443, 471, 500, 530, 560, 593, 626, 660, 695, 731, 768, 806, 846, 887, 929, 972, 1017, 1063, 1110, 1159, 1209, 1261, 1315, 1370, 1427, 1486, 1547, 1609, 1673, 1739, 1807, 1877, 1950, 2025, 2102, 2182, 2264, 2349, 2436, 2526, 2619, 2714, 2812, 2913, 3018, 3126, 3237, 3352, 3470, 3592, 3718, 3847, 3980, 4117, 4259, 4405, 4556, 4711, 4871, 5036, 5206, 5381, 5562, 5748, 5940, 6138, 6342, 6552, 6769, 6993, 7223, 7461, 7706, 7959, 8219, 8487, 8764, 9049, 9343, 9646, 9958, 10280, 10612, 10954, 11307, 11671, 12046, 12432, 12830, 13241, 13664, 14000};
    ...
    std::string masscut[2] = {"noMassCut", "MassCut"};
    for (int ii = 0; ii < 2; ii++){
      for(int jj = 0; jj < 2; jj++){

      sprintf(hname, "h_profile_JES_%s_%s", scale[ii].c_str(), masscut[jj].c_str());
      sprintf(htit, "Profile of JES_%s vs Mass %s", scale[ii].c_str(), masscut[jj].c_str());

      h_profile_JES[ii][jj] = new TProfile(hname, htit, nMassBins, MassBin);


      sprintf(hname, "h_mass_JES_%s_%s", scale[ii].c_str(), masscut[jj].c_str());
      sprintf(htit, "Mass Distribution for JES_%s %s", scale[ii].c_str(), masscut[jj].c_str());
      ...
      sprintf(hname, "h_profile_PES_%s_%s", scale[ii].c_str(), masscut[jj].c_str());
      sprintf(htit, "Profile of PES_%s vs Mass %s", scale[ii].c_str(), masscut[jj].c_str());

      h_profile_PES[ii][jj] = new TProfile(hname, htit, nMassBins, MassBin);


      sprintf(hname, "h_mass_PES_%s_%s", scale[ii].c_str(), masscut[jj].c_str());
      sprintf(htit, "Mass Distribution for PES_%s %s", scale[ii].c_str(), masscut[jj].c_str());
    ...
    for(Int_t ij = 0; ij < 2; ij++){
      ...
      sprintf(hname, "h_mass_X_bin1_JES_%s", scale[ij].c_str());
      sprintf(htit, "X dist of Invt Mass for JES_%s", scale[ij].c_str());
      h_mass_X_bin1_JES[ij] = new TH1F(hname, htit, 14000,0.0,5.0);
      h_mass_X_bin1_JES[ij]->GetYaxis()->SetTitle("Events");   h_mass_X_bin1_JES[ij]->GetYaxis()->CenterTitle();
      h_mass_X_bin1_JES[ij]->GetXaxis()->SetTitle("X = M_{#gamma jet}/M_{q^{#ast}}");    h_mass_X_bin1_JES[ij]->GetXaxis()->CenterTitle();
      h_mass_X_bin1_JES[ij]->Sumw2();

      sprintf(hname, "h_mass_X_bin1_PES_%s", scale[ij].c_str());
      sprintf(htit, "X dist of Invt Mass for PES_%s", scale[ij].c_str());
      h_mass_X_bin1_PES[ij] = new TH1F(hname, htit, 14000,0.0,5.0);
      h_mass_X_bin1_PES[ij]->GetYaxis()->SetTitle("Events");   h_mass_X_bin1_PES[ij]->GetYaxis()->CenterTitle();
      h_mass_X_bin1_PES[ij]->GetXaxis()->SetTitle("X = M_{#gamma jet}/M_{q^{#ast}}");    h_mass_X_bin1_PES[ij]->GetXaxis()->CenterTitle();
      h_mass_X_bin1_PES[ij]->Sumw2();

    }

    h_mass_X_bin1 = new TH1F("h_mass_X_bin1", "X Dist of Invt mass", 14000,0.0,5.0);
    ...
    const int nbins = 11;
    const int nbinsWt = 11;
    TString CutFlowLabels[nbins] = {"Total", "HLT", "PrimaryVtx", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "DPhi", "DEta", "GJInvtMass"};
    TString CutFlowLabelsWithWts[nbinsWt] = {"Total", "HLT", "PrimaryVtx", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "DPhi", "DEta", "GJInvtMass"};
    ...
    h_CutFlowWithWts_XSm5 = new TH1F("h_CutFlowWithWts_XSm5", "Events Passing Various Cuts With Weights", nbinsWt, 0, nbinsWt);
    h_CutFlowWithWts_XSm5->GetYaxis()->SetTitle("Events");         h_CutFlowWithWts_XSm5->GetYaxis()->CenterTitle();
    for(int i = 0; i < nbinsWt; i++){
      h_CutFlowWithWts_XSm5->GetXaxis()->SetBinLabel(i+1, CutFlowLabelsWithWts[i]);
    }

    h_CutFlowWithWts_XSp5 = new TH1F("h_CutFlowWithWts_XSp5", "Events Passing Various Cuts With Weights", nbinsWt, 0, nbinsWt);
    h_CutFlowWithWts_XSp5->GetYaxis()->SetTitle("Events");         h_CutFlowWithWts_XSp5->GetYaxis()->CenterTitle();
    for(int i = 0; i < nbinsWt; i++){
      h_CutFlowWithWts_XSp5->GetXaxis()->SetBinLabel(i+1, CutFlowLabelsWithWts[i]);
    }
