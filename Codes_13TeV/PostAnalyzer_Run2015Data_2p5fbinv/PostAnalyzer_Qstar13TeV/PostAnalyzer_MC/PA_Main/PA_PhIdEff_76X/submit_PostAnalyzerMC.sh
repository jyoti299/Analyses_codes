...
#MCnTuplesDir=root://cmsxrootd.fnal.gov//eos/uscms/store/user/lpcqstar/13TeV/NTuples/MC
GJets=GJets
DiJet=DiJet
Signal_Qstar=Signal
...
public :
   ...
   Int_t JC_G, JC_L, JC_M, JC_T, JC_H;
   ...
   //Histograms
   //Photon Efficiency
   TH1F *h_PassPhIdGenIsoMatch_EB;
   TH1F *h_PassPhIdGenIsoMatch_EE;
   ...
   TH1F *h_PassInvtMassGenIsoMatch_EB;
   TH1F *h_PassInvtMassGenIsoMatch_EE;
   TH1F *h_PassInvtMassLoose_EB;
   TH1F *h_PassInvtMassLoose_EE;
   TH1F *h_PassInvtMassMedium_EB;
   TH1F *h_PassInvtMassMedium_EE;
   TH1F *h_PassInvtMassTight_EB;
   TH1F *h_PassInvtMassTight_EE;
   TH1F *h_PassInvtMassHighPt_EB;
   TH1F *h_PassInvtMassHighPt_EE;

   //Cut Flow
   TH1F *h_CutFlow_PhEff;
   TH1F *h_CutFlowWithWts_PhEff;
...
/*      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/MC_76X/Signal/QstarToGJ_M1000_f1p0/ntuple_QstarToGJ_M-1000_f-1p0_76X_1.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/MC_76X/Signal/QstarToGJ_M1000_f1p0/ntuple_QstarToGJ_M-1000_f-1p0_76X_12.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/MC_76X/Signal/QstarToGJ_M1000_f1p0/ntuple_QstarToGJ_M-1000_f-1p0_76X_13.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/MC_76X/Signal/QstarToGJ_M1000_f1p0/ntuple_QstarToGJ_M-1000_f-1p0_76X_18.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/MC_76X/Signal/QstarToGJ_M1000_f1p0/ntuple_QstarToGJ_M-1000_f-1p0_76X_15.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/MC_76X/Signal/QstarToGJ_M1000_f1p0/ntuple_QstarToGJ_M-1000_f-1p0_76X_19.root/ggNtuplizer/EventTree");
...
void PostAnalyzer_MC::PileupReWeighting(){
  ...
  //    Bool_t Pileup_Qstar = ${Qstar};
    ...
    //For Silver Json
  TFile *fData = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_Qstar13TeV/PostAnalyzer_MC/PileupHistograms/Data_Run2015D_PileUpDist_SilverJson/DataPileupHist_2015D.root");
  TH1F *dataPU = (TH1F*)fData->Get("pileup");
   
  TFile *fMC = TFile::Open("/uscms_data/d3/rocky86/13TeV/PostAnalyzer_Qstar13TeV/PostAnalyzer_MC/PileupHistograms/MC_Run2015D_PileUpDist/"+puMCfile+".root");
...
void PostAnalyzer_MC::BookHistograms(){
  file->cd();
    ...
    h_PassPhIdGenIsoMatch_EB = new TH1F("h_PassPhIdGenIsoMatch_EB", "Pt Distribution of Photons matching with Gen in EB", 1200, 0.0, 6000.0);
    h_PassPhIdGenIsoMatch_EB->GetYaxis()->SetTitle("Events/5 GeV");   h_PassPhIdGenIsoMatch_EB->GetYaxis()->CenterTitle();
    h_PassPhIdGenIsoMatch_EB->GetXaxis()->SetTitle("P_{T}^{#gamma}"); h_PassPhIdGenIsoMatch_EB->GetXaxis()->CenterTitle();
    h_PassPhIdGenIsoMatch_EB->Sumw2();

    h_PassPhIdGenIsoMatch_EE = new TH1F("h_PassPhIdGenIsoMatch_EE", "Pt Distribution of Photons matching with Gen in EE", 1200, 0.0, 6000.0);
    h_PassPhIdGenIsoMatch_EE->GetYaxis()->SetTitle("Events/5 GeV");   h_PassPhIdGenIsoMatch_EE->GetYaxis()->CenterTitle();
    h_PassPhIdGenIsoMatch_EE->GetXaxis()->SetTitle("P_{T}^{#gamma}"); h_PassPhIdGenIsoMatch_EE->GetXaxis()->CenterTitle();
    h_PassPhIdGenIsoMatch_EE->Sumw2();
    ...
    //Photon Efficiency Vs InvtMass
    h_PassInvtMassGenIsoMatch_EB =  new TH1F("h_PassInvtMassGenIsoMatch_EB", "Invt mass of photon+jet passing GenIsoMatch in EB", nMassBins, MassBin);
    h_PassInvtMassGenIsoMatch_EB->GetYaxis()->SetTitle("Events/VarBin");    h_PassInvtMassGenIsoMatch_EB->GetYaxis()->CenterTitle();
    h_PassInvtMassGenIsoMatch_EB->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassInvtMassGenIsoMatch_EB->GetXaxis()->CenterTitle();
    h_PassInvtMassGenIsoMatch_EB->Sumw2();     

    h_PassInvtMassGenIsoMatch_EE =  new TH1F("h_PassInvtMassGenIsoMatch_EE", "Invt mass of photon+jet passing GenIsoMatch in EE", nMassBins, MassBin);
    h_PassInvtMassGenIsoMatch_EE->GetYaxis()->SetTitle("Events/VarBin");    h_PassInvtMassGenIsoMatch_EE->GetYaxis()->CenterTitle();
    h_PassInvtMassGenIsoMatch_EE->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassInvtMassGenIsoMatch_EE->GetXaxis()->CenterTitle();
    h_PassInvtMassGenIsoMatch_EE->Sumw2();     

    h_PassInvtMassLoose_EB =  new TH1F("h_PassInvtMassLoose_EB", "Invt mass of photon+jet passing Loose Id in EB", nMassBins, MassBin);
    h_PassInvtMassLoose_EB->GetYaxis()->SetTitle("Events/VarBin");    h_PassInvtMassLoose_EB->GetYaxis()->CenterTitle();
    h_PassInvtMassLoose_EB->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassInvtMassLoose_EB->GetXaxis()->CenterTitle();
    h_PassInvtMassLoose_EB->Sumw2();     

    h_PassInvtMassLoose_EE =  new TH1F("h_PassInvtMassLoose_EE", "Invt mass of photon+jet passing Loose Id in EE", nMassBins, MassBin);
    h_PassInvtMassLoose_EE->GetYaxis()->SetTitle("Events/VarBin");    h_PassInvtMassLoose_EE->GetYaxis()->CenterTitle();
    h_PassInvtMassLoose_EE->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassInvtMassLoose_EE->GetXaxis()->CenterTitle();
    h_PassInvtMassLoose_EE->Sumw2();     

    h_PassInvtMassMedium_EB =  new TH1F("h_PassInvtMassMedium_EB", "Invt mass of photon+jet passing Medium Id in EB", nMassBins, MassBin);
    h_PassInvtMassMedium_EB->GetYaxis()->SetTitle("Events/VarBin");    h_PassInvtMassMedium_EB->GetYaxis()->CenterTitle();
    h_PassInvtMassMedium_EB->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassInvtMassMedium_EB->GetXaxis()->CenterTitle();
    h_PassInvtMassMedium_EB->Sumw2();     

    h_PassInvtMassMedium_EE =  new TH1F("h_PassInvtMassMedium_EE", "Invt mass of photon+jet passing Medium Id in EE", nMassBins, MassBin);
    h_PassInvtMassMedium_EE->GetYaxis()->SetTitle("Events/VarBin");    h_PassInvtMassMedium_EE->GetYaxis()->CenterTitle();
    h_PassInvtMassMedium_EE->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassInvtMassMedium_EE->GetXaxis()->CenterTitle();
    h_PassInvtMassMedium_EE->Sumw2();     

    h_PassInvtMassTight_EB =  new TH1F("h_PassInvtMassTight_EB", "Invt mass of photon+jet passing Tight Id in EB", nMassBins, MassBin);
    h_PassInvtMassTight_EB->GetYaxis()->SetTitle("Events/VarBin");    h_PassInvtMassTight_EB->GetYaxis()->CenterTitle();
    h_PassInvtMassTight_EB->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassInvtMassTight_EB->GetXaxis()->CenterTitle();
    h_PassInvtMassTight_EB->Sumw2();     

    h_PassInvtMassTight_EE =  new TH1F("h_PassInvtMassTight_EE", "Invt mass of photon+jet passing Tight Id in EE", nMassBins, MassBin);
    h_PassInvtMassTight_EE->GetYaxis()->SetTitle("Events/VarBin");    h_PassInvtMassTight_EE->GetYaxis()->CenterTitle();
    h_PassInvtMassTight_EE->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassInvtMassTight_EE->GetXaxis()->CenterTitle();
    h_PassInvtMassTight_EE->Sumw2();     

    h_PassInvtMassHighPt_EB =  new TH1F("h_PassInvtMassHighPt_EB", "Invt mass of photon+jet passing HighPt Id in EB", nMassBins, MassBin);
    h_PassInvtMassHighPt_EB->GetYaxis()->SetTitle("Events/VarBin");    h_PassInvtMassHighPt_EB->GetYaxis()->CenterTitle();
    h_PassInvtMassHighPt_EB->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassInvtMassHighPt_EB->GetXaxis()->CenterTitle();
    h_PassInvtMassHighPt_EB->Sumw2();     
    
    h_PassInvtMassHighPt_EE =  new TH1F("h_PassInvtMassHighPt_EE", "Invt mass of photon+jet passing HighPt Id in EE", nMassBins, MassBin);
    h_PassInvtMassHighPt_EE->GetYaxis()->SetTitle("Events/VarBin");    h_PassInvtMassHighPt_EE->GetYaxis()->CenterTitle();
    h_PassInvtMassHighPt_EE->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassInvtMassHighPt_EE->GetXaxis()->CenterTitle();
    h_PassInvtMassHighPt_EE->Sumw2();     
    ...
    TString CutFlowLabels[nbins] = {"Total", "PassLooserId_EB", "PassLooseId_EB", "PassMediumId_EB", "PassTightId_EB", "PassHighPtId_EB", "PassLooserId_EE", "PassLooseId_EE", "PassMediumId_EE", "PassTightId_EE", "PassHighPtId_EE"};
    TString CutFlowLabelsWithWts[nbinsWt] = {"Total", "PassLooserId_EB", "PassLooseId_EB", "PassMediumId_EB", "PassTightId_EB", "PassHighPtId_EB", "PassLooserId_EE", "PassLooseId_EE", "PassMediumId_EE", "PassTightId_EE", "PassHighPtId_EE"};

    h_CutFlow_PhEff = new TH1F("h_CutFlow_PhEff", "Events Passing Various Cuts for photon efficiency", nbins, 0, nbins);
    h_CutFlow_PhEff->GetYaxis()->SetTitle("Events");         h_CutFlow_PhEff->GetYaxis()->CenterTitle();
    for(int i = 0; i < nbins; i++){
      h_CutFlow_PhEff->GetXaxis()->SetBinLabel(i+1, CutFlowLabels[i]);
    }

    h_CutFlowWithWts_PhEff = new TH1F("h_CutFlowWithWts_PhEff", "Events Passing Various Cuts With Weights  for photon efficiency", nbinsWt, 0, nbinsWt);
    h_CutFlowWithWts_PhEff->GetYaxis()->SetTitle("Events");         h_CutFlowWithWts_PhEff->GetYaxis()->CenterTitle();
    for(int i = 0; i < nbinsWt; i++){
      h_CutFlowWithWts_PhEff->GetXaxis()->SetBinLabel(i+1, CutFlowLabelsWithWts[i]);
    }
