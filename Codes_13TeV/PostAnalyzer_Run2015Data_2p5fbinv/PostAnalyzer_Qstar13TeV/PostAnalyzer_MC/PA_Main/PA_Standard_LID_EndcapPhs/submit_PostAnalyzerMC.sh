...
PostAna_Dir_final=${PostAna_Dir}/Standard_LID_EndcapPhs
...
#do
#XS=(311.164  50690  117.864  5846)##these may not correct so correct these
...
/*      chain->Add("root://cmseos.fnal.gov//store/user/lpcqstar/13TeV/NTuples/MC/DiJet/AOD_QCD_Pt_170to300_1.root/ggNtuplizer/EventTree"); 
