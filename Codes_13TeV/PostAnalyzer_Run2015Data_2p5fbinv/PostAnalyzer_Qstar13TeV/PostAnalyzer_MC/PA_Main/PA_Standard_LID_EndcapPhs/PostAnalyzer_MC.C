...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   //Define Output file here
   TString OutputPath = "/eos/uscms/store/user/rocky86/13TeV/PostAnalyzer_Results/Standard_LID_EndcapPhs/MC/Signal_Qstar/";
   TString OutputFile = "QstarToGJ_M7000_f1p0";
		  ...
		  if(Pass_JetEta){
			...
			h_CutFlowWithWts->Fill(9.5, PreBTag_EvtWt);
			  ...
			  //Uncomment in script for qstar
  			  h_mass_X_bin1              ->Fill(GetInvtMass(PC, JC)/(7000.0), PreBTag_EvtWt);
