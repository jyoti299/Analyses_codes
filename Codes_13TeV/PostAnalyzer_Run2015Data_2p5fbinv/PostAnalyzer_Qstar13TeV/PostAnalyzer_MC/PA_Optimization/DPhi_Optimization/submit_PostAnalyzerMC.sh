...
#outputDir=${PostAna_Dir_final}/DPhi_Optimization
	  ...
	  if(GoodIsoPhotons.size() > 0){
		...
		if(Pass_JetPt){
		  ...
		  if(Pass_JetEta){
			...
			//Uncomment in script
			//h_mass_X_bin1_dphi1p5            ->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);

			h_GJetInvtMass_bin40_dphi1p5[0]    ->Fill(GetInvtMass(PC, JC),PreBTag_EvtWt);
			h_GJetInvtMass_VarBin_dphi1p5[0]   ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			h_GJetInvtMass_UnitBin_dphi1p5[0]  ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);

			if(Pass_GJInvtMass){
			  h_CutFlow->Fill(10.5);
			  h_CutFlowWithWts->Fill(10.5, PreBTag_EvtWt);

			  h_GJetInvtMass_bin40_dphi1p5[1]    ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			  h_GJetInvtMass_VarBin_dphi1p5[1]   ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			  h_GJetInvtMass_UnitBin_dphi1p5[1]  ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			...
			//Uncomment in script
			//h_mass_X_bin1_dphi2p0            ->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);

			h_GJetInvtMass_bin40_dphi2p0[0]    ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			h_GJetInvtMass_VarBin_dphi2p0[0]   ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			h_GJetInvtMass_UnitBin_dphi2p0[0]  ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);

			if(Pass_GJInvtMass){
			  h_CutFlow->Fill(13.5);
			  h_CutFlowWithWts->Fill(13.5, PreBTag_EvtWt);

			  h_GJetInvtMass_bin40_dphi2p0[1]    ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			  h_GJetInvtMass_VarBin_dphi2p0[1]   ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			  h_GJetInvtMass_UnitBin_dphi2p0[1]  ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			...
			//Uncomment in script
			//h_mass_X_bin1_dphi2p5            ->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);

			h_GJetInvtMass_bin40_dphi2p5[0]    ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			h_GJetInvtMass_VarBin_dphi2p5[0]   ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			h_GJetInvtMass_UnitBin_dphi2p5[0]  ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);

			if(Pass_GJInvtMass){
			  h_CutFlow->Fill(16.5);
			  h_CutFlowWithWts->Fill(16.5, PreBTag_EvtWt);

			  h_GJetInvtMass_bin40_dphi2p5[1]    ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			  h_GJetInvtMass_VarBin_dphi2p5[1]   ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			  h_GJetInvtMass_UnitBin_dphi2p5[1]  ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			...
			//Uncomment in script
			//h_mass_X_bin1_dphi3p0            ->Fill(GetInvtMass(PC, JC)/${mass_norm[${sampleIndex}]}, PreBTag_EvtWt);

			h_GJetInvtMass_bin40_dphi3p0[0]    ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			h_GJetInvtMass_VarBin_dphi3p0[0]   ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			h_GJetInvtMass_UnitBin_dphi3p0[0]  ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);

			if(Pass_GJInvtMass){
			  h_CutFlow->Fill(19.5);
			  h_CutFlowWithWts->Fill(19.5, PreBTag_EvtWt);

			  h_GJetInvtMass_bin40_dphi3p0[1]    ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			  h_GJetInvtMass_VarBin_dphi3p0[1]   ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
			  h_GJetInvtMass_UnitBin_dphi3p0[1]  ->Fill(GetInvtMass(PC, JC), PreBTag_EvtWt);
...
public :
   ...
   TH1F *h_mass_X_bin1_dphi1p5; //Invt mass divide by mean mass required for interploation of signal shapes.
   TH1F *h_mass_X_bin1_dphi2p0;
   TH1F *h_mass_X_bin1_dphi2p5;
   TH1F *h_mass_X_bin1_dphi3p0;
...
void PostAnalyzer_MC::BookHistograms(){
  file->cd();
    ...
    h_mass_X_bin1_dphi1p5 = new TH1F("h_mass_X_bin1_dphi1p5","mass of photon+jet",14000,0.0,5.0); 
    h_mass_X_bin1_dphi1p5->GetYaxis()->SetTitle("Events");                            h_mass_X_bin1_dphi1p5->GetYaxis()->CenterTitle();
    h_mass_X_bin1_dphi1p5->GetXaxis()->SetTitle("X = M_{#gamma jet}/M_{q^{#ast}}");   h_mass_X_bin1_dphi1p5->GetXaxis()->CenterTitle();
    h_mass_X_bin1_dphi1p5->Sumw2();

    h_mass_X_bin1_dphi2p0 = new TH1F("h_mass_X_bin1_dphi2p0","mass of photon+jet",14000,0.0,5.0); 
    h_mass_X_bin1_dphi2p0->GetYaxis()->SetTitle("Events");                            h_mass_X_bin1_dphi2p0->GetYaxis()->CenterTitle();
    h_mass_X_bin1_dphi2p0->GetXaxis()->SetTitle("X = M_{#gamma jet}/M_{q^{#ast}}");   h_mass_X_bin1_dphi2p0->GetXaxis()->CenterTitle();
    h_mass_X_bin1_dphi2p0->Sumw2();

    h_mass_X_bin1_dphi2p5 = new TH1F("h_mass_X_bin1_dphi2p5","mass of photon+jet",14000,0.0,5.0); 
    h_mass_X_bin1_dphi2p5->GetYaxis()->SetTitle("Events");                            h_mass_X_bin1_dphi2p5->GetYaxis()->CenterTitle();
    h_mass_X_bin1_dphi2p5->GetXaxis()->SetTitle("X = M_{#gamma jet}/M_{q^{#ast}}");   h_mass_X_bin1_dphi2p5->GetXaxis()->CenterTitle();
    h_mass_X_bin1_dphi2p5->Sumw2();

    h_mass_X_bin1_dphi3p0 = new TH1F("h_mass_X_bin1_dphi3p0","mass of photon+jet",14000,0.0,5.0); 
    h_mass_X_bin1_dphi3p0->GetYaxis()->SetTitle("Events");                            h_mass_X_bin1_dphi3p0->GetYaxis()->CenterTitle();
    h_mass_X_bin1_dphi3p0->GetXaxis()->SetTitle("X = M_{#gamma jet}/M_{q^{#ast}}");   h_mass_X_bin1_dphi3p0->GetXaxis()->CenterTitle();
    h_mass_X_bin1_dphi3p0->Sumw2();
    ...
    TString CutFlowLabelsWithWts[nbinsWt] = {"Total", "HLT", "PrimaryVtx_&_METFilters", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "DPhi1p5", "DPhi1p5+DEta", "DPhi1p5+DEta+GJInvtMass", "DPhi2p0", "DPhi2p0+DEta", "DPhi2p0+DEta+GJInvtMass", "DPhi2p5", "DPhi2p5+DEta", "DPhi2p5+DEta+GJInvtMass", "DPhi3p0", "DPhi3p0+DEta", "DPhi3p0+DEta+GJInvtMass"};
