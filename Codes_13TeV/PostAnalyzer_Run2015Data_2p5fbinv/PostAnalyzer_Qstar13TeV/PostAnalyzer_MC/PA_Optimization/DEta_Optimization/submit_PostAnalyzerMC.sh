...
MCnTuplesDir=root://cmseos.fnal.gov//store/user/lpcqstar/13TeV/NTuples/MC
GJets=GJets
DiJet=DiJet
...
#PostAna_Dir_final=${PostAna_Dir}/Optimization
#outputDir=${PostAna_Dir_final}/DEta_Optimization
#PostAnaMC_Dir=${outputDir}/MC
...
#mass_norm=( 500  1000  2000  3000  4000  5000  6000  7000 )

#sourceDir=${MCnTuplesDir}/${Signal_Qstar}/${i}/
#finalDir=${PostAnaMC_Dir}/${Signal_Qstar}
...
public :
   ...
   //Histograms
   //for deta = 1.0
   TH1F *h_GJetInvtMass_bin40_deta1p0[2];
   TH1F *h_GJetInvtMass_VarBin_deta1p0[2];
   TH1F *h_GJetInvtMass_UnitBin_deta1p0[2];

   //for deta = 1.2
   TH1F *h_GJetInvtMass_bin40_deta1p2[2];
   TH1F *h_GJetInvtMass_VarBin_deta1p2[2];
   TH1F *h_GJetInvtMass_UnitBin_deta1p2[2];

   //for deta = 1.5
   TH1F *h_GJetInvtMass_bin40_deta1p5[2];
   TH1F *h_GJetInvtMass_VarBin_deta1p5[2];
   TH1F *h_GJetInvtMass_UnitBin_deta1p5[2];

   //for deta = 2.0
   TH1F *h_GJetInvtMass_bin40_deta2p0[2];
   TH1F *h_GJetInvtMass_VarBin_deta2p0[2];
   TH1F *h_GJetInvtMass_UnitBin_deta2p0[2];

   //for deta = 2.2
   TH1F *h_GJetInvtMass_bin40_deta2p2[2];
   TH1F *h_GJetInvtMass_VarBin_deta2p2[2];
   TH1F *h_GJetInvtMass_UnitBin_deta2p2[2];

   TH1F *h_mass_X_bin1_deta1p0; //Invt mass divide by mean mass required for interploation of signal shapes.
   TH1F *h_mass_X_bin1_deta1p2;
   TH1F *h_mass_X_bin1_deta1p5;
   TH1F *h_mass_X_bin1_deta2p0;
   TH1F *h_mass_X_bin1_deta2p2;
...
//    puMCfile = "Qstar_PileupHist";

    //For Golden Json
    // TFile *fData = TFile::Open("/uscms_data/d3/rocky86/slc6_amd64_gcc491/Analyzer_13TeV/PostAnalyzer_MC/PileupHistograms/Data_Run2015D_PileUpDist/DataPileupHist_2015D.root");
    //For Silver Json
...
void PostAnalyzer_MC::BookHistograms(){
  file->cd();
    ...
    for( Int_t hist = 0; hist < 2; ++hist ){ 
      ...
      sprintf(name, "h_GJetInvtMass_bin40_deta1p0_%s",cut[hist].c_str());
      h_GJetInvtMass_bin40_deta1p0[hist] = new TH1F(name,"Invt mass of photon+jet", 350, 0.0, 14000.0);
      h_GJetInvtMass_bin40_deta1p0[hist]->GetYaxis()->SetTitle("Events/40 GeV");       h_GJetInvtMass_bin40_deta1p0[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_bin40_deta1p0[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_bin40_deta1p0[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_bin40_deta1p0[hist]->Sumw2(); 
     
      sprintf(name, "h_GJetInvtMass_VarBin_deta1p0_%s",cut[hist].c_str());
      h_GJetInvtMass_VarBin_deta1p0[hist] = new TH1F(name, "Invt mass of photon+jet", nMassBins, MassBin);
      h_GJetInvtMass_VarBin_deta1p0[hist]->GetYaxis()->SetTitle("Events/VarBin");       h_GJetInvtMass_VarBin_deta1p0[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_VarBin_deta1p0[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_VarBin_deta1p0[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_VarBin_deta1p0[hist]->Sumw2();

      sprintf(name, "h_GJetInvtMass_UnitBin_deta1p0_%s",cut[hist].c_str());
      h_GJetInvtMass_UnitBin_deta1p0[hist] = new TH1F(name,"Invt mass of photon+jet", 14000, 0.0, 14000.0);
      h_GJetInvtMass_UnitBin_deta1p0[hist]->GetYaxis()->SetTitle("Events/UnitBin");       h_GJetInvtMass_UnitBin_deta1p0[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_UnitBin_deta1p0[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_UnitBin_deta1p0[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_UnitBin_deta1p0[hist]->Sumw2(); 
     

      sprintf(name, "h_GJetInvtMass_bin40_deta1p2_%s",cut[hist].c_str());
      h_GJetInvtMass_bin40_deta1p2[hist] = new TH1F(name,"Invt mass of photon+jet", 350, 0.0, 14000.0);
      h_GJetInvtMass_bin40_deta1p2[hist]->GetYaxis()->SetTitle("Events/40 GeV");       h_GJetInvtMass_bin40_deta1p2[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_bin40_deta1p2[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_bin40_deta1p2[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_bin40_deta1p2[hist]->Sumw2(); 
     
      sprintf(name, "h_GJetInvtMass_VarBin_deta1p2_%s",cut[hist].c_str());
      h_GJetInvtMass_VarBin_deta1p2[hist] = new TH1F(name, "Invt mass of photon+jet", nMassBins, MassBin);
      h_GJetInvtMass_VarBin_deta1p2[hist]->GetYaxis()->SetTitle("Events/VarBin");       h_GJetInvtMass_VarBin_deta1p2[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_VarBin_deta1p2[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_VarBin_deta1p2[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_VarBin_deta1p2[hist]->Sumw2();

      sprintf(name, "h_GJetInvtMass_UnitBin_deta1p2_%s",cut[hist].c_str());
      h_GJetInvtMass_UnitBin_deta1p2[hist] = new TH1F(name,"Invt mass of photon+jet", 14000, 0.0, 14000.0);
      h_GJetInvtMass_UnitBin_deta1p2[hist]->GetYaxis()->SetTitle("Events/UnitBin");       h_GJetInvtMass_UnitBin_deta1p2[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_UnitBin_deta1p2[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_UnitBin_deta1p2[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_UnitBin_deta1p2[hist]->Sumw2(); 
     

      sprintf(name, "h_GJetInvtMass_bin40_deta1p5_%s",cut[hist].c_str());
      h_GJetInvtMass_bin40_deta1p5[hist] = new TH1F(name,"Invt mass of photon+jet", 350, 0.0, 14000.0);
      h_GJetInvtMass_bin40_deta1p5[hist]->GetYaxis()->SetTitle("Events/40 GeV");       h_GJetInvtMass_bin40_deta1p5[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_bin40_deta1p5[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_bin40_deta1p5[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_bin40_deta1p5[hist]->Sumw2(); 
     
      sprintf(name, "h_GJetInvtMass_VarBin_deta1p5_%s",cut[hist].c_str());
      h_GJetInvtMass_VarBin_deta1p5[hist] = new TH1F(name, "Invt mass of photon+jet", nMassBins, MassBin);
      h_GJetInvtMass_VarBin_deta1p5[hist]->GetYaxis()->SetTitle("Events/VarBin");       h_GJetInvtMass_VarBin_deta1p5[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_VarBin_deta1p5[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_VarBin_deta1p5[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_VarBin_deta1p5[hist]->Sumw2();

      sprintf(name, "h_GJetInvtMass_UnitBin_deta1p5_%s",cut[hist].c_str());
      h_GJetInvtMass_UnitBin_deta1p5[hist] = new TH1F(name,"Invt mass of photon+jet", 14000, 0.0, 14000.0);
      h_GJetInvtMass_UnitBin_deta1p5[hist]->GetYaxis()->SetTitle("Events/UnitBin");       h_GJetInvtMass_UnitBin_deta1p5[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_UnitBin_deta1p5[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_UnitBin_deta1p5[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_UnitBin_deta1p5[hist]->Sumw2(); 
     

      sprintf(name, "h_GJetInvtMass_bin40_deta2p0_%s",cut[hist].c_str());
      h_GJetInvtMass_bin40_deta2p0[hist] = new TH1F(name,"Invt mass of photon+jet", 350, 0.0, 14000.0);
      h_GJetInvtMass_bin40_deta2p0[hist]->GetYaxis()->SetTitle("Events/40 GeV");       h_GJetInvtMass_bin40_deta2p0[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_bin40_deta2p0[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_bin40_deta2p0[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_bin40_deta2p0[hist]->Sumw2(); 
     
      sprintf(name, "h_GJetInvtMass_VarBin_deta2p0_%s",cut[hist].c_str());
      h_GJetInvtMass_VarBin_deta2p0[hist] = new TH1F(name, "Invt mass of photon+jet", nMassBins, MassBin);
      h_GJetInvtMass_VarBin_deta2p0[hist]->GetYaxis()->SetTitle("Events/VarBin");       h_GJetInvtMass_VarBin_deta2p0[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_VarBin_deta2p0[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_VarBin_deta2p0[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_VarBin_deta2p0[hist]->Sumw2();

      sprintf(name, "h_GJetInvtMass_UnitBin_deta2p0_%s",cut[hist].c_str());
      h_GJetInvtMass_UnitBin_deta2p0[hist] = new TH1F(name,"Invt mass of photon+jet", 14000, 0.0, 14000.0);
      h_GJetInvtMass_UnitBin_deta2p0[hist]->GetYaxis()->SetTitle("Events/UnitBin");       h_GJetInvtMass_UnitBin_deta2p0[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_UnitBin_deta2p0[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_UnitBin_deta2p0[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_UnitBin_deta2p0[hist]->Sumw2(); 
     

      sprintf(name, "h_GJetInvtMass_bin40_deta2p2_%s",cut[hist].c_str());
      h_GJetInvtMass_bin40_deta2p2[hist] = new TH1F(name,"Invt mass of photon+jet", 350, 0.0, 14000.0);
      h_GJetInvtMass_bin40_deta2p2[hist]->GetYaxis()->SetTitle("Events/40 GeV");       h_GJetInvtMass_bin40_deta2p2[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_bin40_deta2p2[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_bin40_deta2p2[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_bin40_deta2p2[hist]->Sumw2(); 
     
      sprintf(name, "h_GJetInvtMass_VarBin_deta2p2_%s",cut[hist].c_str());
      h_GJetInvtMass_VarBin_deta2p2[hist] = new TH1F(name, "Invt mass of photon+jet", nMassBins, MassBin);
      h_GJetInvtMass_VarBin_deta2p2[hist]->GetYaxis()->SetTitle("Events/VarBin");       h_GJetInvtMass_VarBin_deta2p2[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_VarBin_deta2p2[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_VarBin_deta2p2[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_VarBin_deta2p2[hist]->Sumw2();

      sprintf(name, "h_GJetInvtMass_UnitBin_deta2p2_%s",cut[hist].c_str());
      h_GJetInvtMass_UnitBin_deta2p2[hist] = new TH1F(name,"Invt mass of photon+jet", 14000, 0.0, 14000.0);
      h_GJetInvtMass_UnitBin_deta2p2[hist]->GetYaxis()->SetTitle("Events/UnitBin");       h_GJetInvtMass_UnitBin_deta2p2[hist]->GetYaxis()->CenterTitle();
      h_GJetInvtMass_UnitBin_deta2p2[hist]->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_GJetInvtMass_UnitBin_deta2p2[hist]->GetXaxis()->CenterTitle();
      h_GJetInvtMass_UnitBin_deta2p2[hist]->Sumw2(); 
         }

    h_mass_X_bin1_deta1p0 = new TH1F("h_mass_X_bin1_deta1p0","mass of photon+jet",14000,0.0,5.0); 
    h_mass_X_bin1_deta1p0->GetYaxis()->SetTitle("Events");                            h_mass_X_bin1_deta1p0->GetYaxis()->CenterTitle();
    h_mass_X_bin1_deta1p0->GetXaxis()->SetTitle("X = M_{#gamma jet}/M_{q^{#ast}}");   h_mass_X_bin1_deta1p0->GetXaxis()->CenterTitle();
    h_mass_X_bin1_deta1p0->Sumw2();

    h_mass_X_bin1_deta1p2 = new TH1F("h_mass_X_bin1_deta1p2","mass of photon+jet",14000,0.0,5.0); 
    h_mass_X_bin1_deta1p2->GetYaxis()->SetTitle("Events");                            h_mass_X_bin1_deta1p2->GetYaxis()->CenterTitle();
    h_mass_X_bin1_deta1p2->GetXaxis()->SetTitle("X = M_{#gamma jet}/M_{q^{#ast}}");   h_mass_X_bin1_deta1p2->GetXaxis()->CenterTitle();
    h_mass_X_bin1_deta1p2->Sumw2();

    h_mass_X_bin1_deta1p5 = new TH1F("h_mass_X_bin1_deta1p5","mass of photon+jet",14000,0.0,5.0); 
    h_mass_X_bin1_deta1p5->GetYaxis()->SetTitle("Events");                            h_mass_X_bin1_deta1p5->GetYaxis()->CenterTitle();
    h_mass_X_bin1_deta1p5->GetXaxis()->SetTitle("X = M_{#gamma jet}/M_{q^{#ast}}");   h_mass_X_bin1_deta1p5->GetXaxis()->CenterTitle();
    h_mass_X_bin1_deta1p5->Sumw2();

    h_mass_X_bin1_deta2p0 = new TH1F("h_mass_X_bin1_deta2p0","mass of photon+jet",14000,0.0,5.0); 
    h_mass_X_bin1_deta2p0->GetYaxis()->SetTitle("Events");                            h_mass_X_bin1_deta2p0->GetYaxis()->CenterTitle();
    h_mass_X_bin1_deta2p0->GetXaxis()->SetTitle("X = M_{#gamma jet}/M_{q^{#ast}}");   h_mass_X_bin1_deta2p0->GetXaxis()->CenterTitle();
    h_mass_X_bin1_deta2p0->Sumw2();

    h_mass_X_bin1_deta2p2 = new TH1F("h_mass_X_bin1_deta2p2","mass of photon+jet",14000,0.0,5.0); 
    h_mass_X_bin1_deta2p2->GetYaxis()->SetTitle("Events");                            h_mass_X_bin1_deta2p2->GetYaxis()->CenterTitle();
    h_mass_X_bin1_deta2p2->GetXaxis()->SetTitle("X = M_{#gamma jet}/M_{q^{#ast}}");   h_mass_X_bin1_deta2p2->GetXaxis()->CenterTitle();
    h_mass_X_bin1_deta2p2->Sumw2();
    ...
    const int nbins = 19;
    const int nbinsWt = 19;
    TString CutFlowLabels[nbins] = {"Total", "HLT", "PrimaryVtx_&_METFilters", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "DPhi", "DEta1p0", "DEta1p0+GJInvtMass", "DEta1p2", "DEta1p2+GJInvtMass", "DEta1p5", "DEta1p5+GJInvtMass", "DEta2p0", "DEta2p0+GJInvtMass", "DEta2p2", "DEta2p2+GJInvtMass"};
    TString CutFlowLabelsWithWts[nbinsWt] = {"Total", "HLT", "PrimaryVtx_&_METFilters", "PhotonID", "PhotonPtEta", "JetID", "JetPt", "JetEta", "DPhi", "DEta1p0", "DEta1p0+GJInvtMass", "DEta1p2", "DEta1p2+GJInvtMass", "DEta1p5", "DEta1p5+GJInvtMass", "DEta2p0", "DEta2p0+GJInvtMass", "DEta2p2", "DEta2p2+GJInvtMass"};
