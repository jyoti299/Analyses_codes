...
void QstarInterpolation::runInterpolation()
{
       ...
       TString OutFile = "${outputDir}/ResonanceShapes_Qstar${coupling}_${inputDir}.root";
//       TString signalPath = "/eos/uscms/store/user/lpcqstar/13TeV/PostAnalyzer_Results/Qstar13TeV_HighPtPhID_Interpolation/MC/Signal_Qstar/";
       TString signalPath = "/eos/uscms/store/user/rocky86/13TeV/PostAnalyzer_Results/Optimization/DPhi_Optimization/MC/Signal_Qstar/";
       
       const int nSigFiles = 8;
       TString SignalFiles[nSigFiles] = {
       "QstarToGJ_M500_${coupling}.root",
       ...
       "QstarToGJ_M6000_${coupling}.root",
       "QstarToGJ_M7000_${coupling}.root",
       };
    ...
    //Input X histoname
    TString Mass_X   = "h_mass_X_bin1_dphi1p5";
