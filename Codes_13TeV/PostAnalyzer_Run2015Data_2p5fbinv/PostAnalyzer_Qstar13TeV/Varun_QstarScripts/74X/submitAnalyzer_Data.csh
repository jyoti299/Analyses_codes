...
foreach i ( Run2015D_PromptReco_v3  Run2015D_PromptReco_v4  Run2015D_PromptReco_v4_SJv2)
set XS =  ( 1.                      1.                      1. )
set totEvnts = (1                   1                       1  )
setenv sourceDir /store/user/leptonjets/varun/13TeV/Ntuples/Data/${i}/
setenv InputFilesPath root://cmsxrootd.fnal.gov/${sourceDir}
set filesPerJob = 2000 ## Total files : max
endif
##
###----------------------------------------------------------------------------------------------------
if( ${runCase} == 1 ) then
echo "******** Running for Testing -- DATA ***********"
foreach i ( Run2015D_PromptReco_v4_SJv2)
set XS =  ( 1.                    )
set totEvnts = (1                 )
setenv sourceDir /store/user/leptonjets/varun/13TeV/Ntuples/Data/${i}/
setenv InputFilesPath root://cmsxrootd.fnal.gov/${sourceDir}
