...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::ExRootConfReader*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::ExRootTask*)0x0)->GetClass(); }
   return fgIsA;
}
...
class __attribute__((annotate("$clingAutoload$external/ExRootAnalysis/ExRootAnalysisLinkDef.h")))  ExRootTreeReader;
class __attribute__((annotate("$clingAutoload$external/ExRootAnalysis/ExRootAnalysisLinkDef.h")))  ExRootTreeBranch;
class __attribute__((annotate("$clingAutoload$external/ExRootAnalysis/ExRootAnalysisLinkDef.h")))  ExRootTreeWriter;
class __attribute__((annotate("$clingAutoload$external/ExRootAnalysis/ExRootAnalysisLinkDef.h")))  ExRootResult;
class __attribute__((annotate("$clingAutoload$external/ExRootAnalysis/ExRootAnalysisLinkDef.h")))  ExRootClassifier;
class __attribute__((annotate("$clingAutoload$external/ExRootAnalysis/ExRootAnalysisLinkDef.h")))  ExRootFilter;
class __attribute__((annotate("$clingAutoload$external/ExRootAnalysis/ExRootAnalysisLinkDef.h")))  ExRootProgressBar;
class __attribute__((annotate("$clingAutoload$external/ExRootAnalysis/ExRootAnalysisLinkDef.h")))  ExRootConfReader;
class __attribute__((annotate("$clingAutoload$external/ExRootAnalysis/ExRootAnalysisLinkDef.h")))  ExRootConfParam;
class __attribute__((annotate("$clingAutoload$external/ExRootAnalysis/ExRootAnalysisLinkDef.h")))  ExRootTask;
)DICTFWDDCLS";
