...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::FastJetFinder*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("FastJetFinder", ::FastJetFinder::Class_Version(), "modules/FastJetFinder.h", 46,
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::FastJetFinder*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::FastJetGridMedianEstimator*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RunPUPPI*)0x0)->GetClass(); }
   return fgIsA;
}
...
class __attribute__((annotate("$clingAutoload$modules/FastJetLinkDef.h")))  FastJetFinder;
class __attribute__((annotate("$clingAutoload$modules/FastJetLinkDef.h")))  FastJetGridMedianEstimator;
class __attribute__((annotate("$clingAutoload$modules/FastJetLinkDef.h")))  RunPUPPI;
)DICTFWDDCLS";
