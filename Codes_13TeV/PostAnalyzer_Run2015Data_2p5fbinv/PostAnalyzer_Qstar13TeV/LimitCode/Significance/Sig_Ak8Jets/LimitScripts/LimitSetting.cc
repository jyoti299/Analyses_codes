...
void LimitSettingFiles_Data(){
  ...
  TFile *f = new TFile("/eos/uscms/store/user/rocky86/13TeV/PostAnalyzer_Results/Standard_LID/Data/Run2015D_PromptReco.root");
  TFile *fnew = new TFile("../Standard_LID_data_GJetInvtMass.root", "RECREATE");
