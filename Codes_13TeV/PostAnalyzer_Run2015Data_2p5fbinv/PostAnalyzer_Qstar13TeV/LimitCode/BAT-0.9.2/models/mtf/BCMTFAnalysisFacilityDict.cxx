//
// File generated by /cvmfs/cms.cern.ch/slc6_amd64_gcc481/lcg/root/5.34.10-cms7//bin/rootcint at Sun Feb 14 14:58:35 2016
...
static int G__BCMTFAnalysisFacilityDict_220_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFAnalysisFacilityDict_220_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((BCMTFAnalysisFacility*) G__getstructoffset())->GetBCMTF());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFAnalysisFacilityDict_220_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFAnalysisFacilityDict_220_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFAnalysisFacilityDict_220_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((BCMTFAnalysisFacility*) G__getstructoffset())->GetLogLevel());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BCMTFAnalysisFacilityDict_220_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFAnalysisFacilityDict_220_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
...
static int G__BCMTFAnalysisFacilityDict_220_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
...
static int G__BCMTFAnalysisFacilityDict_220_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 5:
...
static int G__BCMTFAnalysisFacilityDict_220_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<TH1D>* pobj;
...
static int G__BCMTFAnalysisFacilityDict_220_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFAnalysisFacilityDict_220_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFAnalysisFacilityDict_220_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BCMTFAnalysisFacilityDict_220_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 3:
...
static int G__BCMTFAnalysisFacilityDict_220_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         vector<TH1D>* pobj;
...
static int G__BCMTFAnalysisFacilityDict_220_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__BCMTFAnalysisFacilityDict_220_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__BCMTFAnalysisFacilityDict_220_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memfuncBCMTFAnalysisFacility(void) {
   ...
   G__memfunc_setup("BCMTFAnalysisFacility",2021,G__BCMTFAnalysisFacilityDict_220_0_1, 105, G__get_linked_tagnum(&G__BCMTFAnalysisFacilityDictLN_BCMTFAnalysisFacility), -1, 0, 1, 1, 1, 0, "U 'BCMTF' - 0 - mtf", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetBCMTF",652,G__BCMTFAnalysisFacilityDict_220_0_2, 85, G__get_linked_tagnum(&G__BCMTFAnalysisFacilityDictLN_BCMTF), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetBCMTF",664,G__BCMTFAnalysisFacilityDict_220_0_3, 121, -1, -1, 0, 1, 1, 1, 0, "U 'BCMTF' - 0 - mtf", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetFlagMCMC",966,G__BCMTFAnalysisFacilityDict_220_0_4, 121, -1, -1, 0, 1, 1, 1, 0, "g - - 0 - flag", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetLogLevel",1082,G__BCMTFAnalysisFacilityDict_220_0_5, 105, G__get_linked_tagnum(&G__BCMTFAnalysisFacilityDictLN_BCLogcLcLLogLevel), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetLogLevel",1094,G__BCMTFAnalysisFacilityDict_220_0_6, 121, -1, -1, 0, 1, 1, 1, 0, "i 'BCLog::LogLevel' - 0 - level", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PerformSingleChannelAnalyses",2870,G__BCMTFAnalysisFacilityDict_220_0_7, 105, -1, -1, 0, 2, 1, 1, 0, 
"C - - 10 - dirname C - - 10 '\"\"' options", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PerformSingleSystematicAnalyses",3235,G__BCMTFAnalysisFacilityDict_220_0_8, 105, -1, -1, 0, 2, 1, 1, 0, 
"C - - 10 - dirname C - - 10 '\"\"' options", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PerformCalibrationAnalysis",2695,G__BCMTFAnalysisFacilityDict_220_0_9, 105, -1, -1, 0, 5, 1, 1, 0, 
...
"i - - 0 '1000' nensembles", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("BuildEnsemble",1307,G__BCMTFAnalysisFacilityDict_220_0_10, 117, G__get_linked_tagnum(&G__BCMTFAnalysisFacilityDictLN_vectorlETH1DcOallocatorlETH1DgRsPgR), G__defined_typename("vector<TH1D>"), 0, 1, 1, 1, 0, "u 'vector<double,allocator<double> >' 'vector<double>' 11 - parameters", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("BuildEnsembles",1422,G__BCMTFAnalysisFacilityDict_220_0_11, 85, G__get_linked_tagnum(&G__BCMTFAnalysisFacilityDictLN_TTree), -1, 0, 2, 1, 1, 0, 
"u 'vector<double,allocator<double> >' 'vector<double>' 11 - parameters i - - 0 - nensembles", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("BuildEnsembles",1422,G__BCMTFAnalysisFacilityDict_220_0_12, 85, G__get_linked_tagnum(&G__BCMTFAnalysisFacilityDictLN_TTree), -1, 0, 2, 1, 1, 0, 
"U 'TTree' - 0 - tree i - - 0 - nensembles", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PerformEnsembleTest",1958,G__BCMTFAnalysisFacilityDict_220_0_13, 85, G__get_linked_tagnum(&G__BCMTFAnalysisFacilityDictLN_TTree), -1, 0, 2, 1, 1, 0, 
"u 'vector<double,allocator<double> >' 'vector<double>' 11 - parameters i - - 0 - nensembles", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PerformEnsembleTest",1958,G__BCMTFAnalysisFacilityDict_220_0_14, 85, G__get_linked_tagnum(&G__BCMTFAnalysisFacilityDictLN_TTree), -1, 0, 3, 1, 1, 0, 
"U 'TTree' - 0 - tree i - - 0 - nensembles "
"i - - 0 '0' start", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("MatrixToHistograms",1881,G__BCMTFAnalysisFacilityDict_220_0_15, 117, G__get_linked_tagnum(&G__BCMTFAnalysisFacilityDictLN_vectorlETH1DcOallocatorlETH1DgRsPgR), G__defined_typename("vector<TH1D>"), 0, 1, 1, 1, 0, "u 'vector<vector<double,allocator<double> >,allocator<vector<double,allocator<double> > > >' 'vector<std::vector<double> >' 11 - matrix", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("BCMTFAnalysisFacility", 2021, G__BCMTFAnalysisFacilityDict_220_0_16, (int) ('i'), 
G__get_linked_tagnum(&G__BCMTFAnalysisFacilityDictLN_BCMTFAnalysisFacility), -1, 0, 1, 1, 1, 0, "u 'BCMTFAnalysisFacility' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~BCMTFAnalysisFacility", 2147, G__BCMTFAnalysisFacilityDict_220_0_17, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__BCMTFAnalysisFacilityDict_220_0_18, (int) ('u'), G__get_linked_tagnum(&G__BCMTFAnalysisFacilityDictLN_BCMTFAnalysisFacility), -1, 1, 1, 1, 1, 0, "u 'BCMTFAnalysisFacility' - 11 - -", (char*) NULL, (void*) NULL, 0);
