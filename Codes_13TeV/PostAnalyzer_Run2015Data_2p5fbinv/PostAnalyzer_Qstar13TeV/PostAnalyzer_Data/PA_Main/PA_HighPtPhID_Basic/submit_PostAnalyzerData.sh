...
PostAna_Dir_final=${PostAna_Dir}/Qstar13TeV_HighPtPhID_Basic
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   //  cout << "Analyzing entry:" << jentry << endl;
      ...
      HighPtPhotons.clear();
      HighPtPhotons = HighPtIDPhotons();

      HighPtBarrelPhotons.clear();
      if(HighPtPhotons.size() != 0){
	for(Int_t ip = 0; ip <  HighPtPhotons.size(); ip++){
	  if( (*phoEt)[HighPtPhotons[ip]] > Cut_Photon_pt && fabs((*phoSCEta)[HighPtPhotons[ip]]) <= Cut_Photon_eta){
	  HighPtBarrelPhotons.push_back(HighPtPhotons[ip]);
	  }
	}
      }

      if(HighPtBarrelPhotons.size() != 0) PC = HighPtBarrelPhotons[0];
      ...
      h_nPhotons[0]   ->Fill(HighPtPhotons.size());
		...
		if(JC > -1){
		  ...
		  if(Pass_JetPt){
			...
			if(Pass_GJdEta){
			  ...
			  h_nPhotons[1]              ->Fill(HighPtPhotons.size());
			  ...
			  if(Pass_GJInvtMass && IfMassCut){
			    ...
			    if( InvtMass > htmass ){			   
			      ...
			      cout << "InvtMass of Photon and Jet = " << InvtMass << " GeV/c2" << endl;
			      cout << "Photon Pt = " << htPhoPt << " GeV/c" << endl;
			      cout << "Jet Pt = " << htJetPt << " GeV/c" << endl;
			      cout << "Photon Eta = " << htPhoEta << " GeV/c" << endl;
			      cout << "Jet Eta = " << htJetEta << " GeV/c" << endl;
			      cout << "Photon Phi = " << htPhoPhi << " GeV/c" << endl;
			      cout << "Jet Phi = " << htJetPhi << " GeV/c" << endl;
			      cout << "Run Number = " << RunNo << endl;
			      cout << "Event Number = " << EvtNo << endl;
			      cout << "Lumi Number = " << LumiNo << endl;
			      cout << "********************************************************************************" << endl;
			    ...
			    h_nPhotons[2]              ->Fill(HighPtPhotons.size());
...
public :
   ...
   vector<Int_t> HighPtPhotons;
   vector<Int_t> HighPtBarrelPhotons;
