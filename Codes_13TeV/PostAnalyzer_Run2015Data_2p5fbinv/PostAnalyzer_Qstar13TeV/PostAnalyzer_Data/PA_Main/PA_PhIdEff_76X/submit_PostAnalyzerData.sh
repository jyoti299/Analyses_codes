...
DatanTuplesDir=root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data_76X

sourceDir=${DatanTuplesDir}/
...
public :
   ...
   TH1F *h_PassLooserInvtMass_EB;
   TH1F *h_PassLooserInvtMass_EE;
...
/*      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data_76X/ggNtuples_25ns_data_1593.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data_76X/ggNtuples_25ns_data_1625.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data_76X/ggNtuples_25ns_data_1603.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data_76X/ggNtuples_25ns_data_1620.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data_76X/ggNtuples_25ns_data_1616.root/ggNtuplizer/EventTree");
      chain->Add("root://cmseos.fnal.gov//eos/uscms/store/user/leptonjets/varun/13TeV/Ntuples/Data_76X/ggNtuples_25ns_data_162.root/ggNtuplizer/EventTree");
*/
...
void PostAnalyzer_Data::BookHistograms(){
  file->cd();
    ...
    h_PassLooserInvtMass_EB =  new TH1F("h_PassLooserInvtMass_EB", "Invt mass of photon+jet passing Looser Id in EB", nMassBins, MassBin);
    h_PassLooserInvtMass_EB->GetYaxis()->SetTitle("Events/VarBin");    h_PassLooserInvtMass_EB->GetYaxis()->CenterTitle();
    h_PassLooserInvtMass_EB->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassLooserInvtMass_EB->GetXaxis()->CenterTitle();
    h_PassLooserInvtMass_EB->Sumw2();     

    h_PassLooserInvtMass_EE =  new TH1F("h_PassLooserInvtMass_EE", "Invt mass of photon+jet passing Looser Id in EE", nMassBins, MassBin);
    h_PassLooserInvtMass_EE->GetYaxis()->SetTitle("Events/VarBin");    h_PassLooserInvtMass_EE->GetYaxis()->CenterTitle();
    h_PassLooserInvtMass_EE->GetXaxis()->SetTitle("Invt Mass M_{#gamma jet} (GeV)");  h_PassLooserInvtMass_EE->GetXaxis()->CenterTitle();
    h_PassLooserInvtMass_EE->Sumw2();     
