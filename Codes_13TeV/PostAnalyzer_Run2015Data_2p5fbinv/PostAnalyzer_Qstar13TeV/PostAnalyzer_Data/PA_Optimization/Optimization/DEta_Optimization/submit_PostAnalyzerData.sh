...
DatanTuplesDir=root://cmseos.fnal.gov//store/user/leptonjets/varun/13TeV/Ntuples/Data
	  ...
	  if(GoodIsoPhotons.size() > 0){
		...
		if(Pass_JetPt){
		  ...
		  if(Pass_JetEta){
			...
			h_GJetInvtMass_bin40_deta1p0[0]    ->Fill(GetInvtMass(PC, JC));
			h_GJetInvtMass_VarBin_deta1p0[0]   ->Fill(GetInvtMass(PC, JC));
			h_GJetInvtMass_UnitBin_deta1p0[0]  ->Fill(GetInvtMass(PC, JC));

			if(Pass_GJInvtMass){
			  h_CutFlow->Fill(10.5);

			  h_GJetInvtMass_bin40_deta1p0[1]    ->Fill(GetInvtMass(PC, JC));
			  h_GJetInvtMass_VarBin_deta1p0[1]   ->Fill(GetInvtMass(PC, JC));
			  h_GJetInvtMass_UnitBin_deta1p0[1]  ->Fill(GetInvtMass(PC, JC));
			...
			h_GJetInvtMass_bin40_deta1p2[0]    ->Fill(GetInvtMass(PC, JC));
			h_GJetInvtMass_VarBin_deta1p2[0]   ->Fill(GetInvtMass(PC, JC));
			h_GJetInvtMass_UnitBin_deta1p2[0]  ->Fill(GetInvtMass(PC, JC));

			if(Pass_GJInvtMass){
			  h_CutFlow->Fill(12.5);

			  h_GJetInvtMass_bin40_deta1p2[1]    ->Fill(GetInvtMass(PC, JC));
			  h_GJetInvtMass_VarBin_deta1p2[1]   ->Fill(GetInvtMass(PC, JC));
			  h_GJetInvtMass_UnitBin_deta1p2[1]  ->Fill(GetInvtMass(PC, JC));
			...
			h_GJetInvtMass_bin40_deta1p5[0]    ->Fill(GetInvtMass(PC, JC));
			h_GJetInvtMass_VarBin_deta1p5[0]   ->Fill(GetInvtMass(PC, JC));
			h_GJetInvtMass_UnitBin_deta1p5[0]  ->Fill(GetInvtMass(PC, JC));

			if(Pass_GJInvtMass){
			  h_CutFlow->Fill(14.5);

			  h_GJetInvtMass_bin40_deta1p5[1]    ->Fill(GetInvtMass(PC, JC));
			  h_GJetInvtMass_VarBin_deta1p5[1]   ->Fill(GetInvtMass(PC, JC));
			  h_GJetInvtMass_UnitBin_deta1p5[1]  ->Fill(GetInvtMass(PC, JC));
			...
			h_GJetInvtMass_bin40_deta2p0[0]    ->Fill(GetInvtMass(PC, JC));
			h_GJetInvtMass_VarBin_deta2p0[0]   ->Fill(GetInvtMass(PC, JC));
			h_GJetInvtMass_UnitBin_deta2p0[0]  ->Fill(GetInvtMass(PC, JC));

			if(Pass_GJInvtMass){
			  h_CutFlow->Fill(16.5);

			  h_GJetInvtMass_bin40_deta2p0[1]    ->Fill(GetInvtMass(PC, JC));
			  h_GJetInvtMass_VarBin_deta2p0[1]   ->Fill(GetInvtMass(PC, JC));
			  h_GJetInvtMass_UnitBin_deta2p0[1]  ->Fill(GetInvtMass(PC, JC));
			...
			h_GJetInvtMass_bin40_deta2p2[0]    ->Fill(GetInvtMass(PC, JC));
			h_GJetInvtMass_VarBin_deta2p2[0]   ->Fill(GetInvtMass(PC, JC));
			h_GJetInvtMass_UnitBin_deta2p2[0]  ->Fill(GetInvtMass(PC, JC));

			if(Pass_GJInvtMass){
			  h_CutFlow->Fill(18.5);

			  h_GJetInvtMass_bin40_deta2p2[1]    ->Fill(GetInvtMass(PC, JC));
			  h_GJetInvtMass_VarBin_deta2p2[1]   ->Fill(GetInvtMass(PC, JC));
			  h_GJetInvtMass_UnitBin_deta2p2[1]  ->Fill(GetInvtMass(PC, JC));
