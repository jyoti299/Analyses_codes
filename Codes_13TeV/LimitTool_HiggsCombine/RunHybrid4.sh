...
for (( MASS=2000; MASS<=2900; MASS+=200 )); do
#for (( MASS=4500; MASS<=4500; MASS+=100 )); do
    ...
    combine -M HybridNew --testStat LHC --frequentist -d ${DataCarddir}/ExcitedQuarks_combine_${model}_${mass}_lumi-${lumi}_${boxName}.txt -T 10000 -n ${model}_${mass}_lumi-${lumi}_${boxName} -H Asymptotic --fullBToys --fork 4
