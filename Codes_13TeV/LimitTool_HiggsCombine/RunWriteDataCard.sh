...
Datafile=inputs/GOF_check.root
...
python python/WriteDataCard.py -c ${config} -d ${outdir} -l 35866 -b ${boxName} -i ${inFitFile} -m ${model} --mass 1000 --xsec 0.01 ${Sigfile} ${Datafile}
