...
//=========  (Wed Mar 29 05:29:48 2017) by ROOT version6.02/05
...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(2,"Ntot_bkg_ExcitedQuarks2016");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"pF21_ExcitedQuarks2016");
