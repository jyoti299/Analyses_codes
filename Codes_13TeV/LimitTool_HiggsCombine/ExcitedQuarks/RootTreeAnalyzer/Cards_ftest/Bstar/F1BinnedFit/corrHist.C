...
//=========  (Sat Apr 15 14:32:17 2017) by ROOT version6.02/05
   ...
   correlation_matrix->SetBinContent(8,0.9615532);
   correlation_matrix->SetBinContent(9,0.9968574);
   correlation_matrix->SetBinContent(10,1);
   correlation_matrix->SetBinContent(14,0.9798843);
   correlation_matrix->SetBinContent(15,1);
   correlation_matrix->SetBinContent(16,0.9968574);
   correlation_matrix->SetBinContent(20,1);
   correlation_matrix->SetBinContent(21,0.9798843);
   correlation_matrix->SetBinContent(22,0.9615532);
   correlation_matrix->SetBinContent(25,1);
   correlation_matrix->SetBinError(8,0.9615532);
   correlation_matrix->SetBinError(9,0.9968574);
   correlation_matrix->SetBinError(10,1);
   correlation_matrix->SetBinError(14,0.9798843);
   correlation_matrix->SetBinError(15,1);
   correlation_matrix->SetBinError(16,0.9968574);
   correlation_matrix->SetBinError(20,1);
   correlation_matrix->SetBinError(21,0.9798843);
   correlation_matrix->SetBinError(22,0.9615532);
...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetXaxis()->SetBinLabel(1,"Ntot_bkg_Excited1btagQuarks2016");
   correlation_matrix->GetXaxis()->SetBinLabel(2,"pF11_Excited1btagQuarks2016");
   correlation_matrix->GetXaxis()->SetBinLabel(3,"pF12_Excited1btagQuarks2016");
   correlation_matrix->GetXaxis()->SetBinLabel(4,"pF13_Excited1btagQuarks2016");
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(4,"Ntot_bkg_Excited1btagQuarks2016");
   correlation_matrix->GetYaxis()->SetBinLabel(3,"pF11_Excited1btagQuarks2016");
   correlation_matrix->GetYaxis()->SetBinLabel(2,"pF12_Excited1btagQuarks2016");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"pF13_Excited1btagQuarks2016");
