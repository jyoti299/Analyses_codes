...
//=========  (Fri Apr 14 12:04:18 2017) by ROOT version6.02/05
   TCanvas *c = new TCanvas("c", "c",0,0,500,500);
   gStyle->SetOptStat(0);
   c->SetHighLightColor(2);
   c->Range(-0.2666667,-0.25,2.4,2.25);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH2D *correlation_matrix = new TH2D("correlation_matrix","correlation_matrix",2,0,2,2,0,2);
   correlation_matrix->SetBinContent(6,1);
   correlation_matrix->SetBinContent(9,1);
   correlation_matrix->SetBinError(6,1);
   correlation_matrix->SetBinError(9,1);
   correlation_matrix->SetMinimum(-1);
   correlation_matrix->SetMaximum(1);
   correlation_matrix->SetEntries(4);
   ...
   TPaletteAxis *palette = new TPaletteAxis(2.013333,0,2.133333,2,correlation_matrix);
...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(2,"Ntot_bkg_Excited1btagQuarks2016");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"pF21_Excited1btagQuarks2016");
