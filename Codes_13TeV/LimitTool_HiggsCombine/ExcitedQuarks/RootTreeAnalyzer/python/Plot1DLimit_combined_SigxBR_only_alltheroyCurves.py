...
#    xsecFiles = ['data/Qstar_f1p0_xsec.txt', 'data/Qstar_f0p5_xsec.txt', 'data/Qstar_f0p1_xsec.txt', 'data/Bstar_f1p0_xsec.txt', 'data/Bstar_f0p5_xsec.txt', 'data/Bstar_f0p1_xsec.txt']
    xsecFiles = ['data/Bstar_f1p0_xsec.txt', 'data/Bstar_f0p5_xsec.txt', 'data/Bstar_f0p1_xsec.txt']
...
def getThyEffDict():    
    thyEffDict = {}
#    effFiles = ['data/Qstar_f0p1_eff.txt']
    effFiles = ['data/Bstar_f1p0_eff.txt']
    print effFiles
...
#        elif options.SigCoup=='f0p1':
 ...
 #           thyModelsToDraw = ['Bstar_f0p1']
    ...
    lineColor = {'Qstar_f1p0':rt.kRed+1,
                 ...
                 'Bstar_f0p5':rt.kMagenta+2,
                 'Bstar_f0p1':rt.kCyan+2,
                 'None':1
                 }
    ...
    if options.doSignificance:
        ...
        leg = rt.TLegend(0.21,0.17,0.6,0.49)
...
#            leg.AddEntry(xsec_gr_nom[thyModel], legendLabel[thyModel],'l')
            leg.AddEntry(xsec_gr_nom['Bstar_f1p0'], legendLabel['Bstar_f1p0'],'l')
            leg.AddEntry(xsec_gr_nom['Bstar_f0p5'], legendLabel['Bstar_f0p5'],'l')
            leg.AddEntry(xsec_gr_nom['Bstar_f0p1'], legendLabel['Bstar_f0p1'],'l')
    else:
        #leg.AddEntry(None,"95% CL limits","")
        #leg.AddEntry(None,"90% CL limits","")
        for model in models:
