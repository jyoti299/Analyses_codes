...
if __name__ == '__main__':
   ...
   # parser.add_option('-d','--dir',dest="outDir",default="./",type="string",
    ...
    thyModelsToDraw = []
    if options.Optitype=='DEta_Opti':
        thyModelsToDraw = ['Qstar_f1p0_DEta_1.0', 'Qstar_f1p0_DEta_1.2', 'Qstar_f1p0_DEta_1.5', 'Qstar_f1p0_DEta_1.8', 'Qstar_f1p0_DEta_2.0', 'Qstar_f1p0_DEta_2.2', 'Qstar_f1p0_DEta_2.5', 'Qstar_f1p0_NoDEta']
    if options.Optitype=='DPhi_Opti':
        thyModelsToDraw = ['Qstar_f1p0_DPhi_1.5', 'Qstar_f1p0_DPhi_2.0', 'Qstar_f1p0_DPhi_2.5', 'Qstar_f1p0_NoDPhi']
    if options.Optitype=='PhId_Opti':
        thyModelsToDraw = ['Qstar_f1p0_PhId_Loose', 'Qstar_f1p0_PhId_Medium', 'Qstar_f1p0_PhId_Tight']
    if options.Optitype=='JetId_Opti':
        thyModelsToDraw = ['Qstar_f1p0_JetId_Tight', 'Qstar_f1p0_JetId_TightLepVeto']
    if options.Optitype=='CSVDisc_Opti':
        thyModelsToDraw = ['Bstar_f1p0_CSVL', 'Bstar_f1p0_CSVM', 'Bstar_f1p0_CSVT']

    lineStyle = {'Qstar_f1p0_DEta_1.0':2,
                 'Qstar_f1p0_DEta_1.2':3,
                 'Qstar_f1p0_DEta_1.5':4,
                 'Qstar_f1p0_DEta_1.8':5, 
                 'Qstar_f1p0_DEta_2.0':6,
                 'Qstar_f1p0_DEta_2.2':7,
                 'Qstar_f1p0_DEta_2.5':8, 
                 'Qstar_f1p0_NoDEta'  :9,
                 'Qstar_f1p0_DPhi_1.5':2,
                 'Qstar_f1p0_DPhi_2.0':4,
                 'Qstar_f1p0_DPhi_2.5':7,
                 'Qstar_f1p0_NoDPhi'  :9,
                 'Qstar_f1p0_PhId_Loose':2,
                 'Qstar_f1p0_PhId_Medium':4,
                 'Qstar_f1p0_PhId_Tight':7,
                 'Qstar_f1p0_JetId_Tight':2,
                 'Qstar_f1p0_JetId_TightLepVeto':4,
                 'Bstar_f1p0_CSVL':2,
                 'Bstar_f1p0_CSVM':4,
                 'Bstar_f1p0_CSVT':7,
                 'None':1               
    ...
    lineColor = {'Qstar_f1p0_DEta_1.0':rt.kRed+1,
                 'Qstar_f1p0_DEta_1.2':rt.kMagenta,
                 'Qstar_f1p0_DEta_1.5':rt.kGray+2,
                 'Qstar_f1p0_DEta_1.8':rt.kBlue+1,
                 'Qstar_f1p0_DEta_2.0':rt.kOrange+2,
                 'Qstar_f1p0_DEta_2.2':rt.kGreen+1,
                 'Qstar_f1p0_DEta_2.5':rt.kBlue+3,
                 'Qstar_f1p0_NoDEta'  :rt.kYellow+3,
                 'Qstar_f1p0_DPhi_1.5':rt.kRed+1,
                 'Qstar_f1p0_DPhi_2.0':rt.kBlue+1,
                 'Qstar_f1p0_DPhi_2.5':rt.kGreen+1,
                 'Qstar_f1p0_NoDPhi'  :rt.kMagenta,
                 'Qstar_f1p0_PhId_Loose':rt.kMagenta,
                 'Qstar_f1p0_PhId_Medium':rt.kBlue+1,
                 'Qstar_f1p0_PhId_Tight':rt.kGreen+1,
                 'Qstar_f1p0_JetId_Tight':rt.kRed+1,
                 'Qstar_f1p0_JetId_TightLepVeto':rt.kBlue+1,
                 'Bstar_f1p0_CSVL':rt.kRed+1,
                 'Bstar_f1p0_CSVM':rt.kBlue+1,
                 'Bstar_f1p0_CSVT':rt.kGreen+1,                 
                 'None':1
                 }


    markerColor = {'Qstar_f1p0_DEta_1.0':rt.kRed+1,
                 'Qstar_f1p0_DEta_1.2':rt.kMagenta,
                 'Qstar_f1p0_DEta_1.5':rt.kGray+2,
                 'Qstar_f1p0_DEta_1.8':rt.kBlue+1,
                 'Qstar_f1p0_DEta_2.0':rt.kOrange+2,
    ...
    markerStyle = {'Qstar_f1p0_DEta_1.0':20,
                 'Qstar_f1p0_DEta_1.2':21,
                 'Qstar_f1p0_DEta_1.5':24,
                 'Qstar_f1p0_DEta_1.8':22,
                 'Qstar_f1p0_DEta_2.0':25,
                 'Qstar_f1p0_DEta_2.2':29,
                 'Qstar_f1p0_DEta_2.5':26,
                 'Qstar_f1p0_NoDEta'  :30,
                 'Qstar_f1p0_DPhi_1.5':20,
                 'Qstar_f1p0_DPhi_2.0':21,
                 'Qstar_f1p0_DPhi_2.5':24,
                 'Qstar_f1p0_NoDPhi'  :25,
                 'Qstar_f1p0_PhId_Loose':20,
                 'Qstar_f1p0_PhId_Medium':21,
                 'Qstar_f1p0_PhId_Tight':29,
                 'Qstar_f1p0_JetId_Tight':20,
                 'Qstar_f1p0_JetId_TightLepVeto':24,
                 'Bstar_f1p0_CSVL':24,
                 'Bstar_f1p0_CSVM':25,
                 'Bstar_f1p0_CSVT':29
                 }
        
    legendLabel = {'Qstar_f1p0_DEta_1.0':'#Delta #eta < 1.0',
                 'Qstar_f1p0_DEta_1.2':'#Delta #eta < 1.2',
                 'Qstar_f1p0_DEta_1.5':'#Delta #eta < 1.5',
                 'Qstar_f1p0_DEta_1.8':'#Delta #eta < 1.8',
                 'Qstar_f1p0_DEta_2.0':'#Delta #eta < 2.0',
                 'Qstar_f1p0_DEta_2.2':'#Delta #eta < 2.2',
                 'Qstar_f1p0_DEta_2.5':'#Delta #eta < 2.5',
                 'Qstar_f1p0_NoDEta'  :'No #Delta #eta',
                 'Qstar_f1p0_DPhi_1.5':'#Delta #phi > 1.5',
                 'Qstar_f1p0_DPhi_2.0':'#Delta #phi > 2.0',
                 'Qstar_f1p0_DPhi_2.5':'#Delta #phi > 2.5',
                 'Qstar_f1p0_NoDPhi'  :'No #Delta #phi',
                 'Qstar_f1p0_PhId_Loose':'Photon LID',
                 'Qstar_f1p0_PhId_Medium':'Photon MID',
                 'Qstar_f1p0_PhId_Tight':'Photon TID',
                 'Qstar_f1p0_JetId_Tight':'Jet TID',
                 'Qstar_f1p0_JetId_TightLepVeto':'Jet TLV ID',
                 'Bstar_f1p0_CSVL':'CSVL',
                 'Bstar_f1p0_CSVM':'CSVM',
                 'Bstar_f1p0_CSVT':'CSVT'                 
                 }

#    Directory = {'Qstar_f1p0_DEta_1.0':'Cards_Optimization/DEta_Opti/DEta_1.0/',
#                 'Qstar_f1p0_DEta_1.2':'Cards_Optimization/DEta_Opti/DEta_1.2/',
#                 'Qstar_f1p0_DEta_1.5':'Cards_Optimization/DEta_Opti/DEta_1.5/',
#                 'Qstar_f1p0_DEta_1.8':'Cards_Optimization/DEta_Opti/DEta_1.8/',
#                 'Qstar_f1p0_DEta_2.0':'Cards_Optimization/DEta_Opti/DEta_2.0/',
#                 'Qstar_f1p0_DEta_2.2':'Cards_Optimization/DEta_Opti/DEta_2.2/',
#                 'Qstar_f1p0_DEta_2.5':'Cards_Optimization/DEta_Opti/DEta_2.5/',
#                 'Qstar_f1p0_NoDEta'  :'Cards_Optimization/DEta_Opti/NoDEta/',
#                 'Qstar_f1p0_DPhi_1.5':'Cards_Optimization/DPhi_Opti/DPhi_1.5/',
 #                'Qstar_f1p0_DPhi_2.0':'Cards_Optimization/DPhi_Opti/DPhi_2.0/',
 #                'Qstar_f1p0_DPhi_2.5':'Cards_Optimization/DPhi_Opti/DPhi_2.5/',
 #                'Qstar_f1p0_NoDPhi'  :'Cards_Optimization/DPhi_Opti/NoDPhi/',
 #                'Qstar_f1p0_PhId_Loose':'Cards_Optimization/PhId_Opti/PhId_Loose/',
 #                'Qstar_f1p0_PhId_Medium':'Cards_Optimization/PhId_Opti/PhId_Medium/',
 #                'Qstar_f1p0_PhId_Tight':'Cards_Optimization/PhId_Opti/PhId_Tight/',
 #                'Qstar_f1p0_JetId_Tight':'Cards_Optimization/JetId_Opti/JetId_Tight/',
 #                'Qstar_f1p0_JetId_TightLepVeto':'Cards_Optimization/JetId_Opti/JetId_TightLepVeto/',
 #                'Bstar_f1p0_CSVL':'Cards_Optimization/CSVDisc_Opti/CSVL',
 #                'Bstar_f1p0_CSVM':'Cards_Optimization/CSVDisc_Opti/CSVM',
 #                'Bstar_f1p0_CSVT':'Cards_Optimization/CSVDisc_Opti/CSVT',
 #                }

    Directory = {'Qstar_f1p0_DEta_1.0':'Cards_Optimization/Opti_usingReReco/DEta_Opti/DEta_1.0/',
                 'Qstar_f1p0_DEta_1.2':'Cards_Optimization/Opti_usingReReco/DEta_Opti/DEta_1.2/',
                 'Qstar_f1p0_DEta_1.5':'Cards_Optimization/Opti_usingReReco/DEta_Opti/DEta_1.5/',
                 'Qstar_f1p0_DEta_1.8':'Cards_Optimization/Opti_usingReReco/DEta_Opti/DEta_1.8/',
                 'Qstar_f1p0_DEta_2.0':'Cards_Optimization/Opti_usingReReco/DEta_Opti/DEta_2.0/',
                 'Qstar_f1p0_DEta_2.2':'Cards_Optimization/Opti_usingReReco/DEta_Opti/DEta_2.2/',
                 'Qstar_f1p0_DEta_2.5':'Cards_Optimization/Opti_usingReReco/DEta_Opti/DEta_2.5/',
                 'Qstar_f1p0_NoDEta'  :'Cards_Optimization/Opti_usingReReco/DEta_Opti/NoDEta/',
                 'Qstar_f1p0_DPhi_1.5':'Cards_Optimization/DPhi_Opti/DPhi_1.5/',
                 'Qstar_f1p0_DPhi_2.0':'Cards_Optimization/DPhi_Opti/DPhi_2.0/',
                 'Qstar_f1p0_DPhi_2.5':'Cards_Optimization/DPhi_Opti/DPhi_2.5/',
                 'Qstar_f1p0_NoDPhi'  :'Cards_Optimization/DPhi_Opti/NoDPhi/',
    ...
    if options.doSignificance:
        ...
        if options.bayes:
            ...
            if options.noSys:
                ...
                c.SaveAs("Cards_Optimization/Opti_usingReReco/"+options.Optitype+"/Explimits_Optimization_freq_"+options.Optitype+"_"+options.model+"_"+options.box.lower()+".pdf")
                c.SaveAs("Cards_Optimization/Opti_usingReReco/"+options.Optitype+"/Explimits_Optimization_freq_"+options.Optitype+"_"+options.model+"_"+options.box.lower()+".png")
                c.SaveAs("Cards_Optimization/Opti_usingReReco/"+options.Optitype+"/Explimits_Optimization_freq_"+options.Optitype+"_"+options.model+"_"+options.box.lower()+".root")
