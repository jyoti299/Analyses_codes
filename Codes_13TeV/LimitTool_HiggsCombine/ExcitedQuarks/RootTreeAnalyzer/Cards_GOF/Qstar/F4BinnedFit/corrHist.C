...
//=========  (Mon Feb  6 11:57:17 2017) by ROOT version6.02/05
   ...
   correlation_matrix->SetBinContent(7,1.229554e-07);
   correlation_matrix->SetBinContent(8,1);
   correlation_matrix->SetBinContent(12,1);
   correlation_matrix->SetBinContent(13,1.229554e-07);
   correlation_matrix->SetBinContent(16,1);
   correlation_matrix->SetBinError(7,1.229554e-07);
   correlation_matrix->SetBinError(8,1);
   correlation_matrix->SetBinError(12,1);
   correlation_matrix->SetBinError(13,1.229554e-07);
...
palette->SetTitleSize(0.035);
   ...
   correlation_matrix->GetXaxis()->SetBinLabel(2,"pF41_ExcitedQuarks2016");
   correlation_matrix->GetXaxis()->SetBinLabel(3,"pF42_ExcitedQuarks2016");
   ...
   correlation_matrix->GetYaxis()->SetBinLabel(3,"Ntot_bkg_ExcitedQuarks2016");
   correlation_matrix->GetYaxis()->SetBinLabel(2,"pF41_ExcitedQuarks2016");
   correlation_matrix->GetYaxis()->SetBinLabel(1,"pF42_ExcitedQuarks2016");
