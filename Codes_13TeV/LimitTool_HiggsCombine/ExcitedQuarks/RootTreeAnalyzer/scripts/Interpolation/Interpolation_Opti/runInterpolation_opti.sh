...
Model=Bstar ##Qstar   ##TO_CHANGE

InPath=/uscms_data/d3/rocky86/13TeV/HiggsCombineTool/HiggsCombine_fromdijet/CMSSW_7_4_14/src/ExcitedQuarks/RootTreeAnalyzer/PostAna_Results/PA_Results_2015+2016/80X/Optimization/
OutPath=/uscms_data/d3/rocky86/13TeV/HiggsCombineTool/HiggsCombine_fromdijet/CMSSW_7_4_14/src/ExcitedQuarks/RootTreeAnalyzer/inputs/Optimization_80X/

Opti=CSVDisc_Opti  ##DEta_Opti  ##DPhi_Opti  ##PhId_Opti  ##JetId_Opti  ##CSVDisc_Opti  ##TO_CGANGE

#for cut in  DEta_1.0  DEta_1.2  DEta_1.5  DEta_1.8  DEta_2.0  DEta_2.2  DEta_2.5  NoDEta  ##TO_CHANGE
...
echo "RUNNING FOR ${cut}"

InSigDir=${InPath}/${Opti}/${cut}/MC/Signal_${Model}/ 

outputDir=${OutPath}/${Opti}/${cut}/
...
OutFileName=ResonanceShapes_${Model}_${coupling}_${tag}_13TeV_80X_Spring16_${cut} 
...
void Interpolation::runInterpolation(){
  ...
  //Input X histoname
  TString Mass_X = "h_mass_X_bin1_1bTag"; //TO_CHANGE
...
echo "INTERPOLATION DONE for ${coupling} and ${cut}"
