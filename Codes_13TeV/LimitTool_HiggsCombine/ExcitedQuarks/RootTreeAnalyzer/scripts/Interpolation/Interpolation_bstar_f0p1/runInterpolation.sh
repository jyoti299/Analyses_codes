...
pwd=/uscms_data/d3/rocky86/13TeV/HiggsCombineTool/HiggsCombine_fromdijet/CMSSW_7_4_14/src/ExcitedQuarks/RootTreeAnalyzer/scripts/Interpolation/
...
InSigDir=${Model}_80X_ResShapes_latestSyst_full2016lumi/ ##TO_CHANGE

#for coupling in f1p0 f0p5 f0p1
for coupling in f-0p1  #f-0p1
do

for syst in  nominal JESUP JESDOWN JER PESUP PESDOWN PER BSFUP BSFDOWN
do
...
outputDir=${pwd}/InterpolatedFiles/80X/${coupling}/
...
if [ "${syst}" = "nominal" ]; then
    OutFileName=ResonanceShapes_${Model}_${tag}_${coupling}_13TeV_PhLID-JetTID-Pt190-nodeta-nodphi-CSVM_mass695_80X_Spring16
    mass_X=h_mass_X_bin1
elif [ "${syst}" = "JESUP" ]; then
    OutFileName=ResonanceShapes_${Model}_${tag}_${coupling}_13TeV_PhLID-JetTID-Pt190-nodeta-nodphi-CSVM_mass695_80X_Spring16_${syst}
    mass_X=h_mass_X_bin1_JES_up
elif [ "${syst}" = "JESDOWN" ]; then
    OutFileName=ResonanceShapes_${Model}_${tag}_${coupling}_13TeV_PhLID-JetTID-Pt190-nodeta-nodphi-CSVM_mass695_80X_Spring16_${syst}
    mass_X=h_mass_X_bin1_JES_down
elif [ "${syst}" = "JER" ]; then
    OutFileName=ResonanceShapes_${Model}_${tag}_${coupling}_13TeV_PhLID-JetTID-Pt190-nodeta-nodphi-CSVM_mass695_80X_Spring16_${syst}
    mass_X=h_mass_X_bin1_JER
elif [ "${syst}" = "PESUP" ]; then
    OutFileName=ResonanceShapes_${Model}_${tag}_${coupling}_13TeV_PhLID-JetTID-Pt190-nodeta-nodphi-CSVM_mass695_80X_Spring16_${syst}
    mass_X=h_mass_X_bin1_PES_up
elif [ "${syst}" = "PESDOWN" ]; then
    OutFileName=ResonanceShapes_${Model}_${tag}_${coupling}_13TeV_PhLID-JetTID-Pt190-nodeta-nodphi-CSVM_mass695_80X_Spring16_${syst}
    mass_X=h_mass_X_bin1_PES_down
elif [ "${syst}" = "PER" ]; then
    OutFileName=ResonanceShapes_${Model}_${tag}_${coupling}_13TeV_PhLID-JetTID-Pt190-nodeta-nodphi-CSVM_mass695_80X_Spring16_${syst}
    mass_X=h_mass_X_bin1_PER
elif [ "${syst}" = "BSFUP" ]; then
    OutFileName=ResonanceShapes_${Model}_${tag}_${coupling}_13TeV_PhLID-JetTID-Pt190-nodeta-nodphi-CSVM_mass695_80X_Spring16_${syst}
    mass_X=h_mass_X_bin1_BSF_${tag}_up
elif [ "${syst}" = "BSFDOWN" ]; then
    OutFileName=ResonanceShapes_${Model}_${tag}_${coupling}_13TeV_PhLID-JetTID-Pt190-nodeta-nodphi-CSVM_mass695_80X_Spring16_${syst}
    mass_X=h_mass_X_bin1_BSF_${tag}_down
fi
...
void Interpolation::runInterpolation(){
  ...
  //Input X histoname
  TString Mass_X = "${mass_X}"; //TO_CHANGE
