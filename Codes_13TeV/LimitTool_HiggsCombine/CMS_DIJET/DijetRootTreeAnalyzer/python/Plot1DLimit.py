...
def setstyle():
    ...
    rt.gStyle.SetTitleFont(42,"xyz")    # set the pad title font
    rt.gStyle.SetTitleSize(0.06,"xyz") # set the 3 axes title size
    rt.gStyle.SetTitleSize(0.06,"xyz")   # set the pad title size
    rt.gStyle.SetTitleSize(0.052,"xyz")   # set the pad title size
    rt.gStyle.SetTitleOffset(1.2,"xyz")   # set the pad title size
