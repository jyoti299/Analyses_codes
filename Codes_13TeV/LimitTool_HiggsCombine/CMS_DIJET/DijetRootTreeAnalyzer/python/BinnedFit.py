...
#################################################
    ...
    background= background_pdf.asTF(rt.RooArgList(w.var('mjj')),rt.RooArgList(w.var('p0_%s'%box))) ##taking bkg pdf as a function
    int_b = background.Integral(w.var('mjj').getMin(),w.var('mjj').getMax()) ##taking integral with initial parameters of bkg with mjj range
