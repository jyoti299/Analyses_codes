...
OutFileName=ResonanceShapes_${Model}_${coupling}_${tag}_13TeV_80X_Spring16_${cut}_BSFDOWN
...
void Interpolation::runInterpolation(){
  ...
  //Input X histoname
  TString Mass_X = "h_mass_X_bin1_BSF_1bTag_down"; //TO_CHANGE
