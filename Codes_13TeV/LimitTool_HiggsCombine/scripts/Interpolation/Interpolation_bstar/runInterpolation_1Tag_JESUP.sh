...
OutFileName=ResonanceShapes_${Model}_${tag}_${coupling}_13TeV_PhLID-JetTID-Pt190-nodeta-nodphi-CSVM_mass695_80X_Spring16_JESUP  ##TO_CHANGE
...
void Interpolation::runInterpolation(){
  ...
  //Input X histoname
  TString Mass_X = "h_mass_X_bin1_JES_up_${tag}"; //TO_CHANGE
