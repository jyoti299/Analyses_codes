#Here in this file, to remove the ecal Isolation cut from WP80, i have changed the thrOverEEE and thrOverEEB in hltEle27WP80EcalIsoFilter
#from 0.1 and 0.15 to 999999.
...
process.Trig_analyzer.OutputFile = "Std_HLTLevel_Corrections_with_NoEcalIsoCut_InWP80.root"
