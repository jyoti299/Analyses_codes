#Here in this file, to remove the ecal Isolation cut and hcal isolation cut from WP80, i have changed the thrOverEEE and thrOverEEB in
#hltEle27WP80EcalIsoFilter and hltEle27WP80HcalIsoFilter from 0.1 and 0.15 to 999999.
...
process.hltEle27WP80EcalIsoFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    ...
    thrOverE2EB = cms.double( -1.0 ),
    thrRegularEE = cms.double( -1.0 ),
    thrOverEEE = cms.double( 999999 ),
    L1IsoCand = cms.InputTag( "hltL1SeededRecoEcalCandidate" ),
    thrOverEEB = cms.double( 999999 ),
    thrRegularEB = cms.double( -1.0 ),
    lessThan = cms.bool( True ),
    useEt = cms.bool( True ),
    ncandcut = cms.int32( 1 ),
...
process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'root://xrootd.unl.edu//store/data/Run2012D/DoubleElectron/RAW-RECO/ZElectron-22Jan2013-v1/10000/4E810F67-698F-E211-B9CA-0026189438D3.root',
        'root://xrootd.unl.edu//store/data/Run2012D/DoubleElectron/RAW-RECO/ZElectron-22Jan2013-v1/10000/FECE8EF7-6A8F-E211-9748-002618943969.root',
    ),
...
#----------------------------------------------------------------------------------------------------------------------------------------------------
# Removing single "keep *" output and adding what are required
...
#----------------------------------------------------------------------------------------------------------------------------------------------------
#overriding values defined in cfi file.
process.Trig_analyzer.OutputFile = "Std_HLTLevel_Corrections_with_NoEcalnHcalIsoCut_InWP80.root"
process.Trig_analyzer.pTOfflineProbeCut = 0.0

#defining the analyzer process.
process.p = cms.Path(process.Trig_analyzer)

#Defining schedule for processes in case these are not defined in correct order
process.schedule = cms.Schedule(process.HLT_Ele17_CaloIdVT_CaloIsoVT_TrkIdT_TrkIsoVT_Ele8_Mass50_v6, process.HLT_Ele27_WP80_v11, process.HLTriggerFinalPath, process.p)
...
#        tag = cms.string( 'EcalLaserAPDPNRatios_weekly_1day_test_hlt' ),
