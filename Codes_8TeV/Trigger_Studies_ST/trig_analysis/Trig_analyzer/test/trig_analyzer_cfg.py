...
#         'root://cmssrv32.fnal.gov//store/data/Run2012D/DoubleElectron/RAW-RECO/ZElectron-22Jan2013-v1/10000/4E810F67-698F-E211-B9CA-0026189438D3.root',
 #        'root://cmssrv32.fnal.gov//store/data/Run2012D/DoubleElectron/RAW-RECO/ZElectron-22Jan2013-v1/10000/FECE8EF7-6A8F-E211-9748-002618943969.root',
...
process.Trig_analyzer.OutputFile = "Standard_HLTLevel_corrections.root"
process.Trig_analyzer.pTOfflineProbeCut = 0.0

#process.p = cms.Path(process.kt6PFJets25 * process.Trig_analyzer)

process.p = cms.Path(process.Trig_analyzer)
