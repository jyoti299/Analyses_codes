...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   //Define Output file here
   TString OutputPath = "/eos/uscms/store/user/lpcqstar/Rocky/PostAnalyzer_Results/PostAna_Results_LoosePhId/Data/";
   TString OutputFile = "Data_Run2012D_22Jan_AOD_NTuples_2401_2700";
