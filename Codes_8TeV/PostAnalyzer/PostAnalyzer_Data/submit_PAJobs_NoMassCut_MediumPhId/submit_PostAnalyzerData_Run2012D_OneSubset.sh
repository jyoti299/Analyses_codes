...
#range of the files whose jobs are to be submitted (the text file  Subset_Run2012D with this range of filenames should be present in current dir)
#only change this range while submitting for a subset, no need to change anything else
sf=1
maxf=300
...
echo "Submitting jobs from ${sf} to ${maxf}"
