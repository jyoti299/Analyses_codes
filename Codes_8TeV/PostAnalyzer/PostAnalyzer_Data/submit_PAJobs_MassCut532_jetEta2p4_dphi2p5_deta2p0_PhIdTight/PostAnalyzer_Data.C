...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   //Define Output file here
   TString OutputPath = "/eos/uscms/store/user/lpcqstar/Rocky/PostAnalyzer_Results/PostAna_Results_MassCut532_jetEta2p4_dphi2p5_deta2p0_PhIdTight/Data/";
   TString OutputFile = "Data_Run2012D_22Jan_AOD_NTuples_1_300";
