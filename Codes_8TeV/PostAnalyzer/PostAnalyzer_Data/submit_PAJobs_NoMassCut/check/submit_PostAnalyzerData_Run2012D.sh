...
cp ${subdataset} Subset_Run2012D_${sf}_${maxf}.txt
...
/*
  ...
  */ 
   ...
   Long64_t nEvt_NoLICTD = 0; //To get LICTD efficiency
...
/*
   ...
   Eff_PassCSVLBTag   = (double)CutFlowNumber[12]/(double)CutFlowNumber[11];
   Eff_PassCSVMBTag   = (double)CutFlowNumber[13]/(double)CutFlowNumber[11];
   Eff_PassCSVTBTag   = (double)CutFlowNumber[14]/(double)CutFlowNumber[11];
   Eff_Nodetadphicut_PassCSVL = (double)ncsvlbjets/(double)njets; 
   Eff_Nodetadphicut_PassCSVM = (double)ncsvmbjets/(double)njets;
   Eff_Nodetadphicut_PassCSVT = (double)ncsvtbjets/(double)njets;
   Eff_LICTD          = (double)CutFlowNumber[4]/(double)nEvt_NoLICTD;
   ...
   cout << "*****************************************************************************************************" << endl;
   cout << "No. of events passing with LICTD cut = " << CutFlowNumber[4] << endl;
   cout << "No. of events passing without LICTD cut = " << nEvt_NoLICTD << endl;
   cout << "*****************************************************************************************************" << endl;
   cout << "*****************************************************************************************************" << endl;
   ...
   cout << "Eff_Nodetadphicut_PassCSVL = " << Eff_Nodetadphicut_PassCSVL*100 << "%" << endl;
   cout << "Eff_Nodetadphicut_PassCSVM = " << Eff_Nodetadphicut_PassCSVM*100 << "%" << endl;
   cout << "Eff_Nodetadphicut_PassCSVT = " << Eff_Nodetadphicut_PassCSVT*100 << "%" << endl;
