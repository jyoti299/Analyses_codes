...
public :
   ...
   Double_t Eff_NodetadphiMasscut_PassCSVL_Expected, Eff_NodetadphiMasscut_PassCSVM_Expected, Eff_NodetadphiMasscut_PassCSVT_Expected;
   Double_t Eff_LICTD;
...
Int_t PostAnalyzer_MC::GetPhotonPassingAllCuts_NoLICTD(){
  Int_t pc = -1;
  for(Int_t i = 0; i < Photon_n; i++){
