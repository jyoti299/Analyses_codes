...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   cout << "**Relative Error = (Evts_pErr-Evts_noErr)/Evts_noErr or (Eff_pErr-Eff_noErr)/Eff_noErr (This one is required for limit setting" << endl;
   cout << "Since for limit setting, we need % errors , so for limit setting, relatvie error is needed and for tagging eff plots, absolute errors are needed. Dont forget to do it this way" << endl;
   cout << "**Absolute Error = (Eff_pErr-Eff_noErr) (Required for Tagging Eff plots" << endl;
   cout << "******************************************************************************************************" << endl;
