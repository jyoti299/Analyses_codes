...
PostAna_Dir_mediumPhId=${PostAna_Dir}/PostAna_Results_MediumPhId
PostAnaMC_Dir=${PostAna_Dir_mediumPhId}/MC
...
if [ ! -d ${PostAna_Dir_mediumPhId} ]; then
echo "Making Directory ${PostAna_Dir_mediumPhId}"
mkdir ${PostAna_Dir_mediumPhId}
chmod 775 ${PostAna_Dir_mediumPhId}
fi
