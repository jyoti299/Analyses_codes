...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TString OutputPath = "/eos/uscms/store/user/lpcqstar/Rocky/PostAnalyzer_Results/PostAna_Results_MediumPhId/MC/PhotonJet/";
   TString OutputFile = "G_Pt_1800toInf";
   ...
   for(Long64_t jentry = 0; jentry < nentries; jentry++){
     ...
     //Uncomment this in script
     Lumi_EvtWt = Lumi*(1.867141E-6/1939122);
