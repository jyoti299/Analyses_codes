...
PostAna_Dir_latest=${PostAna_Dir}/PostAna_Results_latest
PostAnaMC_Dir=${PostAna_Dir_latest}/MC
...
for i in BstarToGJ_M700_f0p5 BstarToGJ_M1000_f0p5 BstarToGJ_M1500_f0p1 BstarToGJ_M1500_f0p5 BstarToGJ_M1700_f0p1 BstarToGJ_M3000_f0p1 BstarToGJ_M3000_f1p0 BstarToGJ_M4000_f0p5
do 
XS=(0.05305 0.005841 0.00001231 0.0003057 0.000004339 0.00000001103 0.00000134 0.000000005162)
totalEvents=(60000 120000 120000  120000 160000 197872 160000 197291)
...
if [ ! -d ${PostAna_Dir_latest} ]; then
echo "Making Directory ${PostAna_Dir_latest}"
mkdir ${PostAna_Dir_latest}
chmod 775 ${PostAna_Dir_latest}
fi
