...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   //Define Output file here
   TString OutputPath = "/eos/uscms/store/user/lpcqstar/Rocky/PostAnalyzer_Results/PostAna_Results_NoMassCut_jetEta2p4_dphi1p5_deta2p0_PhIdTight_standard/MC/PhotonJet/";
