...
PostAna_Dir_loosePhId=${PostAna_Dir}/PostAna_Results_LoosePhId
PostAnaMC_Dir=${PostAna_Dir_loosePhId}/MC
...
for i in QCDDiJet_Pt_300to470  QCDDiJet_Pt_800to1000
do
XS=(1759.549 3.550036 )
totalEvents=( 5978500  3998563 )
...
if [ ! -d ${PostAna_Dir_loosePhId} ]; then
echo "Making Directory ${PostAna_Dir_loosePhId}"
mkdir ${PostAna_Dir_loosePhId}
chmod 775 ${PostAna_Dir_loosePhId}
fi
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   Eff_PassCSVLBTag_nErr_0bTag           = CutFlowNumberWithWeights[18]/CutFlowNumberWithWeights[13];
   Eff_PassCSVLBTag_nErr_1bTag           = CutFlowNumberWithWeights[19]/CutFlowNumberWithWeights[13];
   Eff_PassCSVMBTag_Expected             = CutFlowNumberWithWeights[20]/CutFlowNumberWithWeights[12];
   Eff_PassCSVMBTag_noErr_0bTag          = CutFlowNumberWithWeights[21]/CutFlowNumberWithWeights[20];
   Eff_PassCSVMBTag_noErr_1bTag          = CutFlowNumberWithWeights[22]/CutFlowNumberWithWeights[20];
   Eff_PassCSVMBTag_pErr_0bTag           = CutFlowNumberWithWeights[23]/CutFlowNumberWithWeights[20];
   Eff_PassCSVMBTag_pErr_1bTag           = CutFlowNumberWithWeights[24]/CutFlowNumberWithWeights[20];
   Eff_PassCSVMBTag_nErr_0bTag           = CutFlowNumberWithWeights[25]/CutFlowNumberWithWeights[20];
   Eff_PassCSVMBTag_nErr_1bTag           = CutFlowNumberWithWeights[26]/CutFlowNumberWithWeights[20];
   Eff_PassCSVTBTag_Expected             = CutFlowNumberWithWeights[27]/CutFlowNumberWithWeights[12];
   Eff_PassCSVTBTag_noErr_0bTag          = CutFlowNumberWithWeights[28]/CutFlowNumberWithWeights[27];
   Eff_PassCSVTBTag_noErr_1bTag          = CutFlowNumberWithWeights[29]/CutFlowNumberWithWeights[27];
   Eff_PassCSVTBTag_pErr_0bTag           = CutFlowNumberWithWeights[30]/CutFlowNumberWithWeights[27];
   Eff_PassCSVTBTag_pErr_1bTag           = CutFlowNumberWithWeights[31]/CutFlowNumberWithWeights[27];
   Eff_PassCSVTBTag_nErr_0bTag           = CutFlowNumberWithWeights[32]/CutFlowNumberWithWeights[27];
   Eff_PassCSVTBTag_nErr_1bTag           = CutFlowNumberWithWeights[33]/CutFlowNumberWithWeights[27];
   ...
   Effperr_PassCSVL_0bTag               = fabs(Eff_PassCSVLBTag_pErr_0bTag - Eff_PassCSVLBTag_noErr_0bTag);
   Effperr_PassCSVL_1bTag               = fabs(Eff_PassCSVLBTag_pErr_1bTag - Eff_PassCSVLBTag_noErr_1bTag);
   Effnerr_PassCSVL_0bTag               = fabs(Eff_PassCSVLBTag_nErr_0bTag - Eff_PassCSVLBTag_noErr_0bTag);
   Effnerr_PassCSVL_1bTag               = fabs(Eff_PassCSVLBTag_nErr_1bTag - Eff_PassCSVLBTag_noErr_1bTag);

   Effperr_PassCSVM_0bTag               = fabs(Eff_PassCSVMBTag_pErr_0bTag - Eff_PassCSVMBTag_noErr_0bTag);
   Effperr_PassCSVM_1bTag               = fabs(Eff_PassCSVMBTag_pErr_1bTag - Eff_PassCSVMBTag_noErr_1bTag);
   Effnerr_PassCSVM_0bTag               = fabs(Eff_PassCSVMBTag_nErr_0bTag - Eff_PassCSVMBTag_noErr_0bTag);
   Effnerr_PassCSVM_1bTag               = fabs(Eff_PassCSVMBTag_nErr_1bTag - Eff_PassCSVMBTag_noErr_1bTag);

   Effperr_PassCSVT_0bTag               = fabs(Eff_PassCSVTBTag_pErr_0bTag - Eff_PassCSVTBTag_noErr_0bTag);
   Effperr_PassCSVT_1bTag               = fabs(Eff_PassCSVTBTag_pErr_1bTag - Eff_PassCSVTBTag_noErr_1bTag);
   Effnerr_PassCSVT_0bTag               = fabs(Eff_PassCSVTBTag_nErr_0bTag - Eff_PassCSVTBTag_noErr_0bTag);
   Effnerr_PassCSVT_1bTag               = fabs(Eff_PassCSVTBTag_nErr_1bTag - Eff_PassCSVTBTag_noErr_1bTag);
   ...
   cout << "Effperr_PassCSVL_0bTag     = " << Effperr_PassCSVL_0bTag << endl;
   cout << "Effnerr_PassCSVL_0bTag     = " << Effnerr_PassCSVL_0bTag << endl;
   cout << "Eff_PassCSVLBTag_noErr_1bTag    = " << Eff_PassCSVLBTag_noErr_1bTag << endl;
   cout << "Effperr_PassCSVL_1bTag     = " << Effperr_PassCSVL_1bTag << endl;
   cout << "Effnerr_PassCSVL_1bTag     = " << Effnerr_PassCSVL_1bTag << endl;
   cout << "                                                                              " << endl;
   cout << "Eff_PassCSVMBTag_noErr_0bTag    = " << Eff_PassCSVMBTag_noErr_0bTag << endl;
   cout << "Effperr_PassCSVM_0bTag     = " << Effperr_PassCSVM_0bTag << endl;
   cout << "Effnerr_PassCSVM_0bTag     = " << Effnerr_PassCSVM_0bTag << endl;
   cout << "Eff_PassCSVMBTag_noErr_1bTag    = " << Eff_PassCSVMBTag_noErr_1bTag << endl;
   cout << "Effperr_PassCSVM_1bTag     = " << Effperr_PassCSVM_1bTag << endl;
   cout << "Effnerr_PassCSVM_1bTag     = " << Effnerr_PassCSVM_1bTag << endl;
   cout << "                                                                              " << endl;
   cout << "Eff_PassCSVTBTag_noErr_0bTag    = " << Eff_PassCSVTBTag_noErr_0bTag << endl;
   cout << "Effperr_PassCSVT_0bTag     = " << Effperr_PassCSVT_0bTag << endl;
   cout << "Effnerr_PassCSVT_0bTag     = " << Effnerr_PassCSVT_0bTag << endl;
   cout << "Eff_PassCSVTBTag_noErr_1bTag    = " << Eff_PassCSVTBTag_noErr_1bTag << endl;
   cout << "Effperr_PassCSVT_1bTag     = " << Effperr_PassCSVT_1bTag << endl;
   cout << "Effnerr_PassCSVT_1bTag     = " << Effnerr_PassCSVT_1bTag << endl;
   cout << "******************************************************************************************************" << endl;
...
public :
   ...
   Double_t Eff_LICTD;
   Double_t Effperr_PassCSVL_0bTag, Effperr_PassCSVL_1bTag, Effnerr_PassCSVL_0bTag, Effnerr_PassCSVL_1bTag;
   Double_t Effperr_PassCSVM_0bTag, Effperr_PassCSVM_1bTag, Effnerr_PassCSVM_0bTag, Effnerr_PassCSVM_1bTag;
   Double_t Effperr_PassCSVT_0bTag, Effperr_PassCSVT_1bTag, Effnerr_PassCSVT_0bTag, Effnerr_PassCSVT_1bTag;
...
void PostAnalyzer_MC::BookHistograms(){
  ...
  /*
  int nbins = 93;
  double xbins[94] = {1, 22, 44, 67, 91, 116, 141, 167, 194, 222, 251, 281, 312, 344, 377, 412, 448, 485, 523, 563, 604, 646, 690, 735, 782, 831, 881, 933, 987, 1043, 1101, 1161, 1223, 1287, 1353, 1422, 1493, 1567, 1643, 1722, 1804, 1888, 1975, 2065, 2158, 2255, 2355, 2459, 2566, 2677, 2792, 2911, 3034, 3161, 3293, 3429, 3570, 3716, 3867, 4023, 4185, 4353, 4526, 4705, 4891, 5083, 5282, 5488, 5701, 5921, 6149, 6385, 6629, 6882, 7144, 7415, 7695, 7985, 8285, 8596, 8918, 9251, 9595, 9952, 10321, 10703, 11098, 11507, 11930, 12368, 12821, 13290, 13776, 14279};
  */
  int nbins = 95;
  ...
  h_trueNumofInteractions = new TH1F("h_trueNumofInteractions", "True no. of interactions distribution in MC without puWt", 60, 0, 60);
  h_trueNumofInteractions->GetYaxis()->SetTitle("Events");      h_trueNumofInteractions->GetYaxis()->CenterTitle();
  h_trueNumofInteractions->GetXaxis()->SetTitle("nPV_nopuWt (MC)");  h_trueNumofInteractions->GetXaxis()->CenterTitle();
