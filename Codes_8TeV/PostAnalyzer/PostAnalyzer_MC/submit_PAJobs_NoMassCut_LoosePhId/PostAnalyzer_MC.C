...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TString OutputPath = "/eos/uscms/store/user/lpcqstar/Rocky/PostAnalyzer_Results/PostAna_Results_LoosePhId/MC/QCDDiJet/";
   TString OutputFile = "QCDDiJet_Pt_800to1000";
   ...
   for(Long64_t jentry = 0; jentry < nentries; jentry++){
     ...
     //Uncomment this in script
     Lumi_EvtWt = Lumi*(3.550036/3998563);
