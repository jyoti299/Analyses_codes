...
set jsonPath = ${pwd}/JSONs/ 
#set json =  Cert_190456-208686_8TeV_22Jan2013ReReco_Collisions12_JSON.txt                  # For Run2012ABCD 22Jan ReReco
set json =  missinglumi.txt                                                                 # For Run2012ABCD 22Jan ReReco Missing Lumi
#set json =  Cert_190456-208686_8TeV_PromptReco_Collisions12_JSON.txt                      ## Run 2012D prompt reco no pixel algn
#set json =  Cert_190456-208686_8TeV_PromptReco_Collisions12_JSON_PixAlignRecovery.txt     ## Run 2012D prompt reco pixel align

set lumi =       20                   # Lumi per job
...
#setenv destination_path  /pnfs/cms/WAX/11/store/user/varun/2012/Summer12/53X/DiJet/
setenv destination_path  /pnfs/cms/WAX/11/store/user/varun/2012/Data22JanReReco/
...
setenv filedir /2012/Data22JanReReco/${DirName}
...
sed -e 's|outFile          = cms.untracked.string|outFile          = cms.untracked.string('"'"AOD_Output_${DirName}.root"'"'),|'   ${pwd}/config_53X_Data_cfg.py > ${pwd}/config_53X_Data_cfg_tmp.py

cp config_53X_Data_cfg.py config_53X_Data_cfg_orig.py
mv config_53X_Data_cfg_tmp.py config_53X_Data_cfg.py
#----------------------------------------------------------------------------------------------
echo "========================================================================================================================"
...
crab -create -cfg crab_${DirName}.cfg >> log_Submit_${DirName}
else
#crab -create -submit -cfg crab_${DirName}.cfg > log_Submit_${DirName}
crab -create -cfg crab_${DirName}.cfg > log_Submit_${DirName}
endif
...
cp config_53X_Data_cfg.py junk/config_53X_Data_${DirName}_cfg.py
mv config_53X_Data_cfg_orig.py config_53X_Data_cfg.py 
