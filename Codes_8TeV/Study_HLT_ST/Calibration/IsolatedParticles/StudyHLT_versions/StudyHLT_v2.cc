//No consideration of primary vertices as well as truncate_str function. Just similar to v1.
...
void StudyHLT::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  //std::cout << "HLTNames is :" << HLTNames[i] << std::endl;
  //}
...
void StudyHLT::beginJob() {
  ...
  h_HLTCorr     = fs->make<TH1I>("h_HLTCorr", "Correlation among different paths", 300, 0, 300);
