//StudyHLT version in which i have modified the truncate_str code to keep '_' in the HLTs because due to removing of '_', we were not getting the envents for HLT_Physics_
